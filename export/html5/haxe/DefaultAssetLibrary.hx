...
class DefaultAssetLibrary extends openfl.AssetLibrary {
	...
	public function new() {
		...
		add("assets/images/background.svg", TEXT);
		add("assets/images/backgroundhills.png", IMAGE);
		add("assets/images/backgroundhills.svg", TEXT);
		add("assets/images/ground.png", IMAGE);
		add("assets/images/ground.svg", TEXT);
		add("assets/images/icicle.png", IMAGE);
		add("assets/images/icicle.svg", TEXT);
		add("assets/images/images-go-here.txt", TEXT);
		add("assets/images/snowflake.png", IMAGE);
		add("assets/images/snowflake.svg", TEXT);
