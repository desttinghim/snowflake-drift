...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/images/visitor1.eot");
		types.push (lime.Assets.AssetType.TEXT);
		...
		urls.push ("assets/images/Fipps_Regular.eot");
		types.push (lime.Assets.AssetType.BINARY);
		
		
		urls.push ("assets/images/Fipps_Regular.woff");
		types.push (lime.Assets.AssetType.BINARY);
		...
		urls.push ("assets/sounds/floatsound.wav");
		types.push (lime.Assets.AssetType.SOUND);
		
		
		urls.push ("assets/sounds/floatsound.mp3");
		...
		urls.push ("assets/sounds/crashsound.wav");
		types.push (lime.Assets.AssetType.SOUND);
		
		
		urls.push ("assets/sounds/crashsound.mp3");
		types.push (lime.Assets.AssetType.MUSIC);
