...
class ApplicationMain {
	...
	private static function preload() {
		...
		loadBinary("assets/images/background.svg");
		loadFile("assets/images/backgroundhills.png");
		loadBinary("assets/images/backgroundhills.svg");
		loadFile("assets/images/ground.png");
		loadBinary("assets/images/ground.svg");
		loadFile("assets/images/icicle.png");
		loadBinary("assets/images/icicle.svg");
		loadBinary("assets/images/images-go-here.txt");
		loadFile("assets/images/snowflake.png");
		loadBinary("assets/images/snowflake.svg");
