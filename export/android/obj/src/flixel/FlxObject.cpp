...
Void FlxObject_obj::destroy( ){
{
		...
		this->super::destroy();
		HX_STACK_LINE(518)
		this->velocity = ::flixel::util::FlxDestroyUtil_obj::put(this->velocity);
		HX_STACK_LINE(519)
		this->acceleration = ::flixel::util::FlxDestroyUtil_obj::put(this->acceleration);
		HX_STACK_LINE(520)
		this->drag = ::flixel::util::FlxDestroyUtil_obj::put(this->drag);
		HX_STACK_LINE(521)
		this->maxVelocity = ::flixel::util::FlxDestroyUtil_obj::put(this->maxVelocity);
		HX_STACK_LINE(522)
		this->scrollFactor = ::flixel::util::FlxDestroyUtil_obj::put(this->scrollFactor);
		HX_STACK_LINE(523)
		this->last = ::flixel::util::FlxDestroyUtil_obj::put(this->last);
		HX_STACK_LINE(524)
...
bool FlxObject_obj::inWorldBounds( ){
	HX_STACK_FRAME("flixel.FlxObject","inWorldBounds",0x89d0e9f3,"flixel.FlxObject.inWorldBounds","flixel/FlxObject.hx",719,0xf0fe0d80)
	HX_STACK_THIS(this)
	...
	HX_STACK_LINE(719)
	if (((  (((  ((((this->x + this->get_width()) > ::flixel::FlxG_obj::worldBounds->x))) ? bool((this->x < _Function_1_1::Block())) : bool(false) ))) ? bool(((this->y + this->get_height()) > ::flixel::FlxG_obj::worldBounds->y)) : bool(false) ))){
...
Void FlxObject_obj::drawDebugOnCamera( ::flixel::FlxCamera Camera){
{
		...
		if ((this->pixelPerfectRender)){
			HX_STACK_LINE(885)
			boundingBoxX = ::Math_obj::floor(boundingBoxX);
			HX_STACK_LINE(886)
			boundingBoxY = ::Math_obj::floor(boundingBoxY);
		}
		HX_STACK_LINE(895)
...
::String FlxObject_obj::toString( ){
	...
	struct _Function_1_1{
		inline static ::flixel::util::LabelValuePair Block( ::flixel::FlxObject_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/FlxObject.hx",952,0xf0fe0d80)
			{
				HX_STACK_LINE(952)
				::flixel::util::LabelValuePair _this = ::flixel::util::LabelValuePair_obj::_pool->get();		HX_STACK_VAR(_this,"_this");
				HX_STACK_LINE(952)
...
bool FlxObject_obj::separateX( ::flixel::FlxObject Object1,::flixel::FlxObject Object2){
	...
	if (((obj1delta != obj2delta))){
		...
		HX_STACK_LINE(121)
		{
			...
			HX_STACK_LINE(121)
			Float Width = (Object1->get_width() + obj1deltaAbs);		HX_STACK_VAR(Width,"Width");
			HX_STACK_LINE(121)
		...
		HX_STACK_LINE(122)
		{
			...
			HX_STACK_LINE(122)
			Float Width = (Object2->get_width() + obj2deltaAbs);		HX_STACK_VAR(Width,"Width");
			HX_STACK_LINE(122)
