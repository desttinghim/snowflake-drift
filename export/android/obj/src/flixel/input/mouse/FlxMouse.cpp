...
HX_STACK_ARG(CursorContainer,"CursorContainer")
{
	...
	HX_STACK_LINE(436)
	{
		...
		point->_inPool = false;
		HX_STACK_LINE(436)
		this->_globalScreenPosition = point;
	}
	HX_STACK_LINE(438)
	this->_leftButton = ::flixel::input::mouse::FlxMouseButton_obj::__new((int)-1);
	HX_STACK_LINE(440)
	this->_stage = ::openfl::_v2::Lib_obj::get_current()->get_stage();
	HX_STACK_LINE(441)
	...
	HX_STACK_ARG(YOffset,"YOffset")
{
		...
		if ((::Std_obj::is(Graphic,hx::ClassOf< ::Class >()))){
			...
			if ((::Std_obj::is(Graphic,hx::ClassOf< ::openfl::_v2::display::BitmapData >()))){
				HX_STACK_LINE(180)
				this->_cursor = ::openfl::_v2::display::Bitmap_obj::__new(hx::TCast< openfl::_v2::display::BitmapData >::cast(Graphic),null(),null());
			}
			else{
				HX_STACK_LINE(182)
				if ((::Std_obj::is(Graphic,hx::ClassOf< ::String >()))){
					struct _Function_4_1{
						inline static ::openfl::_v2::display::BitmapData Block( Dynamic &Graphic){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/input/mouse/FlxMouse.hx",184,0xe4e80b89)
							{
								HX_STACK_LINE(184)
					...
					HX_STACK_LINE(184)
					this->_cursor = ::openfl::_v2::display::Bitmap_obj::__new(_Function_4_1::Block(Graphic),null(),null());
				}
				else{
					HX_STACK_LINE(188)
					this->_cursor = ::openfl::_v2::display::Bitmap_obj::__new(::flixel::input::mouse::_FlxMouse::GraphicCursor_obj::__new((int)0,(int)0,null(),null()),null(),null());
				}
			}
		}
		HX_STACK_LINE(191)
...
Void FlxMouse_obj::destroy( ){
{
		...
		HX_STACK_LINE(380)
		this->_globalScreenPosition = ::flixel::util::FlxDestroyUtil_obj::put(this->_globalScreenPosition);
		HX_STACK_LINE(382)
		this->cursorContainer = null();
		HX_STACK_LINE(383)
		this->_cursor = null();
		HX_STACK_LINE(389)
		this->_leftButton = ::flixel::util::FlxDestroyUtil_obj::destroy(this->_leftButton);
		HX_STACK_LINE(391)
		this->_middleButton = ::flixel::util::FlxDestroyUtil_obj::destroy(this->_middleButton);
		HX_STACK_LINE(392)
		this->_rightButton = ::flixel::util::FlxDestroyUtil_obj::destroy(this->_rightButton);
		HX_STACK_LINE(395)
		this->_cursorBitmapData = ::flixel::util::FlxDestroyUtil_obj::dispose(this->_cursorBitmapData);
		HX_STACK_LINE(396)
