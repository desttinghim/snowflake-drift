...
HX_STACK_ARG(ID,"ID")
{
	...
	HX_STACK_LINE(37)
	{
		...
		point->_inPool = false;
		HX_STACK_LINE(37)
		this->_justPressedPosition = point;
	}
}
;
	return null();
...
{
		HX_STACK_FRAME("flixel.input.mouse.FlxMouseButton","destroy",0x9f3f8d30,"flixel.input.mouse.FlxMouseButton.destroy","flixel/input/mouse/FlxMouseButton.hx",73,0x7fcdf6f7)
		HX_STACK_THIS(this)
		HX_STACK_LINE(73)
		this->_justPressedPosition = ::flixel::util::FlxDestroyUtil_obj::put(this->_justPressedPosition);
	}
return null();
}
...
Void FlxMouseButton_obj::onDown( ::openfl::_v2::events::MouseEvent FlashEvent){
{
...
Void FlxMouseButton_obj::onUp( ::openfl::_v2::events::MouseEvent FlashEvent){
{
