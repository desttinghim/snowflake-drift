...
HX_STACK_FRAME("flixel.input.FlxAccelerometer","new",0x0d021645,"flixel.input.FlxAccelerometer.new","flixel/input/FlxAccelerometer.hx",10,0x4bc92349)
{
	...
	if ((::openfl::_v2::sensors::Accelerometer_obj::get_isSupported())){
		HX_STACK_LINE(39)
		this->_sensor = ::openfl::_v2::sensors::Accelerometer_obj::__new();
		HX_STACK_LINE(40)
...
bool FlxAccelerometer_obj::get_isSupported( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(46)
	return ::openfl::_v2::sensors::Accelerometer_obj::get_isSupported();
}
...
Dynamic FlxAccelerometer_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 1:
		...
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"_sensor") ) { _sensor=inValue.Cast< ::openfl::_v2::sensors::Accelerometer >(); return inValue; }
	}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::_v2::sensors::Accelerometer*/ ,(int)offsetof(FlxAccelerometer_obj,_sensor),HX_CSTRING("_sensor")},
	{ hx::fsUnknown, 0, null()}
};
#endif
