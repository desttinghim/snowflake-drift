...
HX_STACK_FRAME("flixel.input.keyboard.FlxKeyboard","new",0xa12d657a,"flixel.input.keyboard.FlxKeyboard.new","flixel/input/keyboard/FlxKeyboard.hx",17,0x41882875)
{
	...
	HX_STACK_LINE(328)
	this->_nativeCorrection = ::haxe::ds::StringMap_obj::__new();
	HX_STACK_LINE(330)
...
Void FlxKeyboard_obj::onKeyUp( ::openfl::_v2::events::KeyboardEvent FlashEvent){
{
...
Void FlxKeyboard_obj::onKeyDown( ::openfl::_v2::events::KeyboardEvent FlashEvent){
{
