...
::String FlxSwipe_obj::toString( ){
	...
	struct _Function_1_1{
		inline static ::flixel::util::LabelValuePair Block( ::flixel::input::FlxSwipe_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/input/FlxSwipe.hx",50,0xe38cac7e)
			{
				HX_STACK_LINE(50)
				::flixel::util::LabelValuePair _this = ::flixel::util::LabelValuePair_obj::_pool->get();		HX_STACK_VAR(_this,"_this");
				HX_STACK_LINE(50)
				...
				HX_STACK_LINE(50)
				_this->value = (Float(((__this->_endTimeInTicks - __this->_startTimeInTicks))) / Float((int)1000));
				HX_STACK_LINE(50)
				return _this;
			}
			return null();
