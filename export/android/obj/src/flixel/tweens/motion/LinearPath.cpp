...
Void LinearPath_obj::destroy( ){
{
		...
		HX_STACK_LINE(48)
		this->_last = ::flixel::util::FlxDestroyUtil_obj::put(this->_last);
		HX_STACK_LINE(49)
		this->_prevPoint = ::flixel::util::FlxDestroyUtil_obj::put(this->_prevPoint);
		HX_STACK_LINE(50)
		this->_nextPoint = ::flixel::util::FlxDestroyUtil_obj::put(this->_nextPoint);
	}
return null();
}
	...
	HX_STACK_ARG(y,"y")
{
		...
		struct _Function_1_1{
			inline static ::flixel::util::FlxPoint Block( ::flixel::tweens::motion::LinearPath_obj *__this,Float &x,Float &y){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/tweens/motion/LinearPath.hx",85,0x519b896f)
				{
					HX_STACK_LINE(85)
					...
					point->_inPool = false;
					HX_STACK_LINE(85)
					return __this->_last = point;
				}
				return null();
			}
		};
		HX_STACK_LINE(85)
		this->points[this->points->length] = _Function_1_1::Block(this,x,y);
		HX_STACK_LINE(86)
		return hx::ObjectPtr<OBJ_>(this);
	}
}
