...
Void QuadPath_obj::destroy( ){
{
		...
		HX_STACK_LINE(48)
		this->_a = ::flixel::util::FlxDestroyUtil_obj::put(this->_a);
		HX_STACK_LINE(49)
		this->_b = ::flixel::util::FlxDestroyUtil_obj::put(this->_b);
		HX_STACK_LINE(50)
		this->_c = ::flixel::util::FlxDestroyUtil_obj::put(this->_c);
	}
return null();
}
	...
	HX_STACK_ARG(y,"y")
{
		...
		struct _Function_1_1{
			inline static ::flixel::util::FlxPoint Block( Float &x,Float &y){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/tweens/motion/QuadPath.hx",84,0x562bb60d)
				{
					HX_STACK_LINE(84)
		...
		HX_STACK_LINE(84)
		this->_points->push(_Function_1_1::Block(x,y));
		HX_STACK_LINE(85)
		return hx::ObjectPtr<OBJ_>(this);
	}
}
