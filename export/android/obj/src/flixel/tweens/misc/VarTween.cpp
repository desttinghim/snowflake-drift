		...
		HX_STACK_LINE(105)
		{
			...
			while(((_g < fields->length))){
				...
				struct _Function_3_1{
					inline static Dynamic Block( ::flixel::tweens::misc::VarTween_obj *__this,::String &p1){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/tweens/misc/VarTween.hx",107,0x836bddcb)
						{
							HX_STACK_LINE(107)
				...
				struct _Function_3_2{
					inline static Dynamic Block( ::flixel::tweens::misc::VarTween_obj *__this,::String &p1){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/tweens/misc/VarTween.hx",120,0x836bddcb)
						{
							HX_STACK_LINE(120)
