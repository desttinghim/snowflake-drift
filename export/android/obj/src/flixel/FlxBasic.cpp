...
::String FlxBasic_obj::toString( ){
	...
	struct _Function_1_1{
		inline static ::flixel::util::LabelValuePair Block( ::flixel::FlxBasic_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/FlxBasic.hx",130,0xd8d6cfcf)
			{
				HX_STACK_LINE(130)
				::flixel::util::LabelValuePair _this = ::flixel::util::LabelValuePair_obj::_pool->get();		HX_STACK_VAR(_this,"_this");
				HX_STACK_LINE(130)
