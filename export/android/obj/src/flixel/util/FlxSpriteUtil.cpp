...
::flixel::FlxSprite FlxSpriteUtil_obj::alphaMask( ::flixel::FlxSprite output,Dynamic source,Dynamic mask){
	...
	if ((::Std_obj::is(source,hx::ClassOf< ::String >()))){
		...
		HX_STACK_LINE(56)
		data = ::openfl::_v2::Assets_obj::getBitmapData(id,false);
	}
	else{
		HX_STACK_LINE(58)
		if ((::Std_obj::is(source,hx::ClassOf< ::Class >()))){
			...
			if ((::Std_obj::is(source,hx::ClassOf< ::openfl::_v2::display::BitmapData >()))){
				HX_STACK_LINE(64)
				data = (hx::TCast< openfl::_v2::display::BitmapData >::cast(source))->clone();
			}
			else{
				HX_STACK_LINE(68)
				return null();
	...
	if ((::Std_obj::is(mask,hx::ClassOf< ::String >()))){
		...
		HX_STACK_LINE(73)
		maskData = ::openfl::_v2::Assets_obj::getBitmapData(id,false);
	}
	else{
		HX_STACK_LINE(75)
	...
	HX_STACK_LINE(88)
	::openfl::_v2::geom::Rectangle _g1 = ::openfl::_v2::geom::Rectangle_obj::__new((int)0,(int)0,_g,data->get_height());		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(88)
	data->copyChannel(maskData,_g1,::openfl::_v2::geom::Point_obj::__new(null(),null()),(int)8,(int)8);
	HX_STACK_LINE(89)
...
::flixel::FlxSprite FlxSpriteUtil_obj::alphaMaskFlxSprite( ::flixel::FlxSprite sprite,::flixel::FlxSprite mask,::flixel::FlxSprite output){
	...
	HX_STACK_LINE(109)
	::openfl::_v2::geom::Rectangle _g2 = ::openfl::_v2::geom::Rectangle_obj::__new((int)0,(int)0,_g1,sprite->get_height());		HX_STACK_VAR(_g2,"_g2");
	HX_STACK_LINE(109)
	data->copyChannel(_g,_g2,::openfl::_v2::geom::Point_obj::__new(null(),null()),(int)8,(int)8);
	HX_STACK_LINE(110)
	output->set_pixels(data);
	HX_STACK_LINE(111)
	return output;
	...
	HX_STACK_LINE(273)
	{
		...
		if (((bool((fillStyle != null())) && bool(fillStyle->__Field(HX_CSTRING("hasFill"),true))))){
			...
			HX_STACK_LINE(273)
			{
				...
				HX_STACK_LINE(273)
				_g = (int((int((int(((int((int(Color1) >> int((int)16))) & int((int)255)))) << int((int)16))) | int((int(((int((int(Color1) >> int((int)8))) & int((int)255)))) << int((int)8))))) | int((int(Color1) & int((int)255))));
			}
			...
			HX_STACK_LINE(273)
			::flixel::util::FlxSpriteUtil_obj::flashGfx->beginFill(_g,_Function_3_1::Block(fillStyle));
		}
		else{
			struct _Function_3_1{
...
Void FlxSpriteUtil_obj::beginDraw( int Color,Dynamic lineStyle,Dynamic fillStyle){
{
		...
		if (((bool((fillStyle != null())) && bool(fillStyle->__Field(HX_CSTRING("hasFill"),true))))){
			...
			HX_STACK_LINE(457)
			::flixel::util::FlxSpriteUtil_obj::flashGfx->beginFill(_g,_Function_2_1::Block(fillStyle));
		}
		else{
			struct _Function_2_1{
				inline static Float Block( int &Color){
	...
	HX_STACK_ARG(OnComplete,"OnComplete")
{
		...
		HX_STACK_LINE(631)
		::flixel::tweens::FlxTween_obj::color(sprite,Duration,sprite->color,_g,sprite->alpha,(int)0,(  (((OnComplete != null()))) ? Dynamic(_Function_1_1::Block(OnComplete)) : Dynamic(null()) ));
		HX_STACK_LINE(632)
		return sprite;
	}
}
