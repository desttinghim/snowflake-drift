...
Void CachedGraphics_obj::__construct(::String Key,::openfl::_v2::display::BitmapData Bitmap,hx::Null< bool >  __o_Persist)
{
...
hx::ObjectPtr< CachedGraphics_obj > CachedGraphics_obj::__new(::String Key,::openfl::_v2::display::BitmapData Bitmap,hx::Null< bool >  __o_Persist)
...
Void CachedGraphics_obj::destroy( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(140)
		this->bitmap = ::flixel::util::FlxDestroyUtil_obj::dispose(this->bitmap);
		HX_STACK_LINE(141)
		this->data = ::flixel::util::FlxDestroyUtil_obj::destroy(this->data);
		HX_STACK_LINE(142)
		this->_tilesheet = ::flixel::util::FlxDestroyUtil_obj::destroy(this->_tilesheet);
		HX_STACK_LINE(143)
		this->key = null();
		HX_STACK_LINE(144)
		this->assetsKey = null();
...
::openfl::_v2::display::BitmapData CachedGraphics_obj::getBitmapFromSystem( ){
	...
	if (((this->assetsClass != null()))){
		...
		if (((this->assetsKey != null()))){
			HX_STACK_LINE(172)
			newBitmap = ::openfl::_v2::Assets_obj::getBitmapData(this->assetsKey,false);
		}
	}
	HX_STACK_LINE(175)
	return newBitmap;
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::_v2::display::BitmapData*/ ,(int)offsetof(CachedGraphics_obj,bitmap),HX_CSTRING("bitmap")},
