...
Void TexturePackerData_obj::parseData( ){
{
		...
		struct _Function_1_1{
			inline static ::flixel::util::loaders::CachedGraphics Block( ::flixel::util::loaders::TexturePackerData_obj *__this){
		...
		{
			HX_STACK_LINE(47)
			::String text = ::openfl::_v2::Assets_obj::getText(this->description);		HX_STACK_VAR(text,"text");
			HX_STACK_LINE(47)
		...
		HX_STACK_LINE(49)
		{
			...
			while(((_g < _g1->__Field(HX_CSTRING("length"),true)))){
				...
				if ((frame->__Field(HX_CSTRING("rotated"),true))){
					HX_STACK_LINE(62)
					texFrame->frame = ::openfl::_v2::geom::Rectangle_obj::__new(frame->__Field(HX_CSTRING("frame"),true)->__Field(HX_CSTRING("x"),true),frame->__Field(HX_CSTRING("frame"),true)->__Field(HX_CSTRING("y"),true),frame->__Field(HX_CSTRING("frame"),true)->__Field(HX_CSTRING("h"),true),frame->__Field(HX_CSTRING("frame"),true)->__Field(HX_CSTRING("w"),true));
					HX_STACK_LINE(63)
					texFrame->additionalAngle = (int)-90;
				}
				else{
					HX_STACK_LINE(67)
					texFrame->frame = ::openfl::_v2::geom::Rectangle_obj::__new(frame->__Field(HX_CSTRING("frame"),true)->__Field(HX_CSTRING("x"),true),frame->__Field(HX_CSTRING("frame"),true)->__Field(HX_CSTRING("y"),true),frame->__Field(HX_CSTRING("frame"),true)->__Field(HX_CSTRING("w"),true),frame->__Field(HX_CSTRING("frame"),true)->__Field(HX_CSTRING("h"),true));
					HX_STACK_LINE(68)
...
Dynamic TexturePackerData_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 5:
		if (HX_FIELD_EQ(inName,"asset") ) { asset=inValue.Cast< ::openfl::_v2::display::BitmapData >(); return inValue; }
		break;
	case 6:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::_v2::display::BitmapData*/ ,(int)offsetof(TexturePackerData_obj,asset),HX_CSTRING("asset")},
	{ hx::fsUnknown, 0, null()}
};
#endif
