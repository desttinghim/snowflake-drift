...
::flixel::util::FlxPoint FlxPoint_obj::copyFromFlash( ::openfl::_v2::geom::Point FlashPoint){
...
::flixel::util::FlxPoint FlxPoint_obj::floor( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(246)
	this->set_x(::Math_obj::floor(this->x));
	HX_STACK_LINE(247)
	this->set_y(::Math_obj::floor(this->y));
	HX_STACK_LINE(248)
	return hx::ObjectPtr<OBJ_>(this);
}
...
::flixel::util::FlxPoint FlxPoint_obj::ceil( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(256)
	this->set_x(::Math_obj::ceil(this->x));
	HX_STACK_LINE(257)
	this->set_y(::Math_obj::ceil(this->y));
	HX_STACK_LINE(258)
	return hx::ObjectPtr<OBJ_>(this);
}
...
::String FlxPoint_obj::toString( ){
	...
	struct _Function_1_1{
		inline static ::flixel::util::LabelValuePair Block( ::flixel::util::FlxPoint_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxPoint.hx",273,0xb59f5266)
			{
				HX_STACK_LINE(273)
				::flixel::util::LabelValuePair _this = ::flixel::util::LabelValuePair_obj::_pool->get();		HX_STACK_VAR(_this,"_this");
				HX_STACK_LINE(273)
