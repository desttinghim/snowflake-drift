...
::openfl::_v2::geom::Rectangle FlxBitmapDataPool_obj::_rect;

::openfl::_v2::display::BitmapData FlxBitmapDataPool_obj::get( int w,int h,hx::Null< bool >  __o_transparent,Dynamic fillColor,Dynamic __o_exactSize){
...
{
		HX_STACK_LINE(42)
		::openfl::_v2::display::BitmapData res = null();		HX_STACK_VAR(res,"res");
		HX_STACK_LINE(45)
		::flixel::util::_FlxBitmapDataPool::FlxBitmapDataPoolNode node = ::flixel::util::FlxBitmapDataPool_obj::_head;		HX_STACK_VAR(node,"node");
		HX_STACK_LINE(46)
		while(((node != null()))){
			HX_STACK_LINE(48)
			::openfl::_v2::display::BitmapData bmd = node->bmd;		HX_STACK_VAR(bmd,"bmd");
			struct _Function_2_1{
				inline static bool Block( Dynamic &exactSize,::openfl::_v2::display::BitmapData &bmd,int &w,int &h){
		...
		if (((res != null()))){
			...
			HX_STACK_LINE(79)
			res = ::openfl::_v2::display::BitmapData_obj::__new(w,h,transparent,(  (((fillColor != null()))) ? int(fillColor) : int((int)-1) ),null());
		}
		HX_STACK_LINE(82)
		return res;
	}
...
Void FlxBitmapDataPool_obj::put( ::openfl::_v2::display::BitmapData bmd){
{
...
void FlxBitmapDataPool_obj::__boot()
{
	...
	_head= null();
	_tail= null();
	_rect= ::openfl::_v2::geom::Rectangle_obj::__new(null(),null(),null(),null());
}
