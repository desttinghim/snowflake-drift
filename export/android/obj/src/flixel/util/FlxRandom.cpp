...
int FlxRandom_obj::resetGlobalSeed( ){
	HX_STACK_FRAME("flixel.util.FlxRandom","resetGlobalSeed",0xb2826f10,"flixel.util.FlxRandom.resetGlobalSeed","flixel/util/FlxRandom.hx",120,0xd3ba8ba3)
	HX_STACK_LINE(120)
...
Float FlxRandom_obj::_float( ){
	HX_STACK_FRAME("flixel.util.FlxRandom","float",0xe1a96349,"flixel.util.FlxRandom.float","flixel/util/FlxRandom.hx",136,0xd3ba8ba3)
	HX_STACK_LINE(136)
...
while(((Excludes->indexOf(::flixel::util::FlxRandom_obj::_intHelper,null()) >= (int)0)));
			}
		}
		HX_STACK_LINE(178)
...
while(((Excludes->indexOf(::flixel::util::FlxRandom_obj::_floatHelper,null()) >= (int)0)));
			}
		}
		HX_STACK_LINE(220)
...
Float Chance = __o_Chance.Default(50);
	HX_STACK_FRAME("flixel.util.FlxRandom","chanceRoll",0xff9c5ec4,"flixel.util.FlxRandom.chanceRoll","flixel/util/FlxRandom.hx",232,0xd3ba8ba3)
...
Float Chance = __o_Chance.Default(50);
	HX_STACK_FRAME("flixel.util.FlxRandom","sign",0x2c090730,"flixel.util.FlxRandom.sign","flixel/util/FlxRandom.hx",243,0xd3ba8ba3)
	HX_STACK_ARG(Chance,"Chance")
{
		HX_STACK_LINE(243)
		if (((::flixel::util::FlxRandom_obj::floatRanged((int)0,(int)100,null()) < Chance))){
			HX_STACK_LINE(243)
			return (int)1;
		}
		else{
	...
	HX_STACK_ARG(GreyScale,"GreyScale")
{
		...
		if ((GreyScale)){
			HX_STACK_LINE(444)
			::flixel::util::FlxRandom_obj::_green = ::flixel::util::FlxRandom_obj::_red;
		}
		else{
			HX_STACK_LINE(444)
			::flixel::util::FlxRandom_obj::_green = ::flixel::util::FlxRandom_obj::intRanged(Min,Max,null());
		}
		HX_STACK_LINE(445)
		if ((GreyScale)){
			HX_STACK_LINE(445)
			::flixel::util::FlxRandom_obj::_blue = ::flixel::util::FlxRandom_obj::_red;
		}
		else{
			HX_STACK_LINE(445)
			::flixel::util::FlxRandom_obj::_blue = ::flixel::util::FlxRandom_obj::intRanged(Min,Max,null());
		}
		HX_STACK_LINE(447)
