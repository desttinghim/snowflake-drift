...
Void FlxPath_obj::destroy( ){
{
		...
		HX_STACK_LINE(453)
		{
			...
			while(((_g < _g1->length))){
				...
				++(_g);
				HX_STACK_LINE(455)
				point = ::flixel::util::FlxDestroyUtil_obj::put(point);
			}
		}
		HX_STACK_LINE(457)
		this->nodes = null();
...
::flixel::util::FlxPath FlxPath_obj::add( Float X,Float Y){
	...
	struct _Function_1_1{
		inline static ::flixel::util::FlxPoint Block( Float &Y,Float &X){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxPath.hx",470,0x22aae741)
			{
				HX_STACK_LINE(470)
	...
	HX_STACK_LINE(470)
	this->nodes->push(_Function_1_1::Block(Y,X));
	HX_STACK_LINE(471)
	return hx::ObjectPtr<OBJ_>(this);
}
...
::flixel::util::FlxPath FlxPath_obj::addAt( Float X,Float Y,int Index){
	...
	struct _Function_1_1{
		inline static ::flixel::util::FlxPoint Block( Float &Y,Float &X){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxPath.hx",488,0x22aae741)
			{
				HX_STACK_LINE(488)
				::flixel::util::FlxPoint point = ::flixel::util::FlxPoint_obj::_pool->get()->set(X,Y);		HX_STACK_VAR(point,"point");
				HX_STACK_LINE(488)
	...
	HX_STACK_LINE(488)
	this->nodes->insert(Index,_Function_1_1::Block(Y,X));
	HX_STACK_LINE(489)
	return hx::ObjectPtr<OBJ_>(this);
}
	...
	HX_STACK_ARG(AsReference,"AsReference")
{
		...
		if ((AsReference)){
			...
			struct _Function_2_1{
				inline static ::flixel::util::FlxPoint Block( ::flixel::util::FlxPoint &Node){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxPath.hx",508,0x22aae741)
					{
						HX_STACK_LINE(508)
			...
			HX_STACK_LINE(508)
			this->nodes->push(_Function_2_1::Block(Node));
		}
		HX_STACK_LINE(510)
		return hx::ObjectPtr<OBJ_>(this);
	}
	...
	HX_STACK_ARG(AsReference,"AsReference")
{
		...
		if ((AsReference)){
			...
			struct _Function_2_1{
				inline static ::flixel::util::FlxPoint Block( ::flixel::util::FlxPoint &Node){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxPath.hx",535,0x22aae741)
					{
						HX_STACK_LINE(535)
						::flixel::util::FlxPoint point = ::flixel::util::FlxPoint_obj::_pool->get()->set(Node->x,Node->y);		HX_STACK_VAR(point,"point");
						HX_STACK_LINE(535)
			...
			HX_STACK_LINE(535)
			this->nodes->insert(Index,_Function_2_1::Block(Node));
		}
		HX_STACK_LINE(537)
		return hx::ObjectPtr<OBJ_>(this);
	}
...
Void FlxPath_obj::drawDebug( ::flixel::FlxCamera Camera){
{
		...
		while(((i < l))){
			...
			if (((i < (l - (int)1)))){
				...
				HX_STACK_LINE(682)
				nextNode = this->nodes->__get(i).StaticCast< ::flixel::util::FlxPoint >();
			}
			HX_STACK_LINE(686)
