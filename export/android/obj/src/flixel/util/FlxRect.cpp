...
::flixel::util::FlxRect FlxRect_obj::copyFromFlash( ::openfl::_v2::geom::Rectangle FlashRect){
...
::String FlxRect_obj::toString( ){
	...
	struct _Function_1_1{
		inline static ::flixel::util::LabelValuePair Block( ::flixel::util::FlxRect_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxRect.hx",217,0x4d61f922)
			{
				HX_STACK_LINE(217)
				::flixel::util::LabelValuePair _this = ::flixel::util::LabelValuePair_obj::_pool->get();		HX_STACK_VAR(_this,"_this");
				HX_STACK_LINE(217)
	...
	HX_STACK_LINE(213)
	return ::flixel::util::FlxStringUtil_obj::getDebugString(Array_obj< ::Dynamic >::__new().Add(_g).Add(_g1).Add(_g2).Add(_Function_1_1::Block(this)));
}
