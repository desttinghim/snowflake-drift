...
::flixel::util::FlxPoint FlxAngle_obj::getCartesianCoords( Float Radius,Float Angle,::flixel::util::FlxPoint point){
	...
	HX_STACK_LINE(379)
	p->set_x((Radius * ::Math_obj::cos((Angle * ((Float(::Math_obj::PI) / Float((int)180)))))));
	HX_STACK_LINE(380)
	p->set_y((Radius * ::Math_obj::sin((Angle * ((Float(::Math_obj::PI) / Float((int)180)))))));
	HX_STACK_LINE(381)
	return p;
}
...
::flixel::util::FlxPoint FlxAngle_obj::getPolarCoords( Float X,Float Y,::flixel::util::FlxPoint point){
	...
	HX_STACK_LINE(401)
	p->set_y((::Math_obj::atan2(Y,X) * ((Float((int)180) / Float(::Math_obj::PI)))));
	HX_STACK_LINE(402)
	return p;
}
