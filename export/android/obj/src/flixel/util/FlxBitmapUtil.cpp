...
Void FlxBitmapUtil_obj::merge( ::openfl::_v2::display::BitmapData sourceBitmapData,::openfl::_v2::geom::Rectangle sourceRect,::openfl::_v2::display::BitmapData destBitmapData,::openfl::_v2::geom::Point destPoint,int redMultiplier,int greenMultiplier,int blueMultiplier,int alphaMultiplier){
{
		...
		HX_STACK_LINE(14)
		if (((  ((!(((  ((!(((  ((!(((  ((!(((  ((!(((destPoint->x >= destBitmapData->get_width()))))) ? bool((destPoint->y >= destBitmapData->get_height())) : bool(true) ))))) ? bool((sourceRect->x >= sourceBitmapData->get_width())) : bool(true) ))))) ? bool((sourceRect->y >= sourceBitmapData->get_height())) : bool(true) ))))) ? bool(((sourceRect->x + sourceRect->width) <= (int)0)) : bool(true) ))))) ? bool(((sourceRect->y + sourceRect->height) <= (int)0)) : bool(true) ))){
			HX_STACK_LINE(21)
			return null();
		}
		HX_STACK_LINE(25)
		while(((  ((!(((  ((!(((  ((!(((  ((!(((  ((!((((sourceRect->x + sourceRect->width) > sourceBitmapData->get_width()))))) ? bool(((sourceRect->y + sourceRect->height) > sourceBitmapData->get_height())) : bool(true) ))))) ? bool((sourceRect->x < (int)0)) : bool(true) ))))) ? bool((sourceRect->y < (int)0)) : bool(true) ))))) ? bool((destPoint->x < (int)0)) : bool(true) ))))) ? bool((destPoint->y < (int)0)) : bool(true) ))){
			HX_STACK_LINE(32)
			if ((((sourceRect->x + sourceRect->width) > sourceBitmapData->get_width()))){
				HX_STACK_LINE(32)
				sourceRect->width = (sourceBitmapData->get_width() - sourceRect->x);
			}
			HX_STACK_LINE(33)
			if ((((sourceRect->y + sourceRect->height) > sourceBitmapData->get_height()))){
				HX_STACK_LINE(33)
				sourceRect->height = (sourceBitmapData->get_height() - sourceRect->y);
			}
			HX_STACK_LINE(35)
			...
			HX_STACK_LINE(49)
			if (((  ((!(((destPoint->x >= destBitmapData->get_width()))))) ? bool((destPoint->y >= destBitmapData->get_height())) : bool(true) ))){
				HX_STACK_LINE(49)
				return null();
			}
			HX_STACK_LINE(51)
			...
			while(((_g < width))){
				...
				HX_STACK_LINE(107)
				{
					...
					while(((_g1 < height))){
						...
						HX_STACK_LINE(130)
						resultRed = ::Std_obj::_int((Float((((sourceRed * redMultiplier) + (destRed * (((int)256 - redMultiplier)))))) / Float((int)256)));
						HX_STACK_LINE(131)
						resultGreen = ::Std_obj::_int((Float((((sourceGreen * greenMultiplier) + (destGreen * (((int)256 - greenMultiplier)))))) / Float((int)256)));
						HX_STACK_LINE(132)
						resultBlue = ::Std_obj::_int((Float((((sourceBlue * blueMultiplier) + (destBlue * (((int)256 - blueMultiplier)))))) / Float((int)256)));
						HX_STACK_LINE(133)
						resultAlpha = ::Std_obj::_int((Float((((sourceAlpha * alphaMultiplier) + (destAlpha * (((int)256 - alphaMultiplier)))))) / Float((int)256)));
						HX_STACK_LINE(136)
...
Dynamic FlxBitmapUtil_obj::compare( ::openfl::_v2::display::BitmapData Bitmap1,::openfl::_v2::display::BitmapData Bitmap2){
	...
	HX_STACK_LINE(160)
	if (((_g != Bitmap2->get_width()))){
		HX_STACK_LINE(162)
		return (int)-3;
	}
	else{
		HX_STACK_LINE(164)
		int _g1 = Bitmap1->get_height();		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(164)
		if (((_g1 != Bitmap2->get_height()))){
			HX_STACK_LINE(166)
			return (int)-4;
		}
		else{
...
Float FlxBitmapUtil_obj::getMemorySize( ::openfl::_v2::display::BitmapData bitmapData){
	...
	HX_STACK_LINE(256)
	return ((_g * bitmapData->get_height()) * (int)4);
}
