...
Void FlxVelocity_obj::accelerateTowardsObject( ::flixel::FlxSprite Source,::flixel::FlxSprite Dest,Float Acceleration,Float MaxXSpeed,Float MaxYSpeed){
{
		...
		HX_STACK_LINE(58)
		Source->acceleration->set_x((::Math_obj::cos(a) * Acceleration));
		HX_STACK_LINE(59)
		Source->acceleration->set_y((::Math_obj::sin(a) * Acceleration));
		HX_STACK_LINE(61)
...
::flixel::util::FlxPoint FlxVelocity_obj::velocityFromAngle( Float Angle,Float Speed){
	...
	HX_STACK_LINE(243)
	result->set_x((::Math_obj::cos(a) * Speed));
	HX_STACK_LINE(244)
	result->set_y((::Math_obj::sin(a) * Speed));
	HX_STACK_LINE(246)
	return result;
}
