...
Dynamic FlxDestroyUtil_obj::destroyArray( Dynamic array){
	...
	if (((array != null()))){
		HX_STACK_LINE(34)
		while(((array->__Field(HX_CSTRING("length"),true) > (int)0))){
			HX_STACK_LINE(36)
			::flixel::util::FlxDestroyUtil_obj::destroy(array->__Field(HX_CSTRING("pop"),true)());
		}
	}
	HX_STACK_LINE(39)
	return null();
...
Dynamic FlxDestroyUtil_obj::putArray( Dynamic array){
	...
	if (((array != null()))){
		...
		while(((array->__Field(HX_CSTRING("length"),true) > (int)0))){
			HX_STACK_LINE(68)
			::flixel::util::FlxDestroyUtil_obj::put(array->__Field(HX_CSTRING("pop"),true)());
		}
	}
	HX_STACK_LINE(71)
	return null();
...
::openfl::_v2::display::BitmapData FlxDestroyUtil_obj::dispose( ::openfl::_v2::display::BitmapData Bitmap){
