...
bool FlxMath_obj::isOdd( Float n){
	HX_STACK_FRAME("flixel.util.FlxMath","isOdd",0xc6915517,"flixel.util.FlxMath.isOdd","flixel/util/FlxMath.hx",101,0xa5ea82fe)
	HX_STACK_ARG(n,"n")
	HX_STACK_LINE(101)
...
bool FlxMath_obj::isEven( Float n){
	HX_STACK_FRAME("flixel.util.FlxMath","isEven",0xf20aa6b2,"flixel.util.FlxMath.isEven","flixel/util/FlxMath.hx",119,0xa5ea82fe)
	HX_STACK_ARG(n,"n")
	HX_STACK_LINE(119)
	if (((((int(::Std_obj::_int(n)) & int((int)1))) != (int)0))){
		HX_STACK_LINE(121)
...
Float aDiff = __o_aDiff.Default(0.00001);
	HX_STACK_FRAME("flixel.util.FlxMath","equal",0x77c168e6,"flixel.util.FlxMath.equal","flixel/util/FlxMath.hx",493,0xa5ea82fe)
...
bool FlxMath_obj::sameSign( Float f1,Float f2){
	...
	HX_STACK_LINE(509)
	return (_g == ((  (((f2 < (int)0))) ? int((int)-1) : int((int)1) )));
}
