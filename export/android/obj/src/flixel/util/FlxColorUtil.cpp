...
Float Alpha = __o_Alpha.Default(1.0);
	HX_STACK_FRAME("flixel.util.FlxColorUtil","makeFromARGB",0xd89d5325,"flixel.util.FlxColorUtil.makeFromARGB","flixel/util/FlxColorUtil.hx",21,0x18d3ded1)
	...
	HX_STACK_ARG(Alpha,"Alpha")
{
		...
		HX_STACK_LINE(91)
		int _g = (int(((int(::Std_obj::_int((  (((Alpha > (int)1))) ? Float(Alpha) : Float((Alpha * (int)255)) ))) & int((int)255)))) << int((int)24));		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(91)
		int _g1 = (int(_g) | int((int(::Std_obj::_int((red * (int)255))) << int((int)16))));		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(91)
		int _g2 = (int(_g1) | int((int(::Std_obj::_int((green * (int)255))) << int((int)8))));		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(91)
		return (int(_g2) | int(::Std_obj::_int((blue * (int)255))));
	}
}
	...
	HX_STACK_ARG(Threshold,"Threshold")
{
		...
		HX_STACK_LINE(331)
		int _g = ::flixel::util::FlxColorUtil_obj::HSVtoARGB(warmer,1.0,1.0,null());		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(331)
		int _g1 = ::flixel::util::FlxColorUtil_obj::HSVtoARGB(colder,1.0,1.0,null());		HX_STACK_VAR(_g1,"_g1");
		struct _Function_1_1{
			inline static Dynamic Block( int &_g1,int &warmer,int &_g,Dynamic &hsv,int &Color,int &colder){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxColorUtil.hx",331,0x18d3ded1)
				{
					...
					__result->Add(HX_CSTRING("color2") , _g,false);
					__result->Add(HX_CSTRING("color3") , _g1,false);
		...
		HX_STACK_LINE(331)
		return _Function_1_1::Block(_g1,warmer,_g,hsv,Color,colder);
	}
}
	...
	HX_STACK_ARG(Threshold,"Threshold")
{
		...
		HX_STACK_LINE(359)
		int _g = ::flixel::util::FlxColorUtil_obj::HSVtoARGB(warmer,hsv->__Field(HX_CSTRING("saturation"),true),hsv->__Field(HX_CSTRING("value"),true),null());		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(359)
		int _g1 = ::flixel::util::FlxColorUtil_obj::HSVtoARGB(colder,hsv->__Field(HX_CSTRING("saturation"),true),hsv->__Field(HX_CSTRING("value"),true),null());		HX_STACK_VAR(_g1,"_g1");
		struct _Function_1_1{
			inline static Dynamic Block( int &_g1,int &warmer,int &_g,Dynamic &hsv,int &Color,int &colder){
...
Dynamic FlxColorUtil_obj::getTriadicHarmony( int Color){
	...
	HX_STACK_LINE(376)
	int _g = ::flixel::util::FlxColorUtil_obj::HSVtoARGB(triadic1,1.0,1.0,null());		HX_STACK_VAR(_g,"_g");
	struct _Function_1_1{
		inline static Dynamic Block( int &_g,int &Color,int &triadic2){
	...
	HX_STACK_LINE(376)
	return _Function_1_1::Block(_g,Color,triadic2);
}
...
::String FlxColorUtil_obj::getColorInfo( int Color){
	...
	HX_STACK_LINE(392)
	::String result;		HX_STACK_VAR(result,"result");
	struct _Function_1_1{
				...
				struct _Function_2_1{
					inline static ::String Block( Dynamic &argb1){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxColorUtil.hx",392,0x18d3ded1)
						{
							...
							HX_STACK_LINE(392)
							::String _g = digits.charAt(::Std_obj::_int(msd));		HX_STACK_VAR(_g,"_g");
							HX_STACK_LINE(392)
							return (_g + digits.charAt(::Std_obj::_int(lsd)));
						}
						return null();
					}
				};
				HX_STACK_LINE(392)
				_g1 = (HX_CSTRING("0x") + _Function_2_1::Block(argb1));
				HX_STACK_LINE(392)
				...
				struct _Function_2_2{
					inline static ::String Block( Dynamic &argb1){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxColorUtil.hx",392,0x18d3ded1)
						{
							...
							Float msd = (Float(((Color1 - lsd))) / Float((int)16));		HX_STACK_VAR(msd,"msd");
							HX_STACK_LINE(392)
							::String _g2 = digits.charAt(::Std_obj::_int(msd));		HX_STACK_VAR(_g2,"_g2");
							HX_STACK_LINE(392)
							return (_g2 + digits.charAt(::Std_obj::_int(lsd)));
						}
						return null();
					}
				};
				HX_STACK_LINE(392)
				_g3 = (_g1 + _Function_2_2::Block(argb1));
				HX_STACK_LINE(392)
				...
				struct _Function_2_3{
					inline static ::String Block( Dynamic &argb1){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxColorUtil.hx",392,0x18d3ded1)
						{
							...
							Float msd = (Float(((Color1 - lsd))) / Float((int)16));		HX_STACK_VAR(msd,"msd");
							HX_STACK_LINE(392)
							::String _g4 = digits.charAt(::Std_obj::_int(msd));		HX_STACK_VAR(_g4,"_g4");
							HX_STACK_LINE(392)
							return (_g4 + digits.charAt(::Std_obj::_int(lsd)));
						}
						return null();
					}
				};
				HX_STACK_LINE(392)
				_g5 = (_g3 + _Function_2_3::Block(argb1));
				struct _Function_2_4{
					inline static ::String Block( Dynamic &argb1){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxColorUtil.hx",392,0x18d3ded1)
						{
							...
							Float msd = (Float(((Color1 - lsd))) / Float((int)16));		HX_STACK_VAR(msd,"msd");
							HX_STACK_LINE(392)
							::String _g6 = digits.charAt(::Std_obj::_int(msd));		HX_STACK_VAR(_g6,"_g6");
							HX_STACK_LINE(392)
							return (_g6 + digits.charAt(::Std_obj::_int(lsd)));
						}
						return null();
					}
				};
				HX_STACK_LINE(392)
				return (_g5 + _Function_2_4::Block(argb1));
			}
			return null();
		}
	};
	HX_STACK_LINE(392)
	result = (_Function_1_1::Block(Color) + HX_CSTRING("\n"));
	HX_STACK_LINE(395)
...
::String FlxColorUtil_obj::ARGBtoHexString( int Color){
	...
	struct _Function_1_1{
		inline static ::String Block( Dynamic &argb){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxColorUtil.hx",412,0x18d3ded1)
			{
				HX_STACK_LINE(412)
	...
	HX_STACK_LINE(412)
	_g1 = (HX_CSTRING("0x") + _Function_1_1::Block(argb));
	HX_STACK_LINE(412)
	::String _g3;		HX_STACK_VAR(_g3,"_g3");
	...
	HX_STACK_LINE(412)
	_g3 = (_g1 + _Function_1_2::Block(argb));
	HX_STACK_LINE(412)
	::String _g5;		HX_STACK_VAR(_g5,"_g5");
	...
	HX_STACK_LINE(412)
	_g5 = (_g3 + _Function_1_3::Block(argb));
	...
	HX_STACK_LINE(412)
	return (_g5 + _Function_1_4::Block(argb));
}
...
::String FlxColorUtil_obj::ARGBtoWebString( int Color){
	...
	struct _Function_1_1{
		inline static ::String Block( Dynamic &argb){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/util/FlxColorUtil.hx",424,0x18d3ded1)
			{
				HX_STACK_LINE(424)
				int Color1 = argb->__Field(HX_CSTRING("red"),true);		HX_STACK_VAR(Color1,"Color1");
				HX_STACK_LINE(424)
	...
	HX_STACK_LINE(424)
	_g1 = (HX_CSTRING("#") + _Function_1_1::Block(argb));
	HX_STACK_LINE(424)
	::String _g3;		HX_STACK_VAR(_g3,"_g3");
	struct _Function_1_2{
		inline static ::String Block( Dynamic &argb){
	...
	HX_STACK_LINE(424)
	return (_g3 + _Function_1_3::Block(argb));
}
	...
	HX_STACK_ARG(Alpha,"Alpha")
{
		...
		if (((S == 0.0))){
			...
			HX_STACK_LINE(458)
			result = (int((int((int((int(Alpha) << int((int)24))) | int((int(Red) << int((int)16))))) | int((int(Green) << int((int)8))))) | int(Blue));
		}
		else{
			HX_STACK_LINE(462)
