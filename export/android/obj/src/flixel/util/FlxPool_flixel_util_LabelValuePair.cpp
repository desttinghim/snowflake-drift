...
::flixel::util::LabelValuePair FlxPool_flixel_util_LabelValuePair_obj::get( ){
	...
	if (((obj == null()))){
		HX_STACK_LINE(28)
		obj = ::Type_obj::createInstance(this->_class,Dynamic( Array_obj<Dynamic>::__new()));
	}
	HX_STACK_LINE(30)
	return obj;
}
...
Void FlxPool_flixel_util_LabelValuePair_obj::put( ::flixel::util::LabelValuePair obj){
{
		...
		HX_STACK_LINE(36)
		if (((  (((obj != null()))) ? bool((this->_pool->indexOf(obj,null()) < (int)0)) : bool(false) ))){
			HX_STACK_LINE(38)
			obj->destroy();
			HX_STACK_LINE(39)
			this->_pool->push(obj);
...
Void FlxPool_flixel_util_LabelValuePair_obj::preAllocate( int numObjects){
{
		...
		while(((_g < numObjects))){
			...
			HX_STACK_LINE(56)
			this->_pool->push(::Type_obj::createInstance(this->_class,Dynamic( Array_obj<Dynamic>::__new())));
		}
	}
return null();
}
