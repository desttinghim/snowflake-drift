...
Void FlxSound_obj::reset( ){
{
		...
		if (((this->_transform == null()))){
			HX_STACK_LINE(165)
			this->_transform = ::openfl::media::SoundTransform_obj::__new(null(),null());
		}
		HX_STACK_LINE(167)
		...
		if (((this->_target != null()))){
			struct _Function_2_1{
				inline static Float Block( ::flixel::system::FlxSound_obj *__this){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/system/FlxSound.hx",215,0x7d78fc74)
					{
						HX_STACK_LINE(215)
						...
						{
							HX_STACK_LINE(215)
							::flixel::util::FlxPoint point = ::flixel::util::FlxPoint_obj::_pool->get()->set(__this->_target->x,__this->_target->y);		HX_STACK_VAR(point,"point");
							HX_STACK_LINE(215)
							point->_inPool = false;
							HX_STACK_LINE(215)
							Point1 = point;
						...
						{
							HX_STACK_LINE(215)
							::flixel::util::FlxPoint point = ::flixel::util::FlxPoint_obj::_pool->get()->set(__this->x,__this->y);		HX_STACK_VAR(point,"point");
							HX_STACK_LINE(215)
							point->_inPool = false;
							HX_STACK_LINE(215)
							Point2 = point;
		...
		if ((::Std_obj::is(EmbeddedSound,hx::ClassOf< ::openfl::_v2::media::Sound >()))){
			...
			if ((::Std_obj::is(EmbeddedSound,hx::ClassOf< ::Class >()))){
				...
				if ((::Std_obj::is(EmbeddedSound,hx::ClassOf< ::String >()))){
					HX_STACK_LINE(282)
					this->_sound = ::openfl::_v2::Assets_obj::getSound(EmbeddedSound,null());
				}
			}
		}
		HX_STACK_LINE(286)
	...
	HX_STACK_ARG(OnComplete,"OnComplete")
{
		...
		this->cleanup(true,null(),null());
		HX_STACK_LINE(307)
		this->_sound = ::openfl::_v2::media::Sound_obj::__new(null(),null(),null());
		HX_STACK_LINE(308)
		this->_sound->addEventListener(::openfl::_v2::events::Event_obj::ID3,this->gotID3_dyn(),null(),null(),null());
		HX_STACK_LINE(309)
		this->_sound->load(::openfl::_v2::net::URLRequest_obj::__new(SoundURL),null(),null());
		HX_STACK_LINE(310)
		this->_looped = Looped;
		HX_STACK_LINE(311)
		this->autoDestroy = AutoDestroy;
...
::flixel::system::FlxSound FlxSound_obj::loadByteArray( ::openfl::_v2::utils::ByteArray Bytes,hx::Null< bool >  __o_Looped,hx::Null< bool >  __o_AutoDestroy,Dynamic OnComplete){
bool Looped = __o_Looped.Default(false);
bool AutoDestroy = __o_AutoDestroy.Default(false);
