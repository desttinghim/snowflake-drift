...
Void FlxQuadTree_obj::destroy( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(316)
		this->_headA = ::flixel::util::FlxDestroyUtil_obj::destroy(this->_headA);
		HX_STACK_LINE(317)
		this->_headB = ::flixel::util::FlxDestroyUtil_obj::destroy(this->_headB);
		HX_STACK_LINE(319)
		this->_tailA = ::flixel::util::FlxDestroyUtil_obj::destroy(this->_tailA);
		HX_STACK_LINE(320)
		this->_tailB = ::flixel::util::FlxDestroyUtil_obj::destroy(this->_tailB);
		HX_STACK_LINE(322)
		this->_northWestTree = ::flixel::util::FlxDestroyUtil_obj::destroy(this->_northWestTree);
		HX_STACK_LINE(323)
		this->_northEastTree = ::flixel::util::FlxDestroyUtil_obj::destroy(this->_northEastTree);
		HX_STACK_LINE(325)
		this->_southWestTree = ::flixel::util::FlxDestroyUtil_obj::destroy(this->_southWestTree);
		HX_STACK_LINE(326)
		this->_southEastTree = ::flixel::util::FlxDestroyUtil_obj::destroy(this->_southEastTree);
		HX_STACK_LINE(328)
