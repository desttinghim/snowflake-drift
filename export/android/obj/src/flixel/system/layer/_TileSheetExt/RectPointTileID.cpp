...
Void RectPointTileID_obj::__construct(int id,::openfl::_v2::geom::Rectangle rect,::openfl::_v2::geom::Point point)
{
...
hx::ObjectPtr< RectPointTileID_obj > RectPointTileID_obj::__new(int id,::openfl::_v2::geom::Rectangle rect,::openfl::_v2::geom::Point point)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::_v2::geom::Rectangle*/ ,(int)offsetof(RectPointTileID_obj,rect),HX_CSTRING("rect")},
	{hx::fsObject /*::openfl::_v2::geom::Point*/ ,(int)offsetof(RectPointTileID_obj,point),HX_CSTRING("point")},
