...
Void TileSheetExt_obj::__construct(::openfl::_v2::display::BitmapData bitmap)
{
...
hx::ObjectPtr< TileSheetExt_obj > TileSheetExt_obj::__new(::openfl::_v2::display::BitmapData bitmap)
...
::String TileSheetExt_obj::getKey( ::openfl::_v2::geom::Rectangle rect,::openfl::_v2::geom::Point point){
...
int TileSheetExt_obj::addTileRectID( ::openfl::_v2::geom::Rectangle rect,::openfl::_v2::geom::Point point){
