...
Void TileSheetData_obj::__construct(::openfl::_v2::display::BitmapData Bitmap)
{
...
hx::ObjectPtr< TileSheetData_obj > TileSheetData_obj::__new(::openfl::_v2::display::BitmapData Bitmap)
...
::flixel::system::layer::frames::FlxSpriteFrames TileSheetData_obj::getSpriteSheetFrames( ::flixel::system::layer::Region region,::openfl::_v2::geom::Point origin){
	...
	HX_STACK_LINE(95)
	::openfl::_v2::geom::Point tempPoint = origin;		HX_STACK_VAR(tempPoint,"tempPoint");
	HX_STACK_LINE(96)
	if (((origin == null()))){
		HX_STACK_LINE(98)
		tempPoint = ::openfl::_v2::geom::Point_obj::__new(pointX,pointY);
	}
	HX_STACK_LINE(101)
	...
	HX_STACK_LINE(104)
	::openfl::_v2::geom::Rectangle tempRect;		HX_STACK_VAR(tempRect,"tempRect");
	HX_STACK_LINE(106)
		...
		while(((_g1 < _g))){
			...
			HX_STACK_LINE(111)
			{
				...
				while(((_g3 < _g2))){
					...
					HX_STACK_LINE(113)
					tempRect = ::openfl::_v2::geom::Rectangle_obj::__new((startX + (i * spacedWidth)),(startY + (j * spacedHeight)),width,height);
					HX_STACK_LINE(114)
...
::String TileSheetData_obj::getSpriteSheetFrameKey( ::openfl::_v2::geom::Rectangle rect,::openfl::_v2::geom::Point point){
...
::flixel::system::layer::frames::FlxFrame TileSheetData_obj::addSpriteSheetFrame( ::openfl::_v2::geom::Rectangle rect,::openfl::_v2::geom::Point point){
...
int TileSheetData_obj::addTileRect( ::openfl::_v2::geom::Rectangle tileRect,::openfl::_v2::geom::Point point){
...
Void TileSheetData_obj::onContext( ::openfl::_v2::display::BitmapData bitmap){
{
	...
	HX_STACK_ARG(startY,"startY")
{
		...
		if ((frameData->rotated)){
			HX_STACK_LINE(261)
			texFrame = ::flixel::system::layer::frames::FlxRotatedFrame_obj::__new(hx::ObjectPtr<OBJ_>(this));
		}
		else{
			HX_STACK_LINE(265)
			texFrame = ::flixel::system::layer::frames::FlxFrame_obj::__new(hx::ObjectPtr<OBJ_>(this));
		}
		HX_STACK_LINE(268)
		...
		{
			HX_STACK_LINE(287)
			::openfl::_v2::geom::Point point = ::openfl::_v2::geom::Point_obj::__new((0.5 * texFrame->frame->width),(0.5 * texFrame->frame->height));		HX_STACK_VAR(point,"point");
			HX_STACK_LINE(287)
			texFrame->tileID = this->tileSheet->addTileRectID(texFrame->frame,point);
		}
		HX_STACK_LINE(289)
...
Dynamic TileSheetData_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"bitmap") ) { bitmap=inValue.Cast< ::openfl::_v2::display::BitmapData >(); return inValue; }
		break;
	case 9:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::_v2::display::BitmapData*/ ,(int)offsetof(TileSheetData_obj,bitmap),HX_CSTRING("bitmap")},
	{ hx::fsUnknown, 0, null()}
};
#endif
