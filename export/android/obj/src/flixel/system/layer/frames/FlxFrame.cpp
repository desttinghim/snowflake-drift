...
::openfl::_v2::display::BitmapData FlxFrame_obj::paintOnBitmap( ::openfl::_v2::display::BitmapData bmd){
	...
	struct _Function_1_1{
		inline static bool Block( ::flixel::system::layer::frames::FlxFrame_obj *__this,::openfl::_v2::display::BitmapData &bmd){
	...
	if (((  (((bmd != null()))) ? bool(_Function_1_1::Block(this,bmd)) : bool(false) ))){
		...
		if (((bool((w > this->frame->width)) || bool((h > this->frame->height))))){
			HX_STACK_LINE(65)
			::flixel::system::layer::frames::FlxFrame_obj::RECT->x = ::flixel::system::layer::frames::FlxFrame_obj::RECT->y = (int)0;
			HX_STACK_LINE(66)
...
::openfl::_v2::display::BitmapData FlxFrame_obj::getBitmap( ){
	...
	HX_STACK_LINE(95)
	this->_bitmapData = this->paintOnBitmap(null());
	HX_STACK_LINE(97)
	return this->_bitmapData;
}
...
::openfl::_v2::display::BitmapData FlxFrame_obj::getHReversedBitmap( ){
	...
	int _g = ::Std_obj::_int(this->sourceSize->x);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(111)
	this->_hReversedBitmapData = ::openfl::_v2::display::BitmapData_obj::__new(_g,::Std_obj::_int(this->sourceSize->y),true,(int)0,null());
	HX_STACK_LINE(112)
...
::openfl::_v2::display::BitmapData FlxFrame_obj::getVReversedBitmap( ){
	...
	int _g = ::Std_obj::_int(this->sourceSize->x);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(128)
	this->_vReversedBitmapData = ::openfl::_v2::display::BitmapData_obj::__new(_g,::Std_obj::_int(this->sourceSize->y),true,(int)0,null());
	HX_STACK_LINE(129)
...
::openfl::_v2::display::BitmapData FlxFrame_obj::getHVReversedBitmap( ){
	...
	HX_STACK_LINE(145)
	this->_hvReversedBitmapData = ::openfl::_v2::display::BitmapData_obj::__new(_g1,::Std_obj::_int(this->sourceSize->y),true,(int)0,null());
	HX_STACK_LINE(146)
...
Void FlxFrame_obj::destroy( ){
{
		...
		HX_STACK_LINE(157)
		this->sourceSize = ::flixel::util::FlxDestroyUtil_obj::put(this->sourceSize);
		HX_STACK_LINE(158)
		this->offset = ::flixel::util::FlxDestroyUtil_obj::put(this->offset);
		HX_STACK_LINE(159)
		this->center = ::flixel::util::FlxDestroyUtil_obj::put(this->center);
		HX_STACK_LINE(161)
...
Void FlxFrame_obj::destroyBitmapDatas( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(166)
		this->_bitmapData = ::flixel::util::FlxDestroyUtil_obj::dispose(this->_bitmapData);
		HX_STACK_LINE(167)
		this->_hReversedBitmapData = ::flixel::util::FlxDestroyUtil_obj::dispose(this->_hReversedBitmapData);
		HX_STACK_LINE(168)
		this->_vReversedBitmapData = ::flixel::util::FlxDestroyUtil_obj::dispose(this->_vReversedBitmapData);
		HX_STACK_LINE(169)
		this->_hvReversedBitmapData = ::flixel::util::FlxDestroyUtil_obj::dispose(this->_hvReversedBitmapData);
	}
return null();
}
...
::openfl::_v2::geom::Point FlxFrame_obj::POINT;

::openfl::_v2::geom::Matrix FlxFrame_obj::MATRIX;

::openfl::_v2::geom::Rectangle FlxFrame_obj::RECT;
...
Dynamic FlxFrame_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 5:
		...
		if (HX_FIELD_EQ(inName,"frame") ) { frame=inValue.Cast< ::openfl::_v2::geom::Rectangle >(); return inValue; }
		break;
	case 6:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::_v2::geom::Rectangle*/ ,(int)offsetof(FlxFrame_obj,frame),HX_CSTRING("frame")},
