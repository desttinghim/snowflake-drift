...
HX_STACK_FRAME("flixel.system.ui.FlxSoundTray","new",0x221b6352,"flixel.system.ui.FlxSoundTray.new","flixel/system/ui/FlxSoundTray.hx",22,0x04618f9d)
{
	...
	HX_STACK_LINE(54)
	::openfl::_v2::display::Bitmap tmp = ::openfl::_v2::display::Bitmap_obj::__new(::openfl::_v2::display::BitmapData_obj::__new(this->_width,(int)30,true,(int)2130706432,null()),null(),null());		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(55)
	this->screenCenter();
	HX_STACK_LINE(56)
	this->addChild(tmp);
	...
	HX_STACK_LINE(83)
	{
		...
		while(((_g < (int)10))){
			...
			HX_STACK_LINE(85)
			tmp = ::openfl::_v2::display::Bitmap_obj::__new(::openfl::_v2::display::BitmapData_obj::__new((int)4,(i + (int)1),false,(int)-1,null()),null(),null());
			HX_STACK_LINE(86)
			tmp->set_x(bx);
			HX_STACK_LINE(87)
			tmp->set_y(by);
...
Void FlxSoundTray_obj::update( Float MS){
{
		...
		if (((this->_timer > (int)0))){
			...
			HX_STACK_LINE(108)
			if (((_g > -(this->get_height())))){
				HX_STACK_LINE(110)
				{
					HX_STACK_LINE(110)
					::flixel::system::ui::FlxSoundTray _g1 = hx::ObjectPtr<OBJ_>(this);		HX_STACK_VAR(_g1,"_g1");
					HX_STACK_LINE(110)
					_g1->set_y((_g1->get_y() - (((Float(MS) / Float((int)1000)) * ::flixel::FlxG_obj::height) * (int)2)));
				}
				HX_STACK_LINE(112)
				Float _g1 = this->get_y();		HX_STACK_VAR(_g1,"_g1");
				HX_STACK_LINE(112)
				if (((_g1 <= -(this->get_height())))){
					HX_STACK_LINE(114)
					this->set_visible(false);
					HX_STACK_LINE(115)
					this->active = false;
	...
	HX_STACK_ARG(Silent,"Silent")
{
		...
		if ((!(Silent))){
			struct _Function_2_1{
				inline static ::openfl::_v2::media::Sound Block( ){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/system/ui/FlxSoundTray.hx",134,0x04618f9d)
					{
						HX_STACK_LINE(134)
						...
						HX_STACK_LINE(134)
						return ::openfl::_v2::Assets_obj::getSound((HX_CSTRING("assets/sounds/beep") + extension),null());
					}
					return null();
				}
			};
			HX_STACK_LINE(134)
			::flixel::FlxG_obj::sound->load(_Function_2_1::Block(),null(),null(),null(),null(),null(),null())->play(null());
		}
		HX_STACK_LINE(137)
		this->_timer = (int)1;
		HX_STACK_LINE(138)
...
Void FlxSoundTray_obj::screenCenter( ){
{
		...
		HX_STACK_LINE(166)
		Float _g = (0.5 * ((::openfl::_v2::Lib_obj::get_current()->get_stage()->get_stageWidth() - (this->_width * this->_defaultScale))));		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(166)
		Float _g1 = (_g - ::flixel::FlxG_obj::game->get_x());		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(166)
		this->set_x((Float(_g1) / Float(::flixel::FlxG_obj::game->get_scaleX())));
	}
return null();
}
