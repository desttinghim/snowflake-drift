...
Void FlxSplash_obj::create( ){
{
		...
		HX_STACK_LINE(60)
		this->_sprite = ::openfl::_v2::display::Sprite_obj::__new();
		HX_STACK_LINE(61)
		...
		struct _Function_1_1{
			inline static ::openfl::_v2::media::Sound Block( ){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/system/FlxSplash.hx",76,0xa5de80f2)
				{
					HX_STACK_LINE(76)
					...
					HX_STACK_LINE(76)
					return ::openfl::_v2::Assets_obj::getSound((HX_CSTRING("assets/sounds/flixel") + extension),null());
				}
				return null();
			}
		};
		HX_STACK_LINE(76)
		::flixel::FlxG_obj::sound->load(_Function_1_1::Block(),null(),null(),null(),null(),null(),null())->play(null());
	}
return null();
}
...
Void FlxSplash_obj::timerCallback( ::flixel::util::FlxTimer Timer){
{
		...
		if (((this->_curPart == (int)5))){
			...
			HX_STACK_LINE(116)
			::flixel::tweens::FlxTween_obj::tween(this->_sprite,_g,3.0,_Function_2_2::Block(this));
			...
			HX_STACK_LINE(117)
			::flixel::tweens::FlxTween_obj::tween(this->_text,_g1,3.0,_Function_2_4::Block());
		}
	}
return null();
}
