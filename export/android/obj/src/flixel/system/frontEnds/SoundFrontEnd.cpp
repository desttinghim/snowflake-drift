...
HX_STACK_FRAME("flixel.system.frontEnds.SoundFrontEnd","new",0x71610699,"flixel.system.frontEnds.SoundFrontEnd.new","flixel/system/frontEnds/SoundFrontEnd.hx",14,0x9ba4fb18)
{
	...
	HX_STACK_LINE(263)
	this->_soundCache = ::haxe::ds::StringMap_obj::__new();
}
;
	return null();
}
...
::openfl::_v2::media::Sound SoundFrontEnd_obj::cache( ::String EmbeddedSound){
	...
	if ((this->_soundCache->exists(EmbeddedSound))){
		...
		HX_STACK_LINE(144)
		::openfl::_v2::media::Sound sound = ::openfl::_v2::Assets_obj::getSound(EmbeddedSound,null());		HX_STACK_VAR(sound,"sound");
		HX_STACK_LINE(145)
...
{
		HX_STACK_LINE(162)
		::openfl::_v2::media::Sound sound = null();		HX_STACK_VAR(sound,"sound");
		HX_STACK_LINE(164)
		if ((this->_soundCache->exists(EmbeddedSound))){
			HX_STACK_LINE(166)
			sound = this->_soundCache->get(EmbeddedSound);
		}
		else{
			HX_STACK_LINE(170)
			sound = ::openfl::_v2::Assets_obj::getSound(EmbeddedSound,null());
			HX_STACK_LINE(171)
			this->_soundCache->set(EmbeddedSound,sound);
		}
		HX_STACK_LINE(173)
