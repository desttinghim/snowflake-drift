...
::flixel::util::loaders::CachedGraphics BitmapFrontEnd_obj::get_whitePixel( ){
	...
	if (((this->_whitePixel == null()))){
		HX_STACK_LINE(34)
		::openfl::_v2::display::BitmapData bd = ::openfl::_v2::display::BitmapData_obj::__new((int)2,(int)2,true,(int)-1,null());		HX_STACK_VAR(bd,"bd");
		HX_STACK_LINE(35)
		...
		HX_STACK_LINE(37)
		{
			...
			HX_STACK_LINE(37)
			::openfl::_v2::geom::Rectangle tileRect = ::openfl::_v2::geom::Rectangle_obj::__new((int)0,(int)0,(int)1,(int)1);		HX_STACK_VAR(tileRect,"tileRect");
			HX_STACK_LINE(37)
			::openfl::_v2::geom::Point point = ::openfl::_v2::geom::Point_obj::__new((int)0,(int)0);		HX_STACK_VAR(point,"point");
			HX_STACK_LINE(37)
	...
	HX_STACK_ARG(Key,"Key")
{
		...
		if (((key == null()))){
			...
			struct _Function_2_1{
				inline static bool Block( ::flixel::system::frontEnds::BitmapFrontEnd_obj *__this,::String &key){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/system/frontEnds/BitmapFrontEnd.hx",111,0x91a05ae2)
					{
						HX_STACK_LINE(111)
						return (  ((__this->_cache->exists(key))) ? bool((__this->_cache->get(key) != null())) : bool(false) );
					}
					return null();
				}
			};
		...
		HX_STACK_LINE(116)
		if ((!(((  ((this->_cache->exists(key))) ? bool((this->_cache->get(key) != null())) : bool(false) ))))){
			HX_STACK_LINE(118)
			::flixel::util::loaders::CachedGraphics value = ::flixel::util::loaders::CachedGraphics_obj::__new(key,::openfl::_v2::display::BitmapData_obj::__new(Width,Height,true,Color,null()),null());		HX_STACK_VAR(value,"value");
			HX_STACK_LINE(118)
	...
	HX_STACK_ARG(Key,"Key")
{
		...
		if ((!(((  ((this->_cache->exists(key))) ? bool((this->_cache->get(key) != null())) : bool(false) ))))){
				...
				if ((isBitmap)){
					...
					if ((isRegion)){
						...
						if ((isGraphics)){
							...
							HX_STACK_LINE(265)
							bd = ::openfl::_v2::Assets_obj::getBitmapData(id,false);
						}
					}
				}
			}
			...
			if (((bool((FrameWidth > (int)0)) || bool((FrameHeight > (int)0))))){
				...
				HX_STACK_LINE(276)
				::openfl::_v2::display::BitmapData tempBitmap = ::openfl::_v2::display::BitmapData_obj::__new(_g,(bd->get_height() + (numVerticalFrames * SpacingY)),true,(int)0,null());		HX_STACK_VAR(tempBitmap,"tempBitmap");
				HX_STACK_LINE(277)
				tempBitmap->lock();
				HX_STACK_LINE(278)
...
::String BitmapFrontEnd_obj::getCacheKeyFor( ::openfl::_v2::display::BitmapData bmd){
...
{
		HX_STACK_LINE(356)
		if (((  ((this->_cache->exists(baseKey))) ? bool((this->_cache->get(baseKey) != null())) : bool(false) ))){
			HX_STACK_LINE(358)
...
while(((  ((this->_cache->exists(ukey))) ? bool((this->_cache->get(ukey) != null())) : bool(false) )));
			HX_STACK_LINE(364)
			baseKey = ukey;
		}
		HX_STACK_LINE(366)
...
Void BitmapFrontEnd_obj::removeFromOpenFLCache( ::String key){
{
		...
		HX_STACK_ARG(key,"key")
		HX_STACK_LINE(389)
		::openfl::_v2::Assets_obj::cache->removeBitmapData(key);
	}
return null();
}
