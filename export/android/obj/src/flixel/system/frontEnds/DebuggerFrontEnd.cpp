...
::flixel::system::ui::FlxSystemButton DebuggerFrontEnd_obj::addButton( ::flixel::system::debug::ButtonAlignment Alignment,::openfl::_v2::display::BitmapData Icon,Dynamic UpHandler,hx::Null< bool >  __o_ToggleMode,hx::Null< bool >  __o_UpdateLayout){
...
::flixel::system::debug::Window DebuggerFrontEnd_obj::track( Dynamic Object,::String WindowTitle){
	HX_STACK_FRAME("flixel.system.frontEnds.DebuggerFrontEnd","track",0x1a1fb78a,"flixel.system.frontEnds.DebuggerFrontEnd.track","flixel/system/frontEnds/DebuggerFrontEnd.hx",90,0x2ebb4b30)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Object,"Object")
	HX_STACK_ARG(WindowTitle,"WindowTitle")
	HX_STACK_LINE(90)
	if (((::flixel::system::debug::Tracker_obj::objectsBeingTracked->__Field(HX_CSTRING("indexOf"),true)(Object,null()) == (int)-1))){
		HX_STACK_LINE(92)
			...
			HX_STACK_LINE(95)
			{
				...
				struct _Function_4_1{
					inline static ::String Block( Dynamic &Object){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/system/frontEnds/DebuggerFrontEnd.hx",95,0x2ebb4b30)
						{
							HX_STACK_LINE(95)
				...
				HX_STACK_LINE(95)
				Data = ((HX_CSTRING("FlxG.debugger.track(): Could not find a tracking profile for this object of class '") + _Function_4_1::Block(Object)) + HX_CSTRING("'."));
				HX_STACK_LINE(95)
