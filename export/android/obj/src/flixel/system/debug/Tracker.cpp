...
HX_STACK_ARG(WindowTitle,"WindowTitle")
{
	...
	struct _Function_1_1{
		inline static ::String Block( ::flixel::system::debug::Tracker_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/system/debug/Tracker.hx",160,0x59950a0f)
			{
				HX_STACK_LINE(160)
				Dynamic Obj = __this->_object;		HX_STACK_VAR(Obj,"Obj");
				HX_STACK_LINE(160)
	...
	HX_STACK_LINE(160)
	this->_title->set_text((  (((WindowTitle == null()))) ? ::String(_Function_1_1::Block(this)) : ::String(WindowTitle) ));
	HX_STACK_LINE(161)
...
Void Tracker_obj::initProfiles( ){
{
		...
		if (((::flixel::system::debug::Tracker_obj::profiles == null()))){
			...
			{
				HX_STACK_LINE(95)
				Array< ::String > _g = Array_obj< ::String >::__new().Add(HX_CSTRING("width")).Add(HX_CSTRING("height"));		HX_STACK_VAR(_g,"_g");
				HX_STACK_LINE(95)
				::flixel::system::debug::TrackerProfile Profile = ::flixel::system::debug::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::util::FlxRect >(),_g,Array_obj< ::Dynamic >::__new().Add(hx::ClassOf< ::flixel::util::FlxPoint >()));		HX_STACK_VAR(Profile,"Profile");
				HX_STACK_LINE(95)
				if (((Profile != null()))){
					HX_STACK_LINE(95)
					::flixel::system::debug::Tracker_obj::profiles->push(Profile);
			...
			{
				HX_STACK_LINE(98)
				Array< ::String > _g1 = Array_obj< ::String >::__new().Add(HX_CSTRING("velocity")).Add(HX_CSTRING("acceleration")).Add(HX_CSTRING("drag")).Add(HX_CSTRING("angle"));		HX_STACK_VAR(_g1,"_g1");
				HX_STACK_LINE(98)
				::flixel::system::debug::TrackerProfile Profile = ::flixel::system::debug::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::FlxObject >(),_g1,Array_obj< ::Dynamic >::__new().Add(hx::ClassOf< ::flixel::util::FlxRect >()).Add(hx::ClassOf< ::flixel::FlxBasic >()));		HX_STACK_VAR(Profile,"Profile");
				HX_STACK_LINE(98)
				if (((Profile != null()))){
					HX_STACK_LINE(98)
					::flixel::system::debug::Tracker_obj::profiles->push(Profile);
			...
			{
				HX_STACK_LINE(100)
				Array< ::String > _g2 = Array_obj< ::String >::__new().Add(HX_CSTRING("auto")).Add(HX_CSTRING("widthInTiles")).Add(HX_CSTRING("heightInTiles")).Add(HX_CSTRING("totalTiles")).Add(HX_CSTRING("scaleX")).Add(HX_CSTRING("scaleY"));		HX_STACK_VAR(_g2,"_g2");
				HX_STACK_LINE(100)
				::flixel::system::debug::TrackerProfile Profile = ::flixel::system::debug::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::tile::FlxTilemap >(),_g2,Array_obj< ::Dynamic >::__new().Add(hx::ClassOf< ::flixel::FlxObject >()));		HX_STACK_VAR(Profile,"Profile");
				HX_STACK_LINE(100)
				if (((Profile != null()))){
					HX_STACK_LINE(100)
					::flixel::system::debug::Tracker_obj::profiles->push(Profile);
			...
			{
				HX_STACK_LINE(101)
				Array< ::String > _g3 = Array_obj< ::String >::__new().Add(HX_CSTRING("frameWidth")).Add(HX_CSTRING("frameHeight")).Add(HX_CSTRING("alpha")).Add(HX_CSTRING("origin")).Add(HX_CSTRING("offset")).Add(HX_CSTRING("scale"));		HX_STACK_VAR(_g3,"_g3");
				HX_STACK_LINE(101)
				::flixel::system::debug::TrackerProfile Profile = ::flixel::system::debug::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::FlxSprite >(),_g3,Array_obj< ::Dynamic >::__new().Add(hx::ClassOf< ::flixel::FlxObject >()));		HX_STACK_VAR(Profile,"Profile");
				HX_STACK_LINE(101)
				if (((Profile != null()))){
					HX_STACK_LINE(101)
					::flixel::system::debug::Tracker_obj::profiles->push(Profile);
			...
			{
				HX_STACK_LINE(102)
				Array< ::String > _g4 = Array_obj< ::String >::__new().Add(HX_CSTRING("status")).Add(HX_CSTRING("labelAlphas"));		HX_STACK_VAR(_g4,"_g4");
				HX_STACK_LINE(102)
				::flixel::system::debug::TrackerProfile Profile = ::flixel::system::debug::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::ui::FlxTypedButton >(),_g4,Array_obj< ::Dynamic >::__new().Add(hx::ClassOf< ::flixel::FlxSprite >()));		HX_STACK_VAR(Profile,"Profile");
				HX_STACK_LINE(102)
				if (((Profile != null()))){
					HX_STACK_LINE(102)
					::flixel::system::debug::Tracker_obj::profiles->push(Profile);
			...
			{
				HX_STACK_LINE(104)
				Array< ::String > _g5 = Array_obj< ::String >::__new().Add(HX_CSTRING("min")).Add(HX_CSTRING("max")).Add(HX_CSTRING("range")).Add(HX_CSTRING("pct")).Add(HX_CSTRING("pxPerPercent")).Add(HX_CSTRING("value"));		HX_STACK_VAR(_g5,"_g5");
				HX_STACK_LINE(104)
				::flixel::system::debug::TrackerProfile Profile = ::flixel::system::debug::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::ui::FlxBar >(),_g5,Array_obj< ::Dynamic >::__new().Add(hx::ClassOf< ::flixel::FlxSprite >()));		HX_STACK_VAR(Profile,"Profile");
				HX_STACK_LINE(104)
				if (((Profile != null()))){
					HX_STACK_LINE(104)
					::flixel::system::debug::Tracker_obj::profiles->push(Profile);
			...
			{
				HX_STACK_LINE(106)
				Array< ::String > _g6 = Array_obj< ::String >::__new().Add(HX_CSTRING("text")).Add(HX_CSTRING("size")).Add(HX_CSTRING("font")).Add(HX_CSTRING("embedded")).Add(HX_CSTRING("bold")).Add(HX_CSTRING("italic")).Add(HX_CSTRING("wordWrap")).Add(HX_CSTRING("borderSize")).Add(HX_CSTRING("borderStyle"));		HX_STACK_VAR(_g6,"_g6");
				HX_STACK_LINE(106)
				::flixel::system::debug::TrackerProfile Profile = ::flixel::system::debug::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::text::FlxText >(),_g6,Array_obj< ::Dynamic >::__new().Add(hx::ClassOf< ::flixel::FlxSprite >()));		HX_STACK_VAR(Profile,"Profile");
				HX_STACK_LINE(106)
				if (((Profile != null()))){
					HX_STACK_LINE(106)
					::flixel::system::debug::Tracker_obj::profiles->push(Profile);
			...
			{
				HX_STACK_LINE(109)
				Array< ::String > _g7 = Array_obj< ::String >::__new().Add(HX_CSTRING("length")).Add(HX_CSTRING("members.length")).Add(HX_CSTRING("maxSize"));		HX_STACK_VAR(_g7,"_g7");
				HX_STACK_LINE(109)
				::flixel::system::debug::TrackerProfile Profile = ::flixel::system::debug::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::group::FlxTypedGroup >(),_g7,Array_obj< ::Dynamic >::__new().Add(hx::ClassOf< ::flixel::FlxBasic >()));		HX_STACK_VAR(Profile,"Profile");
				HX_STACK_LINE(109)
				if (((Profile != null()))){
					HX_STACK_LINE(109)
					::flixel::system::debug::Tracker_obj::profiles->push(Profile);
			...
			{
				HX_STACK_LINE(111)
				Array< ::String > _g8 = Array_obj< ::String >::__new().Add(HX_CSTRING("persistentUpdate")).Add(HX_CSTRING("persistentDraw")).Add(HX_CSTRING("destroySubStates")).Add(HX_CSTRING("bgColor"));		HX_STACK_VAR(_g8,"_g8");
				HX_STACK_LINE(111)
				::flixel::system::debug::TrackerProfile Profile = ::flixel::system::debug::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::FlxState >(),_g8,Array_obj< ::Dynamic >::__new().Add(hx::ClassOf< ::flixel::group::FlxTypedGroup >()));		HX_STACK_VAR(Profile,"Profile");
				HX_STACK_LINE(111)
				if (((Profile != null()))){
					HX_STACK_LINE(111)
					::flixel::system::debug::Tracker_obj::profiles->push(Profile);
			...
			{
				HX_STACK_LINE(113)
				Array< ::String > _g9 = Array_obj< ::String >::__new().Add(HX_CSTRING("style")).Add(HX_CSTRING("followLerp")).Add(HX_CSTRING("followLead")).Add(HX_CSTRING("deadzone")).Add(HX_CSTRING("bounds")).Add(HX_CSTRING("zoom")).Add(HX_CSTRING("alpha")).Add(HX_CSTRING("angle"));		HX_STACK_VAR(_g9,"_g9");
				HX_STACK_LINE(113)
				::flixel::system::debug::TrackerProfile Profile = ::flixel::system::debug::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::FlxCamera >(),_g9,Array_obj< ::Dynamic >::__new().Add(hx::ClassOf< ::flixel::FlxBasic >()).Add(hx::ClassOf< ::flixel::util::FlxRect >()));		HX_STACK_VAR(Profile,"Profile");
				HX_STACK_LINE(113)
				if (((Profile != null()))){
					HX_STACK_LINE(113)
					::flixel::system::debug::Tracker_obj::profiles->push(Profile);
			...
			{
				HX_STACK_LINE(131)
				Array< ::String > _g11 = Array_obj< ::String >::__new().Add(HX_CSTRING("screenX")).Add(HX_CSTRING("screenY")).Add(HX_CSTRING("touchPointID")).Add(HX_CSTRING("pressed")).Add(HX_CSTRING("justPressed")).Add(HX_CSTRING("justReleased")).Add(HX_CSTRING("isActive"));		HX_STACK_VAR(_g11,"_g11");
				HX_STACK_LINE(131)
				::flixel::system::debug::TrackerProfile Profile = ::flixel::system::debug::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::input::touch::FlxTouch >(),_g11,Array_obj< ::Dynamic >::__new().Add(hx::ClassOf< ::flixel::util::FlxPoint >()));		HX_STACK_VAR(Profile,"Profile");
				HX_STACK_LINE(131)
				if (((Profile != null()))){
					HX_STACK_LINE(131)
					::flixel::system::debug::Tracker_obj::profiles->push(Profile);
			...
			{
				HX_STACK_LINE(141)
				Array< ::String > _g12 = Array_obj< ::String >::__new().Add(HX_CSTRING("z")).Add(HX_CSTRING("scaleX")).Add(HX_CSTRING("scaleY")).Add(HX_CSTRING("mouseX")).Add(HX_CSTRING("mouseY")).Add(HX_CSTRING("rotationX")).Add(HX_CSTRING("rotationY")).Add(HX_CSTRING("visible"));		HX_STACK_VAR(_g12,"_g12");
				HX_STACK_LINE(141)
				::flixel::system::debug::TrackerProfile Profile = ::flixel::system::debug::TrackerProfile_obj::__new(hx::ClassOf< ::openfl::_v2::display::DisplayObject >(),_g12,Array_obj< ::Dynamic >::__new().Add(hx::ClassOf< ::flixel::util::FlxRect >()));		HX_STACK_VAR(Profile,"Profile");
				HX_STACK_LINE(141)
				if (((Profile != null()))){
					HX_STACK_LINE(141)
					::flixel::system::debug::Tracker_obj::profiles->push(Profile);
			...
			{
				HX_STACK_LINE(142)
				::flixel::system::debug::TrackerProfile Profile = ::flixel::system::debug::TrackerProfile_obj::__new(hx::ClassOf< ::openfl::_v2::geom::Point >(),null(),Array_obj< ::Dynamic >::__new().Add(hx::ClassOf< ::flixel::util::FlxPoint >()));		HX_STACK_VAR(Profile,"Profile");
				HX_STACK_LINE(142)
				if (((Profile != null()))){
					HX_STACK_LINE(142)
					::flixel::system::debug::Tracker_obj::profiles->push(Profile);
			...
			{
				HX_STACK_LINE(143)
				::flixel::system::debug::TrackerProfile Profile = ::flixel::system::debug::TrackerProfile_obj::__new(hx::ClassOf< ::openfl::_v2::geom::Rectangle >(),null(),Array_obj< ::Dynamic >::__new().Add(hx::ClassOf< ::flixel::util::FlxRect >()));		HX_STACK_VAR(Profile,"Profile");
				HX_STACK_LINE(143)
				if (((Profile != null()))){
					HX_STACK_LINE(143)
					::flixel::system::debug::Tracker_obj::profiles->push(Profile);
			...
			{
				HX_STACK_LINE(144)
				::flixel::system::debug::TrackerProfile Profile = ::flixel::system::debug::TrackerProfile_obj::__new(hx::ClassOf< ::openfl::_v2::geom::Matrix >(),Array_obj< ::String >::__new().Add(HX_CSTRING("a")).Add(HX_CSTRING("b")).Add(HX_CSTRING("c")).Add(HX_CSTRING("d")).Add(HX_CSTRING("tx")).Add(HX_CSTRING("ty")),null());		HX_STACK_VAR(Profile,"Profile");
				HX_STACK_LINE(144)
				if (((Profile != null()))){
					HX_STACK_LINE(144)
					::flixel::system::debug::Tracker_obj::profiles->push(Profile);
