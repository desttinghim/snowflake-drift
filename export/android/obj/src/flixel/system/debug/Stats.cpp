...
HX_STACK_FRAME("flixel.system.debug.Stats","new",0x4140b8e9,"flixel.system.debug.Stats.new","flixel/system/debug/Stats.hx",28,0xa5a2e9c8)
{
	...
	HX_STACK_LINE(120)
	int graphY = (::Std_obj::_int(this->_header->get_height()) + gutter);		HX_STACK_VAR(graphY,"graphY");
	HX_STACK_LINE(121)
	int graphHeight = (int)40;		HX_STACK_VAR(graphHeight,"graphHeight");
	HX_STACK_LINE(122)
	int graphWidth = (int)140;		HX_STACK_VAR(graphWidth,"graphWidth");
	HX_STACK_LINE(124)
	this->fpsGraph = ::flixel::system::debug::StatsGraph_obj::__new(graphX,graphY,graphWidth,graphHeight,(int)-6881536,HX_CSTRING("fps"),null(),null());
	HX_STACK_LINE(125)
	...
	HX_STACK_LINE(129)
	graphY = ((::Std_obj::_int(this->_header->get_height()) + graphHeight) + (int)20);
	HX_STACK_LINE(131)
	this->memoryGraph = ::flixel::system::debug::StatsGraph_obj::__new(graphX,graphY,graphWidth,graphHeight,(int)-16737025,HX_CSTRING("MB"),null(),null());
	HX_STACK_LINE(132)
	this->addChild(this->memoryGraph);
	HX_STACK_LINE(134)
	graphY = (::Std_obj::_int(this->_header->get_height()) + gutter);
	HX_STACK_LINE(135)
	hx::AddEq(graphX,((gutter + graphWidth) + (int)20));
	HX_STACK_LINE(136)
	hx::SubEq(graphWidth,(int)10);
	HX_STACK_LINE(138)
	this->updateTimeGraph = ::flixel::system::debug::StatsGraph_obj::__new(graphX,graphY,graphWidth,graphHeight,(int)-2305024,HX_CSTRING("ms"),(int)35,HX_CSTRING("Update"));
	HX_STACK_LINE(139)
	...
	graphY = ((::Std_obj::_int(this->_header->get_height()) + graphHeight) + (int)20);
	HX_STACK_LINE(144)
	this->drawTimeGraph = ::flixel::system::debug::StatsGraph_obj::__new(graphX,graphY,graphWidth,graphHeight,(int)-4784128,HX_CSTRING("ms"),(int)35,HX_CSTRING("Draw"));
	HX_STACK_LINE(145)
	...
	HX_STACK_LINE(156)
	this->_toggleSizeButton = ::flixel::system::ui::FlxSystemButton_obj::__new(::flixel::system::debug::_Stats::GraphicMaximizeButton_obj::__new((int)0,(int)0,null(),null()),this->toggleSize_dyn(),null());
	HX_STACK_LINE(157)
...
Void Stats_obj::update( ){
{
		...
		if (((this->_updateTimer > (int)250))){
			...
			HX_STACK_LINE(254)
			this->memoryGraph->update((Float((Float(::openfl::_v2::system::System_obj::get_totalMemory()) / Float((int)1024))) / Float((int)1000)),null());
			HX_STACK_LINE(255)
			this->updateTexts();
			HX_STACK_LINE(257)
...
Float Stats_obj::currentMem( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(358)
	return (Float((Float(::openfl::_v2::system::System_obj::get_totalMemory()) / Float((int)1024))) / Float((int)1000));
}
...
Void Stats_obj::toggleSize( ){
{
		...
		if (((this->_width == (int)160))){
			...
			HX_STACK_LINE(447)
			this->_toggleSizeButton->changeIcon(::flixel::system::debug::_Stats::GraphicMinimizeButton_obj::__new((int)0,(int)0,null(),null()));
		}
		else{
			HX_STACK_LINE(451)
			...
			this->updateTimeGraph->set_visible(false);
			HX_STACK_LINE(455)
			this->_toggleSizeButton->changeIcon(::flixel::system::debug::_Stats::GraphicMaximizeButton_obj::__new((int)0,(int)0,null(),null()));
		}
		HX_STACK_LINE(458)
		this->updateSize();
		HX_STACK_LINE(459)
...
Void Stats_obj::updateSize( ){
{
		...
		if (((this->_toggleSizeButton != null()))){
			HX_STACK_LINE(467)
			this->_toggleSizeButton->set_x(((this->_width - this->_toggleSizeButton->get_width()) - (int)3));
			HX_STACK_LINE(468)
