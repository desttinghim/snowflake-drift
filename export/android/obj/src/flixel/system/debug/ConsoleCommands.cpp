...
Void ConsoleCommands_obj::set( ::String ObjectAndVariable,Dynamic NewVariableValue,::String WatchName){
{
		...
		HX_STACK_LINE(169)
		{
			...
			splitString->shift();
			HX_STACK_LINE(169)
			ObjectAndVariable1 = splitString->join(HX_CSTRING("."));
			HX_STACK_LINE(169)
				...
				HX_STACK_LINE(216)
				{
					...
					struct _Function_4_1{
						inline static ::String Block( Dynamic &variable){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/system/debug/ConsoleCommands.hx",216,0x4441c1e8)
							{
								HX_STACK_LINE(216)
		...
		HX_STACK_LINE(221)
		{
			...
			struct _Function_2_1{
				inline static ::String Block( Dynamic &object){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/system/debug/ConsoleCommands.hx",221,0x4441c1e8)
					{
						HX_STACK_LINE(221)
						::Class cl;		HX_STACK_VAR(cl,"cl");
						HX_STACK_LINE(221)
	...
	HX_STACK_ARG(NumSuperClassesToInclude,"NumSuperClassesToInclude")
{
		...
		if (((  ((::Std_obj::is(pathToVariable->__Field(HX_CSTRING("object"),true),hx::ClassOf< ::Class >()))) ? bool((pathToVariable->__Field(HX_CSTRING("variableName"),true) == HX_CSTRING(""))) : bool(false) ))){
			HX_STACK_LINE(240)
			fields = ::Type_obj::getClassFields(pathToVariable->__Field(HX_CSTRING("object"),true));
		}
		else{
			HX_STACK_LINE(244)
			...
			HX_STACK_LINE(249)
			fields = ::flixel::system::debug::ConsoleUtil_obj::getInstanceFieldsAdvanced(cl,NumSuperClassesToInclude);
		}
		HX_STACK_LINE(252)
		...
		if ((!(::Reflect_obj::isFunction(func)))){
			...
			if ((!(::Reflect_obj::isObject(object)))){
				HX_STACK_LINE(278)
				{
					...
					struct _Function_4_1{
						inline static ::String Block( Dynamic &object){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/system/debug/ConsoleCommands.hx",278,0x4441c1e8)
							{
								HX_STACK_LINE(278)
								::Class cl;		HX_STACK_VAR(cl,"cl");
								HX_STACK_LINE(278)
								...
								HX_STACK_LINE(296)
								{
									...
									struct _Function_6_1{
										inline static ::String Block( Dynamic &tempObj){
											HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/system/debug/ConsoleCommands.hx",296,0x4441c1e8)
											{
												HX_STACK_LINE(296)
												::Class cl;		HX_STACK_VAR(cl,"cl");
												HX_STACK_LINE(296)
			...
			if (((func == null()))){
				HX_STACK_LINE(307)
				{
					...
					struct _Function_4_1{
						inline static ::String Block( Dynamic &tempObj){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/system/debug/ConsoleCommands.hx",307,0x4441c1e8)
							{
								HX_STACK_LINE(307)
								::Class cl;		HX_STACK_VAR(cl,"cl");
								HX_STACK_LINE(307)
...
Void ConsoleCommands_obj::listObjects( ){
{
		...
		struct _Function_1_1{
			inline static ::String Block( ::flixel::system::debug::ConsoleCommands_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/system/debug/ConsoleCommands.hx",330,0x4441c1e8)
				{
					HX_STACK_LINE(330)
...
Void ConsoleCommands_obj::listFunctions( ){
{
		...
		struct _Function_1_1{
			inline static ::String Block( ::flixel::system::debug::ConsoleCommands_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/system/debug/ConsoleCommands.hx",335,0x4441c1e8)
				{
					HX_STACK_LINE(335)
					::String string = HX_CSTRING("");		HX_STACK_VAR(string,"string");
					HX_STACK_LINE(335)
...
Void ConsoleCommands_obj::track( ::String ObjectAndVariable){
{
		...
		struct _Function_1_1{
			inline static Dynamic Block( Dynamic &pathToVariable){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/system/debug/ConsoleCommands.hx",357,0x4441c1e8)
				{
					HX_STACK_LINE(357)
					Dynamic o = pathToVariable->__Field(HX_CSTRING("object"),true);		HX_STACK_VAR(o,"o");
					HX_STACK_LINE(357)
					return (  (((o == null()))) ? Dynamic(null()) : Dynamic(o->__Field(pathToVariable->__Field(HX_CSTRING("variableName"),true),true)) );
				}
				return null();
			}
		};
		HX_STACK_LINE(357)
		::flixel::FlxG_obj::debugger->track(_Function_1_1::Block(pathToVariable),null());
	}
return null();
}
