...
Void VCR_obj::onPause( ){
{
		...
		HX_STACK_LINE(147)
		this->playbackToggleBtn->changeIcon(::flixel::system::debug::GraphicArrowRight_obj::__new((int)0,(int)0,null(),null()));
	}
return null();
}
...
Dynamic VCR_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 10:
		...
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"runtimeDisplay") ) { runtimeDisplay=inValue.Cast< ::openfl::_v2::text::TextField >(); return inValue; }
		break;
	case 17:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::_v2::text::TextField*/ ,(int)offsetof(VCR_obj,runtimeDisplay),HX_CSTRING("runtimeDisplay")},
