...
HX_STACK_FRAME("flixel.system.debug.Console","new",0x1c127021,"flixel.system.debug.Console.new","flixel/system/debug/Console.hx",24,0x3559cbd0)
{
	...
	HX_STACK_LINE(98)
	this->_input = ::openfl::_v2::text::TextField_obj::__new();
	HX_STACK_LINE(99)
	this->_input->set_type(::openfl::text::TextFieldType_obj::INPUT);
	HX_STACK_LINE(100)
	this->_input->set_embedFonts(true);
	HX_STACK_LINE(101)
	this->_input->set_defaultTextFormat(::openfl::_v2::text::TextFormat_obj::__new(::flixel::system::FlxAssets_obj::FONT_DEBUGGER,(int)13,(int)16777215,false,false,false,null(),null(),null(),null(),null(),null(),null()));
	HX_STACK_LINE(102)
...
Void Console_obj::onKeyPress( ::openfl::_v2::events::KeyboardEvent e){
{
		...
		HX_STACK_ARG(e,"e")
		HX_STACK_LINE(161)
		if (((  (((e->keyCode == (int)32))) ? bool((this->_input->get_text() == HX_CSTRING(" "))) : bool(false) ))){
			HX_STACK_LINE(162)
			this->_input->set_text(HX_CSTRING(""));
		}
		HX_STACK_LINE(165)
		if (((  (((e->keyCode == (int)13))) ? bool((this->_input->get_text() != HX_CSTRING(""))) : bool(false) ))){
			HX_STACK_LINE(166)
			this->processCommand();
		}
		else{
					...
					if (((e->keyCode == (int)38))){
						...
						struct _Function_5_1{
							inline static ::String Block( ::flixel::system::debug::Console_obj *__this){
								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/system/debug/Console.hx",182,0x3559cbd0)
								{
									HX_STACK_LINE(182)
						...
						if (((e->keyCode == (int)40))){
							...
							struct _Function_6_1{
								inline static ::String Block( ::flixel::system::debug::Console_obj *__this){
									HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/system/debug/Console.hx",193,0x3559cbd0)
									{
										HX_STACK_LINE(193)
