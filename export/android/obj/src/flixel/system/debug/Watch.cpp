...
{
	HX_STACK_LINE(39)
	super::__construct(HX_CSTRING("watch"),::flixel::system::debug::GraphicWatch_obj::__new((int)0,(int)0,null(),null()),(int)0,(int)0,true,null(),Closable);
	HX_STACK_LINE(41)
	this->_names = ::openfl::_v2::display::Sprite_obj::__new();
	HX_STACK_LINE(42)
	...
	HX_STACK_LINE(46)
	this->_values = ::openfl::_v2::display::Sprite_obj::__new();
	HX_STACK_LINE(47)
		...
		if (((this->_watching != null()))){
			HX_STACK_LINE(77)
			{
				...
				while(((_g < _g1->length))){
					...
					++(_g);
					HX_STACK_LINE(79)
					watchEntry = ::flixel::util::FlxDestroyUtil_obj::destroy(watchEntry);
				}
			}
			HX_STACK_LINE(81)
			this->_watching = null();
...
Void Watch_obj::remove( Dynamic AnyObject,::String VariableName,::String QuickWatchName){
{
		...
		if (((bool((bool((AnyObject == null())) && bool((VariableName == null())))) && bool((QuickWatchName != null()))))){
			...
			if (((quickWatch != null()))){
				HX_STACK_LINE(172)
				this->removeEntry(quickWatch,this->_watching->indexOf(quickWatch,null()));
			}
			HX_STACK_LINE(174)
...
Dynamic Watch_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"_names") ) { _names=inValue.Cast< ::openfl::_v2::display::Sprite >(); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"editing") ) { editing=inValue.Cast< bool >(); return inValue; }
		if (HX_FIELD_EQ(inName,"_values") ) { _values=inValue.Cast< ::openfl::_v2::display::Sprite >(); return inValue; }
		break;
	case 9:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::_v2::display::Sprite*/ ,(int)offsetof(Watch_obj,_names),HX_CSTRING("_names")},
	{hx::fsObject /*::openfl::_v2::display::Sprite*/ ,(int)offsetof(Watch_obj,_values),HX_CSTRING("_values")},
