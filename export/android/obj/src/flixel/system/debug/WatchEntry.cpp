...
HX_STACK_ARG(Custom,"Custom")
{
	...
	HX_STACK_LINE(123)
	this->_whiteText = ::openfl::_v2::text::TextFormat_obj::__new(fontName,(int)12,color,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
	HX_STACK_LINE(124)
	this->_blackText = ::openfl::_v2::text::TextFormat_obj::__new(fontName,(int)12,(int)0,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
	HX_STACK_LINE(126)
	this->nameDisplay = ::openfl::_v2::text::TextField_obj::__new();
	HX_STACK_LINE(127)
	...
	HX_STACK_LINE(133)
	this->valueDisplay = ::openfl::_v2::text::TextField_obj::__new();
	HX_STACK_LINE(134)
	...
	if ((!(this->quickWatch))){
		HX_STACK_LINE(142)
		this->valueDisplay->addEventListener(::openfl::_v2::events::KeyboardEvent_obj::KEY_UP,this->onKeyUp_dyn(),null(),null(),null());
		HX_STACK_LINE(143)
		this->valueDisplay->addEventListener(::openfl::_v2::events::MouseEvent_obj::MOUSE_UP,this->onMouseUp_dyn(),null(),null(),null());
	}
	HX_STACK_LINE(145)
...
Void WatchEntry_obj::destroy( ){
{
		...
		if (((this->valueDisplay != null()))){
			HX_STACK_LINE(165)
			this->valueDisplay->removeEventListener(::openfl::_v2::events::MouseEvent_obj::MOUSE_UP,this->onMouseUp_dyn(),null());
			HX_STACK_LINE(166)
			this->valueDisplay->removeEventListener(::openfl::_v2::events::KeyboardEvent_obj::KEY_UP,this->onKeyUp_dyn(),null());
			HX_STACK_LINE(167)
				...
				if (((NameWidth > (int)120))){
					struct _Function_4_1{
						inline static ::String Block( ::flixel::system::debug::WatchEntry_obj *__this){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/system/debug/WatchEntry.hx",196,0x35f5be92)
							{
								HX_STACK_LINE(196)
...
Void WatchEntry_obj::onMouseUp( ::openfl::_v2::events::MouseEvent FlashEvent){
{
...
Void WatchEntry_obj::onKeyUp( ::openfl::_v2::events::KeyboardEvent FlashEvent){
{
...
::String WatchEntry_obj::toString( ){
	...
	struct _Function_1_1{
		inline static ::flixel::util::LabelValuePair Block( ::flixel::system::debug::WatchEntry_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/system/debug/WatchEntry.hx",304,0x35f5be92)
			{
				HX_STACK_LINE(304)
				::flixel::util::LabelValuePair _this = ::flixel::util::LabelValuePair_obj::_pool->get();		HX_STACK_VAR(_this,"_this");
				HX_STACK_LINE(304)
	...
	HX_STACK_LINE(302)
	return ::flixel::util::FlxStringUtil_obj::getDebugString(Array_obj< ::Dynamic >::__new().Add(_g).Add(_Function_1_1::Block(this)));
}
...
Dynamic WatchEntry_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 8:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"_whiteText") ) { _whiteText=inValue.Cast< ::openfl::_v2::text::TextFormat >(); return inValue; }
		if (HX_FIELD_EQ(inName,"_blackText") ) { _blackText=inValue.Cast< ::openfl::_v2::text::TextFormat >(); return inValue; }
		if (HX_FIELD_EQ(inName,"quickWatch") ) { quickWatch=inValue.Cast< bool >(); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"nameDisplay") ) { nameDisplay=inValue.Cast< ::openfl::_v2::text::TextField >(); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"valueDisplay") ) { valueDisplay=inValue.Cast< ::openfl::_v2::text::TextField >(); return inValue; }
	}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::_v2::text::TextField*/ ,(int)offsetof(WatchEntry_obj,nameDisplay),HX_CSTRING("nameDisplay")},
	{hx::fsObject /*::openfl::_v2::text::TextField*/ ,(int)offsetof(WatchEntry_obj,valueDisplay),HX_CSTRING("valueDisplay")},
	...
	{hx::fsObject /*::openfl::_v2::text::TextFormat*/ ,(int)offsetof(WatchEntry_obj,_whiteText),HX_CSTRING("_whiteText")},
	{hx::fsObject /*::openfl::_v2::text::TextFormat*/ ,(int)offsetof(WatchEntry_obj,_blackText),HX_CSTRING("_blackText")},
