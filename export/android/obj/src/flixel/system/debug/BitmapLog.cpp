...
HX_STACK_FRAME("flixel.system.debug.BitmapLog","new",0xe9e2bd9f,"flixel.system.debug.BitmapLog.new","flixel/system/debug/BitmapLog.hx",26,0xd4331252)
{
	...
	HX_STACK_LINE(39)
	this->_matrix = ::openfl::_v2::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());
	...
	this->zoom = (int)1;
	HX_STACK_LINE(52)
	super::__construct(HX_CSTRING("bitmapLog"),::flixel::system::debug::GraphicBitmapLog_obj::__new((int)0,(int)0,null(),null()),null(),null(),null(),null(),null());
	HX_STACK_LINE(54)
	this->minSize->x = (int)165;
	HX_STACK_LINE(55)
	this->minSize->y = (int)31;
	HX_STACK_LINE(57)
	int _g = ::Std_obj::_int(this->get_width());		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(57)
	this->_canvasBitmap = ::openfl::_v2::display::Bitmap_obj::__new(::openfl::_v2::display::BitmapData_obj::__new(_g,::Std_obj::_int((this->get_height() - (int)15)),true,(int)0,null()),null(),null());
	HX_STACK_LINE(58)
	...
	HX_STACK_LINE(67)
	this->addEventListener(::openfl::_v2::events::MouseEvent_obj::MOUSE_WHEEL,this->onMouseWheel_dyn(),null(),null(),null());
	HX_STACK_LINE(69)
	this->addEventListener(::openfl::_v2::events::MouseEvent_obj::MIDDLE_MOUSE_DOWN,this->onMiddleDown_dyn(),null(),null(),null());
	HX_STACK_LINE(70)
	this->addEventListener(::openfl::_v2::events::MouseEvent_obj::MIDDLE_MOUSE_UP,this->onMiddleUp_dyn(),null(),null(),null());
	HX_STACK_LINE(73)
...
Void BitmapLog_obj::createHeaderUI( ){
{
		...
		HX_STACK_LINE(84)
		this->_ui = ::openfl::_v2::display::Sprite_obj::__new();
		HX_STACK_LINE(85)
		this->_ui->set_y((int)2);
		HX_STACK_LINE(87)
		this->_buttonLeft = ::flixel::system::ui::FlxSystemButton_obj::__new(::flixel::system::debug::GraphicArrowLeft_obj::__new((int)0,(int)0,null(),null()),this->previous_dyn(),null());
		HX_STACK_LINE(89)
		this->_dimensionsText = ::flixel::system::debug::DebuggerUtil_obj::createTextField(null(),null(),null(),null());
		HX_STACK_LINE(91)
		this->_counterText = ::flixel::system::debug::DebuggerUtil_obj::createTextField((int)0,(int)-3,null(),null());
		HX_STACK_LINE(92)
		...
		HX_STACK_LINE(95)
		this->_buttonText = ::flixel::system::ui::FlxSystemButton_obj::__new(null(), Dynamic(new _Function_1_1(_g)),null());
		HX_STACK_LINE(99)
		this->_buttonText->addChild(this->_counterText);
		HX_STACK_LINE(101)
		this->_buttonRight = ::flixel::system::ui::FlxSystemButton_obj::__new(::flixel::system::debug::GraphicArrowRight_obj::__new((int)0,(int)0,null(),null()),this->next_dyn(),null());
		HX_STACK_LINE(102)
...
Void BitmapLog_obj::createFooterUI( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(114)
		this->_footer = ::openfl::_v2::display::Bitmap_obj::__new(::openfl::_v2::display::BitmapData_obj::__new((int)1,(int)15,true,(int)-1157627904,null()),null(),null());
		HX_STACK_LINE(115)
		this->_footer->set_alpha(0.8);
		HX_STACK_LINE(116)
		this->addChild(this->_footer);
		HX_STACK_LINE(118)
		this->_footerText = ::flixel::system::debug::DebuggerUtil_obj::createTextField(null(),null(),null(),null());
		HX_STACK_LINE(119)
...
Void BitmapLog_obj::destroy( ){
{
		...
		this->_entries = null();
		HX_STACK_LINE(137)
		this->removeEventListener(::openfl::_v2::events::MouseEvent_obj::MOUSE_WHEEL,this->onMouseWheel_dyn(),null());
		HX_STACK_LINE(139)
		this->removeEventListener(::openfl::_v2::events::MouseEvent_obj::MIDDLE_MOUSE_DOWN,this->onMiddleDown_dyn(),null());
		HX_STACK_LINE(140)
		this->removeEventListener(::openfl::_v2::events::MouseEvent_obj::MIDDLE_MOUSE_UP,this->onMiddleUp_dyn(),null());
		HX_STACK_LINE(143)
...
Void BitmapLog_obj::update( ){
{
		...
		if ((this->_middleMouseDown)){
			...
			HX_STACK_LINE(153)
			this->_lastMousePos->set(_g,this->get_mouseY());
		}
	}
return null();
}
...
Void BitmapLog_obj::updateSize( ){
{
		...
		HX_STACK_LINE(161)
		this->_background->set_scaleY((this->_height - (this->_header->get_height() * (int)2)));
	}
return null();
}
...
Void BitmapLog_obj::resize( Float Width,Float Height){
{
		...
		HX_STACK_LINE(168)
		this->_canvasBitmap->set_bitmapData(::flixel::util::FlxDestroyUtil_obj::dispose(this->_canvasBitmap->bitmapData));
		HX_STACK_LINE(169)
		int _g = ::Std_obj::_int((this->_width - this->_canvasBitmap->get_x()));		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(169)
		Float _g1 = (this->_height - this->_canvasBitmap->get_y());		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(169)
		this->_canvasBitmap->set_bitmapData(::openfl::_v2::display::BitmapData_obj::__new(_g,::Std_obj::_int((_g1 - this->_footer->get_height())),true,(int)0,null()));
		HX_STACK_LINE(170)
		this->refreshCanvas(this->_curIndex);
		HX_STACK_LINE(172)
		Float _g2 = this->_header->get_width();		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(172)
		this->_ui->set_x(((_g2 - this->_ui->get_width()) + (int)43));
		HX_STACK_LINE(174)
...
Void BitmapLog_obj::resizeTexts( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(182)
		Float _g = (Float(this->_header->get_width()) / Float((int)2));		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(182)
		this->_dimensionsText->set_x((_g - (Float(this->_dimensionsText->get_textWidth()) / Float((int)2))));
		HX_STACK_LINE(183)
		this->_dimensionsText->set_visible((this->_width > (int)200));
		HX_STACK_LINE(185)
		this->_footerText->set_y((this->_height - this->_footer->get_height()));
		HX_STACK_LINE(186)
		this->_footerText->set_x(((Float(this->_width) / Float((int)2)) - (Float(this->_footerText->get_textWidth()) / Float((int)2))));
		HX_STACK_LINE(187)
		this->_footerText->set_width(this->_footer->get_width());
		HX_STACK_LINE(188)
		if (((this->_footerText->get_x() < (int)0))){
			HX_STACK_LINE(190)
			this->_footerText->set_x((int)0);
		}
		HX_STACK_LINE(193)
		Float _g1 = this->_buttonLeft->get_x();		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(193)
		Float start = (_g1 + this->_buttonLeft->get_width());		HX_STACK_VAR(start,"start");
		HX_STACK_LINE(194)
		Float range = (this->_buttonRight->get_x() - start);		HX_STACK_VAR(range,"range");
		HX_STACK_LINE(195)
		this->_buttonText->set_x(((int)33 - (Float(this->_counterText->get_textWidth()) / Float((int)2))));
	}
return null();
}
...
bool BitmapLog_obj::add( ::openfl::_v2::display::BitmapData bmp,::String __o_name){
	...
	HX_STACK_ARG(name,"name")
{
		...
		struct _Function_1_1{
			inline static Dynamic Block( ::openfl::_v2::display::BitmapData &bmp,::String &name){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/system/debug/BitmapLog.hx",232,0xd4331252)
				{
					hx::Anon __result = hx::Anon_obj::Create();
					__result->Add(HX_CSTRING("bitmap") , bmp->clone(),false);
		...
		HX_STACK_LINE(232)
		this->_entries->__Field(HX_CSTRING("push"),true)(_Function_1_1::Block(bmp,name));
		HX_STACK_LINE(233)
...
Void BitmapLog_obj::clear( ){
{
		...
		this->_entries = Dynamic( Array_obj<Dynamic>::__new());
		HX_STACK_LINE(266)
		this->_canvasBitmap->bitmapData->fillRect(this->_canvasBitmap->bitmapData->get_rect(),(int)0);
		HX_STACK_LINE(267)
...
bool BitmapLog_obj::refreshCanvas( Dynamic Index){
	...
	HX_STACK_LINE(299)
	Float _g = (Float(this->_canvasBitmap->bitmapData->get_width()) / Float((int)2));		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(299)
	this->_point->set_x((_g - (Float((this->_entries->__GetItem(this->_curIndex)->__Field(HX_CSTRING("bitmap"),true)->__Field(HX_CSTRING("get_width"),true)() * this->zoom)) / Float((int)2))));
	HX_STACK_LINE(300)
	Float _g1 = (Float(this->_canvasBitmap->bitmapData->get_height()) / Float((int)2));		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(300)
	this->_point->set_y((_g1 - (Float((this->_entries->__GetItem(this->_curIndex)->__Field(HX_CSTRING("bitmap"),true)->__Field(HX_CSTRING("get_height"),true)() * this->zoom)) / Float((int)2))));
	HX_STACK_LINE(302)
	...
	HX_STACK_LINE(308)
	this->_canvasBitmap->bitmapData->draw(this->_entries->__GetItem(this->_curIndex)->__Field(HX_CSTRING("bitmap"),true),this->_matrix,null(),null(),this->_canvasBitmap->bitmapData->get_rect(),false);
	HX_STACK_LINE(310)
	this->drawBoundingBox(this->_entries->__GetItem(this->_curIndex)->__Field(HX_CSTRING("bitmap"),true));
	HX_STACK_LINE(311)
	this->_canvasBitmap->bitmapData->draw(::flixel::util::FlxSpriteUtil_obj::flashGfxSprite,this->_matrix,null(),null(),this->_canvasBitmap->bitmapData->get_rect(),false);
	HX_STACK_LINE(313)
	this->refreshTexts();
	HX_STACK_LINE(315)
	return true;
...
Void BitmapLog_obj::refreshTexts( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(320)
		::String _g = (this->_entries->__GetItem(this->_curIndex)->__Field(HX_CSTRING("bitmap"),true)->__Field(HX_CSTRING("get_width"),true)() + HX_CSTRING("x"));		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(320)
		this->_dimensionsText->set_text((_g + this->_entries->__GetItem(this->_curIndex)->__Field(HX_CSTRING("bitmap"),true)->__Field(HX_CSTRING("get_height"),true)()));
		HX_STACK_LINE(321)
		...
		struct _Function_1_1{
			inline static Float Block( ::flixel::system::debug::BitmapLog_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/system/debug/BitmapLog.hx",325,0xd4331252)
				{
					HX_STACK_LINE(325)
					::openfl::_v2::display::BitmapData bitmapData = __this->_entries->__GetItem(__this->_curIndex)->__Field(HX_CSTRING("bitmap"),true);		HX_STACK_VAR(bitmapData,"bitmapData");
					HX_STACK_LINE(325)
					int _g1 = bitmapData->get_width();		HX_STACK_VAR(_g1,"_g1");
					HX_STACK_LINE(325)
					return ((_g1 * bitmapData->get_height()) * (int)4);
				}
				return null();
			}
		};
		HX_STACK_LINE(325)
		this->_footerText->set_text((name + ::flixel::util::FlxStringUtil_obj::formatBytes(_Function_1_1::Block(this),null())));
		HX_STACK_LINE(327)
		this->resizeTexts();
	}
return null();
...
Void BitmapLog_obj::drawBoundingBox( ::openfl::_v2::display::BitmapData bitmap){
{
		...
		HX_STACK_LINE(332)
		::openfl::_v2::display::Graphics gfx = ::flixel::util::FlxSpriteUtil_obj::flashGfx;		HX_STACK_VAR(gfx,"gfx");
		HX_STACK_LINE(333)
		gfx->clear();
		HX_STACK_LINE(334)
		gfx->lineStyle((int)1,(int)-65536,0.75,false,::openfl::_v2::display::LineScaleMode_obj::NONE,null(),null(),null());
		HX_STACK_LINE(335)
		int _g = bitmap->get_width();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(335)
		gfx->drawRect((int)0,(int)0,_g,bitmap->get_height());
	}
return null();
}
...
Void BitmapLog_obj::onMouseWheel( ::openfl::_v2::events::MouseEvent e){
{
...
Void BitmapLog_obj::onMiddleDown( ::openfl::_v2::events::MouseEvent e){
{
...
Void BitmapLog_obj::onMiddleUp( ::openfl::_v2::events::MouseEvent e){
{
...
::openfl::_v2::display::BitmapData BitmapLog_obj::get__canvas( ){
...
::openfl::_v2::display::BitmapData BitmapLog_obj::get__curBitmap( ){
...
Dynamic BitmapLog_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 3:
		if (HX_FIELD_EQ(inName,"_ui") ) { _ui=inValue.Cast< ::openfl::_v2::display::Sprite >(); return inValue; }
		break;
	case 4:
	...
	case 7:
		...
		if (HX_FIELD_EQ(inName,"_footer") ) { _footer=inValue.Cast< ::openfl::_v2::display::Bitmap >(); return inValue; }
		break;
	case 8:
	...
	case 11:
		...
		if (HX_FIELD_EQ(inName,"_footerText") ) { _footerText=inValue.Cast< ::openfl::_v2::text::TextField >(); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"_buttonRight") ) { _buttonRight=inValue.Cast< ::flixel::system::ui::FlxSystemButton >(); return inValue; }
		if (HX_FIELD_EQ(inName,"_counterText") ) { _counterText=inValue.Cast< ::openfl::_v2::text::TextField >(); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"_canvasBitmap") ) { _canvasBitmap=inValue.Cast< ::openfl::_v2::display::Bitmap >(); return inValue; }
	...
	case 15:
		...
		if (HX_FIELD_EQ(inName,"_dimensionsText") ) { _dimensionsText=inValue.Cast< ::openfl::_v2::text::TextField >(); return inValue; }
		break;
	case 16:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::_v2::display::Bitmap*/ ,(int)offsetof(BitmapLog_obj,_canvasBitmap),HX_CSTRING("_canvasBitmap")},
	...
	{hx::fsObject /*::openfl::_v2::geom::Matrix*/ ,(int)offsetof(BitmapLog_obj,_matrix),HX_CSTRING("_matrix")},
	...
	{hx::fsObject /*::openfl::_v2::text::TextField*/ ,(int)offsetof(BitmapLog_obj,_counterText),HX_CSTRING("_counterText")},
	{hx::fsObject /*::openfl::_v2::text::TextField*/ ,(int)offsetof(BitmapLog_obj,_dimensionsText),HX_CSTRING("_dimensionsText")},
	{hx::fsObject /*::openfl::_v2::display::Sprite*/ ,(int)offsetof(BitmapLog_obj,_ui),HX_CSTRING("_ui")},
	{hx::fsBool,(int)offsetof(BitmapLog_obj,_middleMouseDown),HX_CSTRING("_middleMouseDown")},
	{hx::fsObject /*::openfl::_v2::display::Bitmap*/ ,(int)offsetof(BitmapLog_obj,_footer),HX_CSTRING("_footer")},
	{hx::fsObject /*::openfl::_v2::text::TextField*/ ,(int)offsetof(BitmapLog_obj,_footerText),HX_CSTRING("_footerText")},
	{ hx::fsUnknown, 0, null()}
};
#endif
