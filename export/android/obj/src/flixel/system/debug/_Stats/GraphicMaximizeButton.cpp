...
{
HX_STACK_FRAME("flixel.system.debug._Stats.GraphicMaximizeButton","new",0xacd98052,"flixel.system.debug._Stats.GraphicMaximizeButton.new","openfl/_v2/Assets.hx",1654,0x2846aac8)
...
Dynamic fillRGBA = __o_fillRGBA.Default(-1);
{
	...
	HX_STACK_LINE(1722)
	::openfl::_v2::utils::ByteArray byteArray = ::openfl::_v2::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::system::debug::_Stats::GraphicMaximizeButton_obj::resourceName));		HX_STACK_VAR(byteArray,"byteArray");
	HX_STACK_LINE(1723)
