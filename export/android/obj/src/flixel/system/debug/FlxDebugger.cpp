...
HX_STACK_ARG(Height,"Height")
{
	...
	HX_STACK_LINE(407)
	this->_screen = ::openfl::_v2::geom::Point_obj::__new(null(),null());
	HX_STACK_LINE(408)
	this->_windows = Array_obj< ::Dynamic >::__new();
	HX_STACK_LINE(410)
	this->_topBar = ::openfl::_v2::display::Sprite_obj::__new();
	HX_STACK_LINE(411)
	this->_topBar->get_graphics()->beginFill((int)0,0.66666666666666663);
	HX_STACK_LINE(412)
	this->_topBar->get_graphics()->drawRect((int)0,(int)0,::openfl::_v2::Lib_obj::get_current()->get_stage()->get_stageWidth(),(int)20);
	HX_STACK_LINE(413)
	...
	{
		HX_STACK_LINE(431)
		::flixel::system::debug::Window window = this->log = ::flixel::system::debug::Log_obj::__new();		HX_STACK_VAR(window,"window");
		HX_STACK_LINE(431)
	...
	{
		HX_STACK_LINE(432)
		::flixel::system::debug::Window window = this->bitmapLog = ::flixel::system::debug::BitmapLog_obj::__new();		HX_STACK_VAR(window,"window");
		HX_STACK_LINE(432)
		this->_windows->push(window);
		HX_STACK_LINE(432)
		this->addChild(window);
	...
	{
		HX_STACK_LINE(433)
		::flixel::system::debug::Window window = this->watch = ::flixel::system::debug::Watch_obj::__new(null());		HX_STACK_VAR(window,"window");
		HX_STACK_LINE(433)
		this->_windows->push(window);
		HX_STACK_LINE(433)
		this->addChild(window);
	...
	{
		HX_STACK_LINE(434)
		::flixel::system::debug::Window window = this->console = ::flixel::system::debug::Console_obj::__new();		HX_STACK_VAR(window,"window");
		HX_STACK_LINE(434)
		this->_windows->push(window);
		HX_STACK_LINE(434)
		this->addChild(window);
	...
	{
		HX_STACK_LINE(435)
		::flixel::system::debug::Window window = this->stats = ::flixel::system::debug::Stats_obj::__new();		HX_STACK_VAR(window,"window");
		HX_STACK_LINE(435)
		this->_windows->push(window);
		HX_STACK_LINE(435)
		this->addChild(window);
	...
	HX_STACK_LINE(449)
	Array< ::Dynamic > drawDebugButton = Array_obj< ::Dynamic >::__new().Add(this->addButton(::flixel::system::debug::ButtonAlignment_obj::RIGHT,::flixel::system::debug::_FlxDebugger::GraphicDrawDebug_obj::__new((int)0,(int)0,null(),null()),this->toggleDrawDebug_dyn(),true,null()));		HX_STACK_VAR(drawDebugButton,"drawDebugButton");
	HX_STACK_LINE(450)
...
Void FlxDebugger_obj::resetLayout( ){
{
		...
		switch( (int)(_g->__Index())){
			...
			case (int)3: {
				...
				HX_STACK_LINE(217)
				this->bitmapLog->reposition((int)0,((((this->console->get_height() + (int)4) + (int)15) + (Float(this->_screen->y) / Float((int)4))) + (int)2));
			}
			;break;
			case (int)4: {
				HX_STACK_LINE(219)
				...
				this->stats->reposition(this->_screen->x,(int)0);
				HX_STACK_LINE(226)
				this->bitmapLog->resize((Float(this->_screen->x) / Float((int)3)),(((Float((((this->_screen->y - (int)15) - 5.))) / Float((int)2)) - (Float(this->console->get_height()) / Float((int)2))) - (int)2));
				HX_STACK_LINE(227)
			...
			case (int)0: {
				...
				this->bitmapLog->resize((Float(((this->_screen->x - (int)6))) / Float((int)2)),(Float(this->_screen->y) / Float((int)4)));
				HX_STACK_LINE(247)
				Float _g7 = (this->log->get_y() - (int)2);		HX_STACK_VAR(_g7,"_g7");
				HX_STACK_LINE(247)
				this->bitmapLog->reposition((int)0,(_g7 - this->bitmapLog->get_height()));
			}
			;break;
		}
	}
...
Void FlxDebugger_obj::onResize( Float Width,Float Height){
{
		...
		this->updateBounds();
		HX_STACK_LINE(257)
		this->_topBar->set_width(::openfl::_v2::Lib_obj::get_current()->get_stage()->get_stageWidth());
		HX_STACK_LINE(258)
...
Void FlxDebugger_obj::updateBounds( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(268)
		this->_screenBounds = ::openfl::_v2::geom::Rectangle_obj::__new((int)2,21.,(this->_screen->x - (int)4),((this->_screen->y - (int)4) - (int)20));
		HX_STACK_LINE(269)
		{
			HX_STACK_LINE(269)
			int _g = (int)0;		HX_STACK_VAR(_g,"_g");
...
Void FlxDebugger_obj::resetButtonLayout( ){
{
		...
		HX_STACK_LINE(303)
		Float _g = (::openfl::_v2::Lib_obj::get_current()->get_stage()->get_stageWidth() * 0.5);		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(303)
		...
		HX_STACK_LINE(306)
		int _g1 = ::openfl::_v2::Lib_obj::get_current()->get_stage()->get_stageWidth();		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(306)
...
::flixel::system::ui::FlxSystemButton FlxDebugger_obj::addButton( ::flixel::system::debug::ButtonAlignment Position,::openfl::_v2::display::BitmapData Icon,Dynamic UpHandler,hx::Null< bool >  __o_ToggleMode,hx::Null< bool >  __o_UpdateLayout){
...
Void FlxDebugger_obj::addWindowToggleButton( ::flixel::system::debug::Window window,::Class icon){
{
		...
		HX_STACK_ARG(icon,"icon")
		HX_STACK_LINE(369)
		::flixel::system::ui::FlxSystemButton button = this->addButton(::flixel::system::debug::ButtonAlignment_obj::RIGHT,::Type_obj::createInstance(icon,Dynamic( Array_obj<Dynamic>::__new().Add((int)0).Add((int)0))),window->toggleVisible_dyn(),true,true);		HX_STACK_VAR(button,"button");
		HX_STACK_LINE(370)
...
Void FlxDebugger_obj::openHomepage( ){
{
		...
		HX_STACK_LINE(507)
		::openfl::_v2::Lib_obj::getURL(::openfl::_v2::net::URLRequest_obj::__new((prefix + HX_CSTRING("http://www.haxeflixel.com"))),HX_CSTRING("_blank"));
	}
return null();
}
