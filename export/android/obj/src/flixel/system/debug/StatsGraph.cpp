...
int LabelWidth = __o_LabelWidth.Default(45);
{
	...
	HX_STACK_LINE(54)
	this->_axis = ::openfl::_v2::display::Shape_obj::__new();
	HX_STACK_LINE(55)
	...
	HX_STACK_LINE(61)
	this->avgLabel = ::flixel::system::debug::DebuggerUtil_obj::createTextField((this->_labelWidth + (int)20),(((Float(this->_height) / Float((int)2)) - 5.5) - (int)10),(int)-1426063361,(int)11);
	HX_STACK_LINE(62)
	this->avgLabel->set_width(this->_width);
	HX_STACK_LINE(63)
	this->avgLabel->get_defaultTextFormat()->align = ::openfl::_v2::text::TextFormatAlign_obj::CENTER;
	HX_STACK_LINE(64)
...
Void StatsGraph_obj::drawAxis( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(80)
		::openfl::_v2::display::Graphics gfx = this->_axis->get_graphics();		HX_STACK_VAR(gfx,"gfx");
		HX_STACK_LINE(81)
		gfx->clear();
		HX_STACK_LINE(82)
...
Void StatsGraph_obj::update( Float Value,Dynamic Average){
{
		...
		HX_STACK_LINE(135)
		this->avgLabel->set_text(((((this->_label + HX_CSTRING("\nAvg: ")) + ::flixel::util::FlxMath_obj::roundDecimal(Average,(int)1)) + HX_CSTRING(" ")) + this->_unit));
		HX_STACK_LINE(137)
		this->drawGraph();
	}
return null();
...
Dynamic StatsGraph_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 5:
		if (HX_FIELD_EQ(inName,"_axis") ) { _axis=inValue.Cast< ::openfl::_v2::display::Shape >(); return inValue; }
	...
	case 7:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"minLabel") ) { minLabel=inValue.Cast< ::openfl::_v2::text::TextField >(); return inValue; }
		if (HX_FIELD_EQ(inName,"curLabel") ) { curLabel=inValue.Cast< ::openfl::_v2::text::TextField >(); return inValue; }
		if (HX_FIELD_EQ(inName,"maxLabel") ) { maxLabel=inValue.Cast< ::openfl::_v2::text::TextField >(); return inValue; }
		if (HX_FIELD_EQ(inName,"avgLabel") ) { avgLabel=inValue.Cast< ::openfl::_v2::text::TextField >(); return inValue; }
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::_v2::text::TextField*/ ,(int)offsetof(StatsGraph_obj,minLabel),HX_CSTRING("minLabel")},
	{hx::fsObject /*::openfl::_v2::text::TextField*/ ,(int)offsetof(StatsGraph_obj,curLabel),HX_CSTRING("curLabel")},
	{hx::fsObject /*::openfl::_v2::text::TextField*/ ,(int)offsetof(StatsGraph_obj,maxLabel),HX_CSTRING("maxLabel")},
	{hx::fsObject /*::openfl::_v2::text::TextField*/ ,(int)offsetof(StatsGraph_obj,avgLabel),HX_CSTRING("avgLabel")},
	...
	{hx::fsObject /*::openfl::_v2::display::Shape*/ ,(int)offsetof(StatsGraph_obj,_axis),HX_CSTRING("_axis")},
