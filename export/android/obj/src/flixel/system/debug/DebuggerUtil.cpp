...
::openfl::_v2::text::TextField DebuggerUtil_obj::createTextField( hx::Null< Float >  __o_X,hx::Null< Float >  __o_Y,hx::Null< int >  __o_Color,hx::Null< int >  __o_Size){
	...
	HX_STACK_ARG(Size,"Size")
{
		...
		HX_STACK_LINE(39)
		tf->set_defaultTextFormat(::openfl::_v2::text::TextFormat_obj::__new(::flixel::system::FlxAssets_obj::FONT_DEBUGGER,Size,(int((int((int(((int((int(Color) >> int((int)16))) & int((int)255)))) << int((int)16))) | int((int(((int((int(Color) >> int((int)8))) & int((int)255)))) << int((int)8))))) | int((int(Color) & int((int)255)))),null(),null(),null(),null(),null(),null(),null(),null(),null(),null()));
