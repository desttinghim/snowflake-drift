...
bool StartFullscreen = __o_StartFullscreen.Default(false);
{
	...
	super::__construct();
	HX_STACK_LINE(229)
	this->_inputContainer = ::openfl::_v2::display::Sprite_obj::__new();
	HX_STACK_LINE(232)
...
Void FlxGame_obj::create( Dynamic _){
{
		...
		HX_STACK_LINE(260)
		this->_total = ::openfl::_v2::Lib_obj::getTimer();
		HX_STACK_LINE(267)
		...
		HX_STACK_LINE(282)
		this->debugger = ::flixel::system::debug::FlxDebugger_obj::__new(_g,::openfl::_v2::Lib_obj::get_current()->get_stage()->get_stageHeight());
		HX_STACK_LINE(283)
		...
		HX_STACK_LINE(310)
		{
			...
			if (((bool(this->_skipSplash) || bool((::flixel::system::FlxSplash_obj::nextState != null()))))){
				...
				HX_STACK_LINE(310)
				this->_requestedState = ::flixel::system::FlxSplash_obj::__new(null());
				HX_STACK_LINE(310)
				this->_skipSplash = true;
			}
			HX_STACK_LINE(310)
		...
		HX_STACK_LINE(326)
		this->resizeGame(_g1,::openfl::_v2::Lib_obj::get_current()->get_stage()->get_stageHeight());
	}
return null();
}
...
Void FlxGame_obj::onEnterFrame( Dynamic _){
{
		...
		HX_STACK_ARG(_,"_")
		HX_STACK_LINE(458)
		this->ticks = ::openfl::_v2::Lib_obj::getTimer();
		HX_STACK_LINE(459)
...
Void FlxGame_obj::update( ){
{
		...
		HX_STACK_LINE(706)
		this->debugger->stats->flixelUpdate((::openfl::_v2::Lib_obj::getTimer() - this->ticks));
		HX_STACK_LINE(710)
		{
			HX_STACK_LINE(710)
			int _g = (int)0;		HX_STACK_VAR(_g,"_g");
...
Void FlxGame_obj::draw( ){
{
		...
		HX_STACK_LINE(842)
		this->debugger->stats->flixelDraw((::openfl::_v2::Lib_obj::getTimer() - this->ticks));
	}
return null();
}
