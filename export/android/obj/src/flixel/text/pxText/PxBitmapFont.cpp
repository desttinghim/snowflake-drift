...
HX_STACK_FRAME("flixel.text.pxText.PxBitmapFont","new",0x07bda9e2,"flixel.text.pxText.PxBitmapFont.new","flixel/text/pxText/PxBitmapFont.hx",19,0xb7b5754d)
{
	...
	HX_STACK_LINE(56)
	this->_point = ::openfl::_v2::geom::Point_obj::__new(null(),null());
	HX_STACK_LINE(63)
...
::flixel::text::pxText::PxBitmapFont PxBitmapFont_obj::loadPixelizer( ::openfl::_v2::display::BitmapData PxBitmapData,::String PxLetters){
	...
	if (((PxBitmapData != null()))){
		...
		HX_STACK_LINE(91)
		::openfl::_v2::display::BitmapData result = this->preparePixelizerBitmapData(PxBitmapData,this->_tileRects);		HX_STACK_VAR(result,"result");
		HX_STACK_LINE(92)
		::String key = ::flixel::FlxG_obj::bitmap->getUniqueKey(HX_CSTRING("font"));		HX_STACK_VAR(key,"key");
		HX_STACK_LINE(93)
		this->setCachedGraphics(::flixel::FlxG_obj::bitmap->addWithSpaces(result,(int)0,(int)0,(int)1,(int)1,false,key));
		HX_STACK_LINE(94)
		...
		HX_STACK_LINE(97)
		::openfl::_v2::geom::Rectangle currRect;		HX_STACK_VAR(currRect,"currRect");
		HX_STACK_LINE(102)
...
::flixel::text::pxText::PxBitmapFont PxBitmapFont_obj::loadAngelCode( ::openfl::_v2::display::BitmapData pBitmapData,::Xml pXMLData){
	...
	if (((bool((pBitmapData != null())) && bool((pXMLData != null()))))){
		...
		HX_STACK_LINE(123)
		::openfl::_v2::display::BitmapData result = this->prepareAngelCodeBitmapData(pBitmapData,pXMLData,this->_symbols);		HX_STACK_VAR(result,"result");
		HX_STACK_LINE(124)
		::String key = ::flixel::FlxG_obj::bitmap->getUniqueKey(HX_CSTRING("font"));		HX_STACK_VAR(key,"key");
		HX_STACK_LINE(125)
		this->setCachedGraphics(::flixel::FlxG_obj::bitmap->addWithSpaces(result,(int)0,(int)0,(int)1,(int)1,false,key));
...
Void PxBitmapFont_obj::updateGlyphData( ::flixel::system::layer::TileSheetData Tiles){
{
		...
		if (((this->_symbols != null()))){
			...
			HX_STACK_LINE(152)
			::openfl::_v2::display::BitmapData bd;		HX_STACK_VAR(bd,"bd");
			HX_STACK_LINE(153)
			...
			HX_STACK_LINE(155)
			{
				...
				while(((_g < _g1->length))){
					...
					if (((bool((charString != HX_CSTRING(" "))) && bool((charString != HX_CSTRING("")))))){
						HX_STACK_LINE(199)
						int _g2 = ::Math_obj::floor(point->x);		HX_STACK_VAR(_g2,"_g2");
						HX_STACK_LINE(199)
						this->setGlyph(Tiles,symbol->charCode,rect,_g2,::Math_obj::floor(point->y),charWidth);
					}
					else{
						HX_STACK_LINE(203)
			...
			if (((this->_tileRects != null()))){
				...
				while(((_g1 < _g))){
					...
					HX_STACK_LINE(212)
					rect = this->_tileRects->__get(letterID).StaticCast< ::openfl::_v2::geom::Rectangle >();
					HX_STACK_LINE(222)
					Dynamic _g11 = this->_glyphString.charCodeAt(letterID);		HX_STACK_VAR(_g11,"_g11");
					HX_STACK_LINE(222)
					this->setGlyph(Tiles,_g11,rect,(int)0,(int)0,::Std_obj::_int(rect->width));
				}
			}
		}
	}
...
::openfl::_v2::display::BitmapData PxBitmapFont_obj::preparePixelizerBitmapData( ::openfl::_v2::display::BitmapData PxBitmapData,Array< ::Dynamic > PxRects){
	...
	while(((cy < PxBitmapData->get_height()))){
		...
		while(((cx < PxBitmapData->get_width()))){
			...
			if (((::Std_obj::_int(PxBitmapData->getPixel(cx,cy)) != bgColor))){
				...
				HX_STACK_LINE(281)
				PxRects->push(::openfl::_v2::geom::Rectangle_obj::__new(cx,cy,gw,gh));
				HX_STACK_LINE(284)
				if (((gh > rowHeight))){
					HX_STACK_LINE(286)
					rowHeight = gh;
...
::openfl::_v2::display::BitmapData PxBitmapFont_obj::prepareAngelCodeBitmapData( ::openfl::_v2::display::BitmapData PxBitmapData,::Xml PxXMLData,Array< ::Dynamic > PxSymbols){
...
Void PxBitmapFont_obj::setGlyph( ::flixel::system::layer::TileSheetData Tiles,int PxCharID,::openfl::_v2::geom::Rectangle PxRect,hx::Null< int >  __o_PxOffsetX,hx::Null< int >  __o_PxOffsetY,hx::Null< int >  __o_PxAdvanceX){
...
::openfl::_v2::display::BitmapData PxBitmapFont_obj::get_pixels( ){
...
::openfl::_v2::geom::Point PxBitmapFont_obj::ZERO_POINT;
...
Dynamic PxBitmapFont_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 6:
		...
		if (HX_FIELD_EQ(inName,"pixels") ) { pixels=inValue.Cast< ::openfl::_v2::display::BitmapData >(); return inValue; }
		break;
	case 7:
	...
	case 9:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"ZERO_POINT") ) { ZERO_POINT=inValue.Cast< ::openfl::_v2::geom::Point >(); return inValue; }
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::_v2::geom::Point*/ ,(int)offsetof(PxBitmapFont_obj,_point),HX_CSTRING("_point")},
	...
	{hx::fsObject /*::openfl::_v2::display::BitmapData*/ ,(int)offsetof(PxBitmapFont_obj,pixels),HX_CSTRING("pixels")},
...
void PxBitmapFont_obj::__boot()
{
	...
	ZERO_POINT= ::openfl::_v2::geom::Point_obj::__new(null(),null());
}
