...
bool EmbeddedFont = __o_EmbeddedFont.Default(true);
{
	...
	HX_STACK_LINE(184)
	this->_textField = ::openfl::_v2::text::TextField_obj::__new();
	HX_STACK_LINE(185)
	...
	HX_STACK_LINE(188)
	this->_defaultFormat = ::openfl::_v2::text::TextFormat_obj::__new(::flixel::system::FlxAssets_obj::FONT_DEFAULT,Size,(int)16777215,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
	HX_STACK_LINE(189)
	this->_formatAdjusted = ::openfl::_v2::text::TextFormat_obj::__new(null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
	HX_STACK_LINE(190)
...
Void FlxText_obj::destroy( ){
{
		...
		this->_formats = null();
		HX_STACK_LINE(247)
		this->shadowOffset = ::flixel::util::FlxDestroyUtil_obj::put(this->shadowOffset);
		HX_STACK_LINE(248)
		this->super::destroy();
	}
return null();
	...
	HX_STACK_ARG(Embedded,"Embedded")
{
		...
		if ((Embedded)){
			...
			if (((Font == null()))){
				...
				HX_STACK_LINE(318)
				this->_defaultFormat->font = ::openfl::_v2::Assets_obj::getFont(Font,null())->fontName;
			}
		}
		else{
			HX_STACK_LINE(321)
...
Void FlxText_obj::addFilter( ::openfl::_v2::filters::BitmapFilter filter,hx::Null< int >  __o_widthInc,hx::Null< int >  __o_heightInc){
...
Void FlxText_obj::removeFilter( ::openfl::_v2::filters::BitmapFilter filter){
{
...
bool FlxText_obj::get_autoSize( ){
	...
	if (((this->_textField != null()))){
		HX_STACK_LINE(462)
		return (this->_textField->get_autoSize() != ::openfl::text::TextFieldAutoSize_obj::NONE);
	}
	else{
		HX_STACK_LINE(462)
		return false;
...
::openfl::_v2::text::TextField FlxText_obj::get_textField( ){
...
Void FlxText_obj::updateColorTransform( ){
{
		...
		if (((this->alpha != (int)1))){
			...
			if (((this->colorTransform == null()))){
				HX_STACK_LINE(687)
				this->colorTransform = ::openfl::_v2::geom::ColorTransform_obj::__new((int)1,(int)1,(int)1,this->alpha,null(),null(),null(),null());
			}
			else{
				HX_STACK_LINE(691)
...
Void FlxText_obj::regenGraphics( ){
{
		...
		HX_STACK_LINE(718)
		if (((this->_textField->get_textHeight() == (int)0))){
			HX_STACK_LINE(720)
			newHeight = oldHeight;
		}
		HX_STACK_LINE(723)
	...
	HX_STACK_ARG(RunOnCpp,"RunOnCpp")
{
		...
		if (((  (((  (((this->_textField != null()))) ? bool((this->_textField->get_text() != null())) : bool(false) ))) ? bool((this->_textField->get_text().length > (int)0)) : bool(false) ))){
			...
			HX_STACK_LINE(778)
			if (((  (((this->_defaultFormat->align == ::openfl::_v2::text::TextFormatAlign_obj::CENTER))) ? bool((this->_textField->get_numLines() == (int)1)) : bool(false) ))){
				HX_STACK_LINE(780)
		...
		if (((  ((!(((  ((!(((this->framePixels == null()))))) ? bool(_Function_1_1::Block(this)) : bool(true) ))))) ? bool(_Function_1_2::Block(this)) : bool(true) ))){
			...
			HX_STACK_LINE(892)
			this->framePixels = ::openfl::_v2::display::BitmapData_obj::__new(_g4,this->cachedGraphics->bitmap->get_height(),true,(int)0,null());
		}
		HX_STACK_LINE(895)
...
::openfl::_v2::text::TextFormat FlxText_obj::dtfCopy( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(910)
	::openfl::_v2::text::TextFormat defaultTextFormat = this->_textField->get_defaultTextFormat();		HX_STACK_VAR(defaultTextFormat,"defaultTextFormat");
	HX_STACK_LINE(912)
	return ::openfl::_v2::text::TextFormat_obj::__new(defaultTextFormat->font,defaultTextFormat->size,defaultTextFormat->color,defaultTextFormat->bold,defaultTextFormat->italic,defaultTextFormat->underline,defaultTextFormat->url,defaultTextFormat->target,defaultTextFormat->align,null(),null(),null(),null());
}
...
Void FlxText_obj::updateFormat( ::openfl::_v2::text::TextFormat Format){
{
...
Dynamic FlxText_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 10:
		...
		if (HX_FIELD_EQ(inName,"_textField") ) { _textField=inValue.Cast< ::openfl::_v2::text::TextField >(); return inValue; }
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::_v2::text::TextField*/ ,(int)offsetof(FlxText_obj,_textField),HX_CSTRING("_textField")},
