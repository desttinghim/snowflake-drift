...
Void FlxTypedEmitter_obj::destroy( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(186)
		this->_point = ::flixel::util::FlxDestroyUtil_obj::put(this->_point);
		HX_STACK_LINE(187)
		this->acceleration = ::flixel::util::FlxDestroyUtil_obj::put(this->acceleration);
		HX_STACK_LINE(188)
		this->particleDrag = ::flixel::util::FlxDestroyUtil_obj::put(this->particleDrag);
		HX_STACK_LINE(190)
		this->xPosition = null();
		HX_STACK_LINE(191)
		this->yPosition = null();
	...
	HX_STACK_ARG(AutoBuffer,"AutoBuffer")
{
		...
		while(((i < Quantity))){
			...
			if ((Multiple)){
				HX_STACK_LINE(246)
				randomFrame = ::flixel::util::FlxRandom_obj::intRanged((int)0,(totalFrames - (int)1),null());
				HX_STACK_LINE(248)
		...
		if ((this->on)){
			...
			if ((this->_explode)){
				...
				if (((this->frequency <= (int)0))){
					...
					this->emitParticle();
					HX_STACK_LINE(330)
					if (((  (((this->_quantity > (int)0))) ? bool((++(this->_counter) >= this->_quantity)) : bool(false) ))){
						HX_STACK_LINE(332)
						this->on = false;
						HX_STACK_LINE(333)
						this->_waitForKill = true;
...
Void FlxTypedEmitter_obj::emitParticle( ){
{
		...
		HX_STACK_LINE(415)
		Float _g1 = (_g - ((int(::Std_obj::_int(particle->__Field(HX_CSTRING("get_width"),true)())) >> int((int)1))));		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(415)
		Float _g2 = (Float((::flixel::util::FlxRandom_obj::_internalSeed = (int(hx::Mod((::flixel::util::FlxRandom_obj::_internalSeed * (int)48271),(int)2147483647)) & int((int)2147483647)))) / Float((int)2147483647));		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(415)
		Float _g3 = (_g1 + (_g2 * this->get_width()));		HX_STACK_VAR(_g3,"_g3");
		HX_STACK_LINE(415)
		Float _g4 = this->get_y();		HX_STACK_VAR(_g4,"_g4");
		HX_STACK_LINE(415)
		Float _g5 = (_g4 - ((int(::Std_obj::_int(particle->__Field(HX_CSTRING("get_height"),true)())) >> int((int)1))));		HX_STACK_VAR(_g5,"_g5");
		HX_STACK_LINE(415)
		Float _g6 = (Float((::flixel::util::FlxRandom_obj::_internalSeed = (int(hx::Mod((::flixel::util::FlxRandom_obj::_internalSeed * (int)48271),(int)2147483647)) & int((int)2147483647)))) / Float((int)2147483647));		HX_STACK_VAR(_g6,"_g6");
		HX_STACK_LINE(415)
		particle->__Field(HX_CSTRING("reset"),true)(_g3,(_g5 + (_g6 * this->get_height())));
		HX_STACK_LINE(416)
		particle->__Field(HX_CSTRING("set_visible"),true)(true);
		HX_STACK_LINE(418)
		if (((this->life->min != this->life->max))){
			HX_STACK_LINE(420)
			particle->__FieldRef(HX_CSTRING("lifespan")) = particle->__FieldRef(HX_CSTRING("maxLifespan")) = (this->life->min + ((Float((::flixel::util::FlxRandom_obj::_internalSeed = (int(hx::Mod((::flixel::util::FlxRandom_obj::_internalSeed * (int)48271),(int)2147483647)) & int((int)2147483647)))) / Float((int)2147483647)) * ((this->life->max - this->life->min))));
		}
		else{
			HX_STACK_LINE(424)
		...
		if (((this->startAlpha->min != this->startAlpha->max))){
			HX_STACK_LINE(429)
			particle->__FieldRef(HX_CSTRING("startAlpha")) = (this->startAlpha->min + ((Float((::flixel::util::FlxRandom_obj::_internalSeed = (int(hx::Mod((::flixel::util::FlxRandom_obj::_internalSeed * (int)48271),(int)2147483647)) & int((int)2147483647)))) / Float((int)2147483647)) * ((this->startAlpha->max - this->startAlpha->min))));
		}
		else{
			HX_STACK_LINE(433)
		...
		if (((this->endAlpha->min != this->endAlpha->max))){
			HX_STACK_LINE(440)
			particleEndAlpha = (this->endAlpha->min + ((Float((::flixel::util::FlxRandom_obj::_internalSeed = (int(hx::Mod((::flixel::util::FlxRandom_obj::_internalSeed * (int)48271),(int)2147483647)) & int((int)2147483647)))) / Float((int)2147483647)) * ((this->endAlpha->max - this->endAlpha->min))));
		}
		HX_STACK_LINE(443)
		...
		if (((this->startRed->min != this->startRed->max))){
			HX_STACK_LINE(465)
			particle->__FieldRef(HX_CSTRING("startRed")) = startRedComp = (this->startRed->min + ((Float((::flixel::util::FlxRandom_obj::_internalSeed = (int(hx::Mod((::flixel::util::FlxRandom_obj::_internalSeed * (int)48271),(int)2147483647)) & int((int)2147483647)))) / Float((int)2147483647)) * ((this->startRed->max - this->startRed->min))));
		}
		HX_STACK_LINE(467)
		if (((this->startGreen->min != this->startGreen->max))){
			HX_STACK_LINE(469)
			particle->__FieldRef(HX_CSTRING("startGreen")) = startGreenComp = (this->startGreen->min + ((Float((::flixel::util::FlxRandom_obj::_internalSeed = (int(hx::Mod((::flixel::util::FlxRandom_obj::_internalSeed * (int)48271),(int)2147483647)) & int((int)2147483647)))) / Float((int)2147483647)) * ((this->startGreen->max - this->startGreen->min))));
		}
		HX_STACK_LINE(471)
		if (((this->startBlue->min != this->startBlue->max))){
			HX_STACK_LINE(473)
			particle->__FieldRef(HX_CSTRING("startBlue")) = startBlueComp = (this->startBlue->min + ((Float((::flixel::util::FlxRandom_obj::_internalSeed = (int(hx::Mod((::flixel::util::FlxRandom_obj::_internalSeed * (int)48271),(int)2147483647)) & int((int)2147483647)))) / Float((int)2147483647)) * ((this->startBlue->max - this->startBlue->min))));
		}
		HX_STACK_LINE(476)
		if (((this->endRed->min != this->endRed->max))){
			HX_STACK_LINE(478)
			endRedComp = (this->endRed->min + ((Float((::flixel::util::FlxRandom_obj::_internalSeed = (int(hx::Mod((::flixel::util::FlxRandom_obj::_internalSeed * (int)48271),(int)2147483647)) & int((int)2147483647)))) / Float((int)2147483647)) * ((this->endRed->max - this->endRed->min))));
		}
		HX_STACK_LINE(481)
		if (((this->endGreen->min != this->endGreen->max))){
			HX_STACK_LINE(483)
			endGreenComp = (this->endGreen->min + ((Float((::flixel::util::FlxRandom_obj::_internalSeed = (int(hx::Mod((::flixel::util::FlxRandom_obj::_internalSeed * (int)48271),(int)2147483647)) & int((int)2147483647)))) / Float((int)2147483647)) * ((this->endGreen->max - this->endGreen->min))));
		}
		HX_STACK_LINE(486)
		if (((this->endBlue->min != this->endBlue->max))){
			HX_STACK_LINE(488)
			endBlueComp = (this->endBlue->min + ((Float((::flixel::util::FlxRandom_obj::_internalSeed = (int(hx::Mod((::flixel::util::FlxRandom_obj::_internalSeed * (int)48271),(int)2147483647)) & int((int)2147483647)))) / Float((int)2147483647)) * ((this->endBlue->max - this->endBlue->min))));
		}
		HX_STACK_LINE(491)
		...
		if (((this->startScale->min != this->startScale->max))){
			HX_STACK_LINE(504)
			particle->__FieldRef(HX_CSTRING("startScale")) = (this->startScale->min + ((Float((::flixel::util::FlxRandom_obj::_internalSeed = (int(hx::Mod((::flixel::util::FlxRandom_obj::_internalSeed * (int)48271),(int)2147483647)) & int((int)2147483647)))) / Float((int)2147483647)) * ((this->startScale->max - this->startScale->min))));
		}
		else{
			HX_STACK_LINE(508)
		...
		if (((this->endScale->min != this->endScale->max))){
			HX_STACK_LINE(515)
			particleEndScale = (this->endScale->min + ::flixel::util::FlxRandom_obj::intRanged((int)0,::Std_obj::_int((this->endScale->max - this->endScale->min)),null()));
		}
		HX_STACK_LINE(518)
		...
		if (((this->xVelocity->min != this->xVelocity->max))){
			HX_STACK_LINE(533)
			particle->__Field(HX_CSTRING("velocity"),true)->__Field(HX_CSTRING("set_x"),true)((this->xVelocity->min + ((Float((::flixel::util::FlxRandom_obj::_internalSeed = (int(hx::Mod((::flixel::util::FlxRandom_obj::_internalSeed * (int)48271),(int)2147483647)) & int((int)2147483647)))) / Float((int)2147483647)) * ((this->xVelocity->max - this->xVelocity->min)))));
		}
		else{
			HX_STACK_LINE(537)
		...
		if (((this->yVelocity->min != this->yVelocity->max))){
			HX_STACK_LINE(541)
			particle->__Field(HX_CSTRING("velocity"),true)->__Field(HX_CSTRING("set_y"),true)((this->yVelocity->min + ((Float((::flixel::util::FlxRandom_obj::_internalSeed = (int(hx::Mod((::flixel::util::FlxRandom_obj::_internalSeed * (int)48271),(int)2147483647)) & int((int)2147483647)))) / Float((int)2147483647)) * ((this->yVelocity->max - this->yVelocity->min)))));
		}
		else{
			HX_STACK_LINE(545)
		...
		if (((this->rotation->min != this->rotation->max))){
			HX_STACK_LINE(551)
			particle->__FieldRef(HX_CSTRING("angularVelocity")) = (this->rotation->min + ((Float((::flixel::util::FlxRandom_obj::_internalSeed = (int(hx::Mod((::flixel::util::FlxRandom_obj::_internalSeed * (int)48271),(int)2147483647)) & int((int)2147483647)))) / Float((int)2147483647)) * ((this->rotation->max - this->rotation->min))));
		}
		else{
			HX_STACK_LINE(555)
		...
		if (((particle->__Field(HX_CSTRING("angularVelocity"),true) != (int)0))){
			HX_STACK_LINE(559)
			particle->__Field(HX_CSTRING("set_angle"),true)((((Float((::flixel::util::FlxRandom_obj::_internalSeed = (int(hx::Mod((::flixel::util::FlxRandom_obj::_internalSeed * (int)48271),(int)2147483647)) & int((int)2147483647)))) / Float((int)2147483647)) * (int)360) - (int)180));
		}
		HX_STACK_LINE(562)
