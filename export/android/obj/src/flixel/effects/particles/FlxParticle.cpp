...
Void FlxParticle_obj::update( ){
{
		...
		if (((this->lifespan > (int)0))){
			...
			if ((this->useColoring)){
				...
				HX_STACK_LINE(137)
				int _g = (int(::Std_obj::_int(((int)255 * redComp))) << int((int)16));		HX_STACK_VAR(_g,"_g");
				HX_STACK_LINE(137)
				int _g1 = (int(_g) | int((int(::Std_obj::_int(((int)255 * greenComp))) << int((int)8))));		HX_STACK_VAR(_g1,"_g1");
				HX_STACK_LINE(137)
				this->set_color((int(_g1) | int(::Std_obj::_int(((int)255 * blueComp)))));
			}
			HX_STACK_LINE(141)
