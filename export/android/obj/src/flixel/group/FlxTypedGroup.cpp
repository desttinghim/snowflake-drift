...
Dynamic FlxTypedGroup_obj::add( Dynamic Object){
	...
	HX_STACK_LINE(133)
	if (((this->members->__Field(HX_CSTRING("indexOf"),true)(Object,null()) >= (int)0))){
		HX_STACK_LINE(135)
		return Object;
	}
	HX_STACK_LINE(139)
...
int Order = __o_Order.Default(-1);
	HX_STACK_FRAME("flixel.group.FlxTypedGroup","sort",0xf04f1be6,"flixel.group.FlxTypedGroup.sort","flixel/group/FlxTypedGroup.hx",302,0x8fe2385a)
	HX_STACK_THIS(this)
	...
	HX_STACK_ARG(Order,"Order")
{
		struct _Function_1_1{
			inline static Dynamic Block( int &Order,Dynamic &Function){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/group/FlxTypedGroup.hx",302,0x8fe2385a)
				{
					HX_STACK_LINE(302)
		...
		HX_STACK_LINE(302)
		this->members->__Field(HX_CSTRING("sort"),true)(_Function_1_1::Block(Order,Function));
	}
return null();
}
