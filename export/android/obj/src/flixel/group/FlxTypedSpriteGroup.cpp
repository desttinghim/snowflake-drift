...
int MaxSize = __o_MaxSize.Default(0);
{
	...
	HX_STACK_LINE(69)
	this->group = ::flixel::group::FlxTypedGroup_obj::__new(MaxSize);
	HX_STACK_LINE(70)
...
{
		HX_STACK_FRAME("flixel.group.FlxTypedSpriteGroup","transformChildren_openfl__v2_display_BlendMode",0x3cfc8345,"flixel.group.FlxTypedSpriteGroup.transformChildren_openfl__v2_display_BlendMode","flixel/group/FlxTypedSpriteGroup.hx",560,0x49082bbf)
		HX_STACK_THIS(this)
...
Void FlxTypedSpriteGroup_obj::initVars( ){
{
		...
		HX_STACK_LINE(82)
		this->offset = ::flixel::util::FlxCallbackPoint_obj::__new(this->offsetCallback_dyn(),null(),null());
		HX_STACK_LINE(83)
		this->origin = ::flixel::util::FlxCallbackPoint_obj::__new(this->originCallback_dyn(),null(),null());
		HX_STACK_LINE(84)
		this->scale = ::flixel::util::FlxCallbackPoint_obj::__new(this->scaleCallback_dyn(),null(),null());
		HX_STACK_LINE(85)
		this->scrollFactor = ::flixel::util::FlxCallbackPoint_obj::__new(this->scrollFactorCallback_dyn(),null(),null());
		HX_STACK_LINE(87)
...
Void FlxTypedSpriteGroup_obj::destroy( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(100)
		this->offset = ::flixel::util::FlxDestroyUtil_obj::destroy(this->offset);
		HX_STACK_LINE(101)
		this->origin = ::flixel::util::FlxDestroyUtil_obj::destroy(this->origin);
		HX_STACK_LINE(102)
		this->scale = ::flixel::util::FlxDestroyUtil_obj::destroy(this->scale);
		HX_STACK_LINE(103)
		this->scrollFactor = ::flixel::util::FlxDestroyUtil_obj::destroy(this->scrollFactor);
		HX_STACK_LINE(105)
		this->group = ::flixel::util::FlxDestroyUtil_obj::destroy(this->group);
		HX_STACK_LINE(106)
		this->_sprites = null();
		HX_STACK_LINE(108)
		this->super::destroy();
...
::flixel::FlxSprite FlxTypedSpriteGroup_obj::clone( ::flixel::FlxSprite NewSprite){
	...
	if (((  ((!(((NewSprite == null()))))) ? bool(!(::Std_obj::is(NewSprite,hx::ClassOf< ::flixel::group::FlxTypedSpriteGroup >()))) : bool(true) ))){
		HX_STACK_LINE(121)
		NewSprite = ::flixel::group::FlxTypedSpriteGroup_obj::__new((int)0,(int)0,this->group->maxSize);
	}
	HX_STACK_LINE(124)
	...
	HX_STACK_LINE(146)
	{
		...
		while(((_g < _g1->length))){
			...
			if (((bool((bool((sprite != null())) && bool(sprite->exists))) && bool(sprite->visible)))){
				...
				if ((!(result))){
					HX_STACK_LINE(150)
					result = sprite->isOnScreen(Camera);
				}
				else{
					HX_STACK_LINE(150)
					result = true;
...
Void FlxTypedSpriteGroup_obj::update( ){
{
		...
		if ((this->moves)){
			...
			HX_STACK_LINE(208)
			Float velocityDelta = (0.5 * ((::flixel::util::FlxVelocity_obj::computeVelocity(this->angularVelocity,this->angularAcceleration,this->angularDrag,this->maxAngular) - this->angularVelocity)));		HX_STACK_VAR(velocityDelta,"velocityDelta");
			HX_STACK_LINE(208)
	...
	HX_STACK_ARG(Order,"Order")
{
		struct _Function_1_1{
			inline static Dynamic Block( int &Order,Dynamic &Function){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/group/FlxTypedSpriteGroup.hx",315,0x49082bbf)
				{
					HX_STACK_LINE(315)
		...
		HX_STACK_LINE(315)
		this->group->members->__Field(HX_CSTRING("sort"),true)(_Function_1_1::Block(Order,Function));
	}
return null();
}
	...
	HX_STACK_ARG(Y,"Y")
{
		...
		HX_STACK_LINE(543)
		Dynamic _g = Dynamic( Array_obj<Dynamic>::__new().Add(this->xTransform_dyn()).Add(this->yTransform_dyn()));		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(543)
		this->multiTransformChildren_Float(_g,Array_obj< Float >::__new().Add(dx).Add(dy));
		HX_STACK_LINE(546)
...
Float FlxTypedSpriteGroup_obj::get_width( ){
	...
	HX_STACK_LINE(778)
	{
		...
		while(((_g < _g1->length))){
			...
			HX_STACK_LINE(781)
			Float maxMemberX = (minMemberX + member->get_width());		HX_STACK_VAR(maxMemberX,"maxMemberX");
			HX_STACK_LINE(783)
			if (((maxMemberX > maxX))){
				HX_STACK_LINE(785)
				maxX = maxMemberX;
...
Float FlxTypedSpriteGroup_obj::get_height( ){
	...
	HX_STACK_LINE(813)
	{
		...
		while(((_g < _g1->length))){
			...
			HX_STACK_LINE(816)
			Float maxMemberY = (minMemberY + member->get_height());		HX_STACK_VAR(maxMemberY,"maxMemberY");
			HX_STACK_LINE(818)
			if (((maxMemberY > maxY))){
				HX_STACK_LINE(820)
				maxY = maxMemberY;
...
::flixel::FlxSprite FlxTypedSpriteGroup_obj::loadGraphicFromSprite( ::flixel::FlxSprite Sprite){
	...
	HX_STACK_ARG(Sprite,"Sprite")
	HX_STACK_LINE(894)
	::flixel::FlxG_obj::log->advanced(HX_CSTRING("loadGraphicFromSprite() is not supported in FlxSpriteGroups."),::flixel::system::debug::LogStyle_obj::ERROR,true);
	HX_STACK_LINE(896)
...
{
		HX_STACK_LINE(915)
		::flixel::FlxG_obj::log->advanced(HX_CSTRING("loadRotatedGraphic() is not supported in FlxSpriteGroups."),::flixel::system::debug::LogStyle_obj::ERROR,true);
		HX_STACK_LINE(917)
		return hx::ObjectPtr<OBJ_>(this);
	}
}
...
{
		HX_STACK_LINE(927)
		::flixel::FlxG_obj::log->advanced(HX_CSTRING("makeGraphic() is not supported in FlxSpriteGroups."),::flixel::system::debug::LogStyle_obj::ERROR,true);
		HX_STACK_LINE(929)
		return hx::ObjectPtr<OBJ_>(this);
	}
}
...
{
		HX_STACK_LINE(939)
		::flixel::FlxG_obj::log->advanced(HX_CSTRING("loadGraphicFromTexture() is not supported in FlxSpriteGroups."),::flixel::system::debug::LogStyle_obj::ERROR,true);
		HX_STACK_LINE(941)
		return hx::ObjectPtr<OBJ_>(this);
	}
}
...
{
		HX_STACK_LINE(951)
		::flixel::FlxG_obj::log->advanced(HX_CSTRING("loadRotatedGraphicFromTexture() is not supported in FlxSpriteGroups."),::flixel::system::debug::LogStyle_obj::ERROR,true);
		HX_STACK_LINE(953)
		return hx::ObjectPtr<OBJ_>(this);
	}
}
...
void FlxTypedSpriteGroup_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_CSTRING("_isDrawnDebug"));
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsBool,(int)offsetof(FlxTypedSpriteGroup_obj,_isDrawnDebug),HX_CSTRING("_isDrawnDebug")},
