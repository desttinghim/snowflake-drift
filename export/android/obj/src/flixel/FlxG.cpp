	...
	HX_STACK_ARG(Target,"Target")
{
		...
		HX_STACK_LINE(426)
		::openfl::_v2::Lib_obj::getURL(::openfl::_v2::net::URLRequest_obj::__new((prefix + URL)),Target);
	}
return null();
}
...
Void FlxG_obj::init( ::flixel::FlxGame Game,int Width,int Height,Float Zoom){
{
		...
		HX_STACK_LINE(447)
		::flixel::FlxG_obj::set_mouse(::flixel::FlxG_obj::inputs->add_flixel_input_mouse_FlxMouse(::flixel::input::mouse::FlxMouse_obj::__new(::flixel::FlxG_obj::game->_inputContainer)));
		HX_STACK_LINE(451)
		...
		HX_STACK_LINE(459)
		::flixel::FlxG_obj::android = ::flixel::FlxG_obj::inputs->add_flixel_input_android_FlxAndroidKeys(::flixel::input::android::FlxAndroidKeys_obj::__new());
		HX_STACK_LINE(463)
		::flixel::FlxG_obj::accelerometer = ::flixel::input::FlxAccelerometer_obj::__new();
		HX_STACK_LINE(465)
...
::flixel::input::mouse::FlxMouse FlxG_obj::set_mouse( ::flixel::input::mouse::FlxMouse NewMouse){
	...
	if (((::flixel::FlxG_obj::mouse == null()))){
		HX_STACK_LINE(508)
		::flixel::FlxG_obj::mouse = ::flixel::FlxG_obj::inputs->add_flixel_input_mouse_FlxMouse(NewMouse);
		HX_STACK_LINE(509)
...
void FlxG_obj::__boot()
{
	...
	VERSION= ::flixel::system::FlxVersion_obj::__new((int)3,(int)3,(int)6,null());
	elapsed= (int)0;
	maxElapsed= 0.1;
	fullscreen= false;
