...
Float Y = __o_Y.Default(0);
{
	...
	struct _Function_1_1{
		inline static ::flixel::util::FlxPoint Block( ){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/ui/FlxTypedButton.hx",93,0x752be24c)
			{
				HX_STACK_LINE(93)
	...
	HX_STACK_LINE(93)
	this->labelOffsets = Array_obj< ::Dynamic >::__new().Add(_g).Add(_g1).Add(_Function_1_1::Block());
	HX_STACK_LINE(95)
...
Void FlxTypedButton_obj::destroy( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(110)
		this->set_label(::flixel::util::FlxDestroyUtil_obj::destroy(this->label));
		HX_STACK_LINE(112)
		this->onUp = ::flixel::util::FlxDestroyUtil_obj::destroy(this->onUp);
		HX_STACK_LINE(113)
		this->onDown = ::flixel::util::FlxDestroyUtil_obj::destroy(this->onDown);
		HX_STACK_LINE(114)
		this->onOver = ::flixel::util::FlxDestroyUtil_obj::destroy(this->onOver);
		HX_STACK_LINE(115)
		this->onOut = ::flixel::util::FlxDestroyUtil_obj::destroy(this->onOut);
		HX_STACK_LINE(117)
...
Void FlxTypedButton_obj::draw( ){
{
		...
		if (((bool((this->label != null())) && bool(this->label->__Field(HX_CSTRING("visible"),true))))){
			HX_STACK_LINE(169)
			this->label->__Field(HX_CSTRING("set_cameras"),true)(this->get_cameras());
			HX_STACK_LINE(170)
