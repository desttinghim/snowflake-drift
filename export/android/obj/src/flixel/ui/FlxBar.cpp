...
bool border = __o_border.Default(false);
{
	...
	HX_STACK_LINE(140)
	this->zeroOffset = ::openfl::_v2::geom::Point_obj::__new(null(),null());
	HX_STACK_LINE(142)
	...
	HX_STACK_LINE(159)
	this->filledBarPoint = ::openfl::_v2::geom::Point_obj::__new((int)0,(int)0);
	HX_STACK_LINE(165)
	if (((parentRef != null()))){
		HX_STACK_LINE(167)
...
Void FlxBar_obj::destroy( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(187)
		this->positionOffset = ::flixel::util::FlxDestroyUtil_obj::put(this->positionOffset);
		HX_STACK_LINE(193)
		...
		HX_STACK_LINE(206)
		this->emptyBar = ::flixel::util::FlxDestroyUtil_obj::dispose(this->emptyBar);
		HX_STACK_LINE(207)
		this->filledBar = ::flixel::util::FlxDestroyUtil_obj::dispose(this->filledBar);
		HX_STACK_LINE(209)
		this->super::destroy();
	}
return null();
	...
	HX_STACK_ARG(border,"border")
{
		...
		HX_STACK_LINE(402)
		::String emptyKey = (((((((((HX_CSTRING("empty: ") + this->barWidth) + HX_CSTRING("x")) + this->barHeight) + HX_CSTRING(":")) + emptyA) + HX_CSTRING(".")) + emptyRGB) + HX_CSTRING("showBorder: ")) + ::Std_obj::string(showBorder));		HX_STACK_VAR(emptyKey,"emptyKey");
		HX_STACK_LINE(403)
		::String filledKey = (((((((((HX_CSTRING("filled: ") + this->barWidth) + HX_CSTRING("x")) + this->barHeight) + HX_CSTRING(":")) + fillA) + HX_CSTRING(".")) + fillRGB) + HX_CSTRING("showBorder: ")) + ::Std_obj::string(showBorder));		HX_STACK_VAR(filledKey,"filledKey");
		HX_STACK_LINE(404)
		if ((showBorder)){
			HX_STACK_LINE(406)
		...
		if ((showBorder)){
			struct _Function_2_1{
				inline static bool Block( ::String &emptyKey){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/ui/FlxBar.hx",423,0x9c56c8d5)
					{
						HX_STACK_LINE(423)
						::flixel::system::frontEnds::BitmapFrontEnd _this = ::flixel::FlxG_obj::bitmap;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(423)
						return (  ((_this->_cache->exists(emptyKey))) ? bool((_this->_cache->get(emptyKey) != null())) : bool(false) );
					}
					return null();
				}
			};
			HX_STACK_LINE(423)
			if (((_Function_2_1::Block(emptyKey) == false))){
				HX_STACK_LINE(425)
				...
				HX_STACK_LINE(426)
				emptyBar->fillRect(::openfl::_v2::geom::Rectangle_obj::__new((int)1,(int)1,(this->barWidth - (int)2),(this->barHeight - (int)2)),empty);
				HX_STACK_LINE(428)
				::flixel::FlxG_obj::bitmap->addWithSpaces(emptyBar,(int)0,(int)0,(int)1,(int)1,false,emptyKey);
			}
			struct _Function_2_2{
				inline static bool Block( ::String &filledKey){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/ui/FlxBar.hx",431,0x9c56c8d5)
					{
						HX_STACK_LINE(431)
						::flixel::system::frontEnds::BitmapFrontEnd _this = ::flixel::FlxG_obj::bitmap;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(431)
						return (  ((_this->_cache->exists(filledKey))) ? bool((_this->_cache->get(filledKey) != null())) : bool(false) );
					}
					return null();
				}
			};
			HX_STACK_LINE(431)
			if (((_Function_2_2::Block(filledKey) == false))){
				HX_STACK_LINE(433)
				...
				HX_STACK_LINE(434)
				filledBar->fillRect(::openfl::_v2::geom::Rectangle_obj::__new((int)1,(int)1,(this->barWidth - (int)2),(this->barHeight - (int)2)),fill);
				HX_STACK_LINE(436)
			...
			struct _Function_2_1{
				inline static bool Block( ::String &emptyKey){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/ui/FlxBar.hx",449,0x9c56c8d5)
					{
						HX_STACK_LINE(449)
						::flixel::system::frontEnds::BitmapFrontEnd _this = ::flixel::FlxG_obj::bitmap;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(449)
			...
			struct _Function_2_2{
				inline static bool Block( ::String &filledKey){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/ui/FlxBar.hx",455,0x9c56c8d5)
					{
						HX_STACK_LINE(455)
						::flixel::system::frontEnds::BitmapFrontEnd _this = ::flixel::FlxG_obj::bitmap;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(455)
		...
		HX_STACK_LINE(471)
		this->setCachedFrontGraphics(::flixel::FlxG_obj::bitmap->get(filledKey));
		HX_STACK_LINE(473)
		...
		HX_STACK_LINE(476)
		this->_frontRegion = ::flixel::system::layer::Region_obj::__new(null(),null(),null(),null(),null(),null(),null(),null());
		HX_STACK_LINE(477)
		this->_frontRegion->width = this->_cachedFrontGraphics->bitmap->get_width();
		HX_STACK_LINE(478)
		this->_frontRegion->height = this->_cachedFrontGraphics->bitmap->get_height();
		HX_STACK_LINE(479)
		this->updateFrameData();
	}
return null();
	...
	HX_STACK_ARG(border,"border")
{
		...
		HX_STACK_LINE(510)
		emptyKey = ((((((emptyKey + HX_CSTRING("], chunkSize: ")) + chunkSize) + HX_CSTRING(", rotation: ")) + rotation) + HX_CSTRING("showBorder: ")) + ::Std_obj::string(showBorder));
		HX_STACK_LINE(512)
		...
		HX_STACK_LINE(520)
		filledKey = ((((((filledKey + HX_CSTRING("], chunkSize: ")) + chunkSize) + HX_CSTRING(", rotation: ")) + rotation) + HX_CSTRING("showBorder: ")) + ::Std_obj::string(showBorder));
		HX_STACK_LINE(522)
		if ((showBorder)){
			HX_STACK_LINE(524)
			int borderA = (int((int(border) >> int((int)24))) & int((int)255));		HX_STACK_VAR(borderA,"borderA");
		...
		if ((showBorder)){
			struct _Function_2_1{
				inline static bool Block( ::String &emptyKey){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/ui/FlxBar.hx",550,0x9c56c8d5)
					{
						HX_STACK_LINE(550)
						::flixel::system::frontEnds::BitmapFrontEnd _this = ::flixel::FlxG_obj::bitmap;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(550)
			...
			struct _Function_2_2{
				inline static bool Block( ::String &filledKey){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/ui/FlxBar.hx",557,0x9c56c8d5)
					{
						HX_STACK_LINE(557)
						::flixel::system::frontEnds::BitmapFrontEnd _this = ::flixel::FlxG_obj::bitmap;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(557)
			...
			struct _Function_2_1{
				inline static bool Block( ::String &emptyKey){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/ui/FlxBar.hx",571,0x9c56c8d5)
					{
						HX_STACK_LINE(571)
						::flixel::system::frontEnds::BitmapFrontEnd _this = ::flixel::FlxG_obj::bitmap;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(571)
			...
			struct _Function_2_2{
				inline static bool Block( ::String &filledKey){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/ui/FlxBar.hx",577,0x9c56c8d5)
					{
						HX_STACK_LINE(577)
						::flixel::system::frontEnds::BitmapFrontEnd _this = ::flixel::FlxG_obj::bitmap;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(577)
	...
	HX_STACK_ARG(fillBackground,"fillBackground")
{
		...
		if (((empty != null()))){
			...
			if ((::Std_obj::is(empty,hx::ClassOf< ::Class >()))){
				HX_STACK_LINE(628)
				hx::AddEq(emptyKey,::Type_obj::getClassName(hx::TCast< Class >::cast(empty)));
			}
			else{
				HX_STACK_LINE(630)
				if ((::Std_obj::is(empty,hx::ClassOf< ::String >()))){
					HX_STACK_LINE(632)
					hx::AddEq(emptyKey,::Std_obj::string(empty));
				}
			}
		}
		HX_STACK_LINE(636)
		if (((fill != null()))){
			...
			if ((::Std_obj::is(fill,hx::ClassOf< ::Class >()))){
				HX_STACK_LINE(640)
				hx::AddEq(filledKey,::Type_obj::getClassName(hx::TCast< Class >::cast(fill)));
			}
			else{
				HX_STACK_LINE(642)
				if ((::Std_obj::is(fill,hx::ClassOf< ::String >()))){
					HX_STACK_LINE(644)
					hx::AddEq(filledKey,::Std_obj::string(fill));
				}
			}
		}
		HX_STACK_LINE(648)
		...
		if (((bool((empty != null())) && bool((fill == null()))))){
			HX_STACK_LINE(677)
			this->barWidth = emptyBitmapData->get_width();
			HX_STACK_LINE(678)
			this->barHeight = emptyBitmapData->get_height();
			HX_STACK_LINE(680)
			if (((this->barWidth >= this->barHeight))){
				HX_STACK_LINE(682)
				this->_framesPosition = HX_CSTRING("horizontal");
			...
			struct _Function_2_1{
				inline static bool Block( ::String &emptyKey){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/ui/FlxBar.hx",689,0x9c56c8d5)
					{
						HX_STACK_LINE(689)
						::flixel::system::frontEnds::BitmapFrontEnd _this = ::flixel::FlxG_obj::bitmap;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(689)
			...
			struct _Function_2_2{
				inline static bool Block( ::String &filledKey){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/ui/FlxBar.hx",694,0x9c56c8d5)
					{
						HX_STACK_LINE(694)
						::flixel::system::frontEnds::BitmapFrontEnd _this = ::flixel::FlxG_obj::bitmap;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(694)
			...
			if (((bool((empty == null())) && bool((fill != null()))))){
				HX_STACK_LINE(714)
				this->barWidth = fillBitmapData->get_width();
				HX_STACK_LINE(715)
				this->barHeight = fillBitmapData->get_height();
				HX_STACK_LINE(717)
				if (((this->barWidth >= this->barHeight))){
					HX_STACK_LINE(719)
					this->_framesPosition = HX_CSTRING("horizontal");
				...
				struct _Function_3_1{
					inline static bool Block( ::String &emptyKey){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/ui/FlxBar.hx",726,0x9c56c8d5)
						{
							HX_STACK_LINE(726)
							::flixel::system::frontEnds::BitmapFrontEnd _this = ::flixel::FlxG_obj::bitmap;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(726)
				...
				HX_STACK_LINE(726)
				if (((_Function_3_1::Block(emptyKey) == false))){
					HX_STACK_LINE(728)
				...
				struct _Function_3_2{
					inline static bool Block( ::String &filledKey){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/ui/FlxBar.hx",732,0x9c56c8d5)
						{
							HX_STACK_LINE(732)
							::flixel::system::frontEnds::BitmapFrontEnd _this = ::flixel::FlxG_obj::bitmap;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(732)
				...
				HX_STACK_LINE(732)
				if (((_Function_3_2::Block(filledKey) == false))){
					HX_STACK_LINE(734)
				...
				if (((bool((empty != null())) && bool((fill != null()))))){
					...
					struct _Function_4_1{
						inline static bool Block( ::String &emptyKey){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/ui/FlxBar.hx",763,0x9c56c8d5)
							{
								HX_STACK_LINE(763)
								::flixel::system::frontEnds::BitmapFrontEnd _this = ::flixel::FlxG_obj::bitmap;		HX_STACK_VAR(_this,"_this");
								HX_STACK_LINE(763)
					...
					HX_STACK_LINE(763)
					if (((_Function_4_1::Block(emptyKey) == false))){
						HX_STACK_LINE(765)
						::flixel::FlxG_obj::bitmap->addWithSpaces(emptyBitmapData,(int)0,(int)0,(int)1,(int)1,false,emptyKey);
					}
					struct _Function_4_2{
						inline static bool Block( ::String &filledKey){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/ui/FlxBar.hx",768,0x9c56c8d5)
							{
								HX_STACK_LINE(768)
								::flixel::system::frontEnds::BitmapFrontEnd _this = ::flixel::FlxG_obj::bitmap;		HX_STACK_VAR(_this,"_this");
								HX_STACK_LINE(768)
					...
					HX_STACK_LINE(768)
					if (((_Function_4_2::Block(filledKey) == false))){
						HX_STACK_LINE(770)
						::flixel::FlxG_obj::bitmap->addWithSpaces(fillBitmapData,(int)0,(int)0,(int)1,(int)1,false,filledKey);
					}
				}
...
{
		HX_STACK_FRAME("flixel.ui.FlxBar","updateValueFromParent",0x9d60d3b7,"flixel.ui.FlxBar.updateValueFromParent","flixel/ui/FlxBar.hx",825,0x9c56c8d5)
		HX_STACK_THIS(this)
		struct _Function_1_1{
			inline static Dynamic Block( ::flixel::ui::FlxBar_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/ui/FlxBar.hx",825,0x9c56c8d5)
				{
					HX_STACK_LINE(825)
					Dynamic o = __this->parent;		HX_STACK_VAR(o,"o");
					HX_STACK_LINE(825)
					return (  (((o == null()))) ? Dynamic(null()) : Dynamic(o->__Field(__this->parentVariable,true)) );
				}
				return null();
			}
		};
		HX_STACK_LINE(825)
		this->updateValue(_Function_1_1::Block(this));
	}
return null();
}
...
Void FlxBar_obj::update( ){
{
		...
		if (((this->parent != null()))){
			struct _Function_2_1{
				inline static Dynamic Block( ::flixel::ui::FlxBar_obj *__this){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/ui/FlxBar.hx",924,0x9c56c8d5)
					{
						HX_STACK_LINE(924)
						Dynamic o = __this->parent;		HX_STACK_VAR(o,"o");
						HX_STACK_LINE(924)
			...
			HX_STACK_LINE(924)
			if (((_Function_2_1::Block(this) != this->value))){
				HX_STACK_LINE(926)
				this->updateValueFromParent();
				HX_STACK_LINE(927)
				this->updateBar();
...
Void FlxBar_obj::draw( ){
{
		...
		HX_STACK_LINE(1003)
		int percentFrame = ((int)2 * ((::Math_obj::floor(this->get_percent()) - (int)1)));		HX_STACK_VAR(percentFrame,"percentFrame");
		HX_STACK_LINE(1005)
		...
		HX_STACK_LINE(1009)
		{
			...
			while(((_g < _g1->length))){
				...
				HX_STACK_LINE(1057)
				currDrawData[(currIndex)++] = this->_emptyBarFrameID;
				HX_STACK_LINE(1059)
				...
				HX_STACK_LINE(1075)
				drawItem = camera->getDrawStackItem(this->_cachedFrontGraphics,this->isColored,this->_blendInt,this->antialiasing);
				HX_STACK_LINE(1077)
				currDrawData = drawItem->drawData;
				HX_STACK_LINE(1078)
				currIndex = drawItem->position;
				...
				if (((percentFrame >= (int)0))){
					...
					HX_STACK_LINE(1100)
					currDrawData[(currIndex)++] = this->_filledBarFrames->__get((percentFrame + (int)1));
					HX_STACK_LINE(1102)
					currDrawData[(currIndex)++] = csx;
					HX_STACK_LINE(1103)
					currDrawData[(currIndex)++] = -(ssx);
...
Void FlxBar_obj::updateFrameData( ){
{
		...
		HX_STACK_LINE(1146)
		{
			...
			HX_STACK_LINE(1146)
			this->_emptyBarFrameID = _this->tileSheet->addTileRectID(tileRect,point);
		}
		HX_STACK_LINE(1147)
		...
		HX_STACK_LINE(1155)
		{
			...
			HX_STACK_LINE(1155)
			int _g = (int)101;		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(1155)
			while(((_g1 < _g))){
				HX_STACK_LINE(1155)
				...
				struct _Function_3_1{
					inline static int Block( ::flixel::ui::FlxBar_obj *__this,Float &frameHeight,Float &frameX,Float &frameY,Float &frameWidth){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/ui/FlxBar.hx",1223,0x9c56c8d5)
						{
							HX_STACK_LINE(1223)
							::flixel::system::layer::TileSheetData _this = __this->_cachedFrontGraphics->get_tilesheet();		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(1223)
							...
							HX_STACK_LINE(1223)
							return _this->tileSheet->addTileRectID(tileRect,point);
						}
						return null();
					}
				};
				HX_STACK_LINE(1223)
				this->_filledBarFrames->push(_Function_3_1::Block(this,frameHeight,frameX,frameY,frameWidth));
			}
		}
	}
return null();
...
::String FlxBar_obj::toString( ){
	...
	struct _Function_1_1{
		inline static ::flixel::util::LabelValuePair Block( ::flixel::ui::FlxBar_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/ui/FlxBar.hx",1256,0x9c56c8d5)
			{
				HX_STACK_LINE(1256)
				::flixel::util::LabelValuePair _this = ::flixel::util::LabelValuePair_obj::_pool->get();		HX_STACK_VAR(_this,"_this");
				HX_STACK_LINE(1256)
	...
	HX_STACK_LINE(1250)
	return ::flixel::util::FlxStringUtil_obj::getDebugString(Array_obj< ::Dynamic >::__new().Add(_g).Add(_g1).Add(_g2).Add(_g3).Add(_g4).Add(_Function_1_1::Block(this)));
}
