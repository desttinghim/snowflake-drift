...
Float Y = __o_Y.Default(0);
{
	...
	{
		HX_STACK_LINE(47)
		this->set_label(::flixel::text::FlxText_obj::__new((this->x + this->labelOffsets->__get((int)0).StaticCast< ::flixel::util::FlxPoint >()->x),(this->y + this->labelOffsets->__get((int)0).StaticCast< ::flixel::util::FlxPoint >()->y),(int)80,Text,null(),null()));
		HX_STACK_LINE(47)
...
Void FlxButton_obj::resetHelpers( ){
{
		...
		if (((this->label != null()))){
			HX_STACK_LINE(59)
			this->label->__Field(HX_CSTRING("set_fieldWidth"),true)(this->label->__FieldRef(HX_CSTRING("frameWidth")) = ::Std_obj::_int(this->get_width()));
			HX_STACK_LINE(60)
