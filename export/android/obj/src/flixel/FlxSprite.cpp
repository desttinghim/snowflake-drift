...
Void FlxSprite_obj::initVars( ){
{
		...
		HX_STACK_LINE(210)
		this->_flashRect = ::openfl::_v2::geom::Rectangle_obj::__new(null(),null(),null(),null());
		HX_STACK_LINE(211)
		this->_flashRect2 = ::openfl::_v2::geom::Rectangle_obj::__new(null(),null(),null(),null());
		HX_STACK_LINE(212)
		this->_flashPointZero = ::openfl::_v2::geom::Point_obj::__new(null(),null());
		HX_STACK_LINE(213)
		{
			HX_STACK_LINE(213)
...
Void FlxSprite_obj::destroy( ){
{
		...
		this->super::destroy();
		HX_STACK_LINE(227)
		this->animation = ::flixel::util::FlxDestroyUtil_obj::destroy(this->animation);
		HX_STACK_LINE(229)
		this->offset = ::flixel::util::FlxDestroyUtil_obj::put(this->offset);
		HX_STACK_LINE(230)
		this->origin = ::flixel::util::FlxDestroyUtil_obj::put(this->origin);
		HX_STACK_LINE(231)
		this->scale = ::flixel::util::FlxDestroyUtil_obj::put(this->scale);
		HX_STACK_LINE(233)
		this->framePixels = ::flixel::util::FlxDestroyUtil_obj::dispose(this->framePixels);
		HX_STACK_LINE(235)
	...
	HX_STACK_ARG(Key,"Key")
{
		...
		this->bakedRotationAngle = (int)0;
		HX_STACK_LINE(307)
		this->set_cachedGraphics(::flixel::FlxG_obj::bitmap->addWithSpaces(Graphic,(int)0,(int)0,(int)1,(int)1,Unique,Key));
		HX_STACK_LINE(309)
		if (((Width == (int)0))){
			HX_STACK_LINE(311)
			if (((Animated == true))){
	...
	HX_STACK_ARG(Key,"Key")
{
		...
		HX_STACK_LINE(369)
		::openfl::_v2::display::BitmapData brush = ::flixel::FlxG_obj::bitmap->addWithSpaces(Graphic,(int)0,(int)0,(int)1,(int)1,false,Key)->bitmap;		HX_STACK_VAR(brush,"brush");
		HX_STACK_LINE(370)
		...
		if (((bool((Frame >= (int)0)) || bool(isRegion)))){
			...
			if ((isRegion)){
				HX_STACK_LINE(381)
				brush = ::openfl::_v2::display::BitmapData_obj::__new(tempRegion->width,tempRegion->height,null(),null(),null());
				HX_STACK_LINE(382)
				...
				HX_STACK_LINE(390)
				brush = ::openfl::_v2::display::BitmapData_obj::__new(_g,full->get_height(),null(),null(),null());
				HX_STACK_LINE(391)
		...
		if ((::Std_obj::is(Graphic,hx::ClassOf< ::String >()))){
			...
			if ((::Std_obj::is(Graphic,hx::ClassOf< ::Class >()))){
				...
				HX_STACK_LINE(430)
				if (((  ((::Std_obj::is(Graphic,hx::ClassOf< ::openfl::_v2::display::BitmapData >()))) ? bool((Key != null())) : bool(false) ))){
					HX_STACK_LINE(432)
					key = Key;
				}
				else{
		...
		HX_STACK_LINE(449)
		{
			...
			if ((_this->_cache->exists(key))){
				HX_STACK_LINE(449)
				skipGen = (_this->_cache->get(key) != null());
			}
			else{
				HX_STACK_LINE(449)
				skipGen = false;
	...
	HX_STACK_ARG(FrameName,"FrameName")
{
		...
		if ((::Std_obj::is(Data,hx::ClassOf< ::flixel::util::loaders::CachedGraphics >()))){
			...
			if ((::Std_obj::is(Data,hx::ClassOf< ::flixel::util::loaders::TexturePackerData >()))){
				HX_STACK_LINE(527)
				this->set_cachedGraphics(::flixel::FlxG_obj::bitmap->addWithSpaces(Data->__Field(HX_CSTRING("assetName"),true),(int)0,(int)0,(int)1,(int)1,Unique,null()));
				HX_STACK_LINE(528)
...
Void FlxSprite_obj::draw( ){
{
		...
		HX_STACK_LINE(748)
		{
			...
			while(((_g < _g1->length))){
				...
				{
					HX_STACK_LINE(875)
					::flixel::util::FlxPoint _g2 = this->_point;		HX_STACK_VAR(_g2,"_g2");
					HX_STACK_LINE(875)
					_g2->set_x((_g2->x - x2));
				}
				HX_STACK_LINE(876)
				...
				if ((this->pixelPerfectRender)){
					...
					HX_STACK_LINE(880)
					_this->set_x(::Math_obj::floor(_this->x));
					HX_STACK_LINE(880)
					_this->set_y(::Math_obj::floor(_this->y));
					HX_STACK_LINE(880)
					_this;
				}
				HX_STACK_LINE(883)
	...
	HX_STACK_ARG(Y,"Y")
{
		...
		HX_STACK_LINE(923)
		::openfl::_v2::display::BitmapData bitmapData = Brush->framePixels;		HX_STACK_VAR(bitmapData,"bitmapData");
		HX_STACK_LINE(926)
				...
				if (((this->cachedGraphics->bitmap->getPixel32(column,row) == Color))){
					...
					if ((FetchPositions)){
						struct _Function_5_1{
							inline static ::flixel::util::FlxPoint Block( int &column,int &row){
								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/FlxSprite.hx",1035,0x0384bffa)
								{
									HX_STACK_LINE(1035)
						...
						HX_STACK_LINE(1035)
						positions->push(_Function_5_1::Block(column,row));
					}
					HX_STACK_LINE(1037)
					this->dirty = true;
				}
	...
	HX_STACK_ARG(alphaOffset,"alphaOffset")
{
		struct _Function_1_1{
			inline static int Block( Float &redMultiplier,Float &blueMultiplier,Float &greenMultiplier){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/FlxSprite.hx",1062,0x0384bffa)
				{
					HX_STACK_LINE(1062)
		...
		if (((this->colorTransform == null()))){
			HX_STACK_LINE(1067)
			this->colorTransform = ::openfl::_v2::geom::ColorTransform_obj::__new(null(),null(),null(),null(),null(),null(),null(),null());
		}
		else{
			HX_STACK_LINE(1071)
...
Void FlxSprite_obj::updateColorTransform( ){
{
		...
		if (((bool((this->alpha != (int)1)) || bool((this->color != (int)16777215))))){
			...
			if (((this->colorTransform == null()))){
				HX_STACK_LINE(1091)
				this->colorTransform = ::openfl::_v2::geom::ColorTransform_obj::__new((Float(((int(this->color) >> int((int)16)))) / Float((int)255)),(Float(((int((int(this->color) >> int((int)8))) & int((int)255)))) / Float((int)255)),(Float(((int(this->color) & int((int)255)))) / Float((int)255)),this->alpha,null(),null(),null(),null());
			}
			else{
				HX_STACK_LINE(1095)
	...
	HX_STACK_ARG(Camera,"Camera")
{
		...
		if (((bool((bool((bool((this->_flashPoint->x < (int)0)) || bool((this->_flashPoint->x > this->frameWidth)))) || bool((this->_flashPoint->y < (int)0)))) || bool((this->_flashPoint->y > this->frameHeight))))){
			...
			HX_STACK_LINE(1147)
			{
				...
				if (((bool((this->frame != null())) && bool(this->dirty)))){
					...
					if (((bool((bool(!(this->flipX)) && bool(!(this->flipY)))) && bool((this->frame->type == ::flixel::system::layer::frames::FrameType_obj::REGULAR))))){
						HX_STACK_LINE(1147)
						this->framePixels = this->frame->paintOnBitmap(this->framePixels);
					}
					else{
						HX_STACK_LINE(1147)
						...
						if (((bool(this->flipX) && bool(this->flipY)))){
							HX_STACK_LINE(1147)
							frameBmd = this->frame->getHVReversedBitmap();
						}
						else{
							HX_STACK_LINE(1147)
							if ((this->flipX)){
								...
								if ((this->flipY)){
									HX_STACK_LINE(1147)
									frameBmd = this->frame->getVReversedBitmap();
								}
								else{
									HX_STACK_LINE(1147)
						...
						if (((  ((!(((  ((!(((this->framePixels == null()))))) ? bool((this->framePixels->get_width() != this->frameWidth)) : bool(true) ))))) ? bool((this->framePixels->get_height() != this->frameHeight)) : bool(true) ))){
							...
							HX_STACK_LINE(1147)
							this->framePixels = ::openfl::_v2::display::BitmapData_obj::__new(_g,::Std_obj::_int(this->frame->sourceSize->y),null(),null(),null());
						}
						HX_STACK_LINE(1147)
			...
			HX_STACK_LINE(1148)
			int _g1 = ::Std_obj::_int(this->_flashPoint->x);		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(1148)
			int pixelColor = frameData->getPixel32(_g1,::Std_obj::_int(this->_flashPoint->y));		HX_STACK_VAR(pixelColor,"pixelColor");
			HX_STACK_LINE(1149)
...
::openfl::_v2::display::BitmapData FlxSprite_obj::set_pixels( ::openfl::_v2::display::BitmapData Pixels){
	...
	if (((key == null()))){
		...
		HX_STACK_LINE(1401)
		this->set_cachedGraphics(::flixel::FlxG_obj::bitmap->addWithSpaces(Pixels,(int)0,(int)0,(int)1,(int)1,false,key));
		HX_STACK_LINE(1402)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::_v2::geom::Matrix*/ ,(int)offsetof(FlxSprite_obj,_matrix),HX_CSTRING("_matrix")},
