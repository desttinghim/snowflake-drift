	...
	while(((pout < size))){
		...
		while(((curbits < (int)8))){
			...
			struct _Function_3_1{
				inline static int Block( int &pin,::haxe::io::Bytes &b){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","C:\\HaxeToolkit\\haxe\\std/haxe/crypto/BaseCode.hx",99,0x52da3542)
					{
						HX_STACK_LINE(99)
						int pos = (pin)++;		HX_STACK_VAR(pos,"pos");
						HX_STACK_LINE(99)
						return b->b->__get(pos);
					}
					return null();
				}
			};
			HX_STACK_LINE(99)
			int i = tbl->__get(_Function_3_1::Block(pin,b));		HX_STACK_VAR(i,"i");
			HX_STACK_LINE(100)
			if (((i == (int)-1))){
				HX_STACK_LINE(101)
...
::String BaseCode_obj::decodeString( ::String s){
	HX_STACK_FRAME("haxe.crypto.BaseCode","decodeString",0x5b4e456a,"haxe.crypto.BaseCode.decodeString","C:\\HaxeToolkit\\haxe\\std/haxe/crypto/BaseCode.hx",123,0x52da3542)
	HX_STACK_THIS(this)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(123)
...
::String BaseCode_obj::decode( ::String s,::String base){
	...
	HX_STACK_ARG(base,"base")
	HX_STACK_LINE(133)
	::haxe::crypto::BaseCode b = ::haxe::crypto::BaseCode_obj::__new(::haxe::io::Bytes_obj::ofString(base));		HX_STACK_VAR(b,"b");
	HX_STACK_LINE(134)
