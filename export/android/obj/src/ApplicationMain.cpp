...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(22)
		::openfl::_v2::Lib_obj::setPackage(HX_CSTRING("HaxeFlixel"),HX_CSTRING("snowflake-drift"),HX_CSTRING("com.example.myapp"),HX_CSTRING("0.0.1"));
		HX_STACK_LINE(101)
		int _g = ::openfl::_v2::Lib_obj::ALLOW_SHADERS;		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(102)
		int _g1 = ::openfl::_v2::Lib_obj::REQUIRE_SHADERS;		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(103)
		int _g2 = (int)0;		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(104)
		int _g3 = (int)0;		HX_STACK_VAR(_g3,"_g3");
		HX_STACK_LINE(105)
		int _g4 = ::openfl::_v2::Lib_obj::RESIZABLE;		HX_STACK_VAR(_g4,"_g4");
		HX_STACK_LINE(106)
		int _g5 = (int)0;		HX_STACK_VAR(_g5,"_g5");
		HX_STACK_LINE(107)
		int _g6 = ::openfl::_v2::Lib_obj::VSYNC;		HX_STACK_VAR(_g6,"_g6");
		HX_STACK_LINE(108)
		int _g7 = ::openfl::_v2::Lib_obj::FULLSCREEN;		HX_STACK_VAR(_g7,"_g7");
		HX_STACK_LINE(109)
		...
		Void run(){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","ApplicationMain.hx",36,0x0780ded5)
			{
				HX_STACK_LINE(38)
				...
				HX_STACK_LINE(40)
				::openfl::_v2::display::MovieClip _g10 = ::openfl::_v2::Lib_obj::get_current();		HX_STACK_VAR(_g10,"_g10");
				HX_STACK_LINE(40)
				_g10->loaderInfo = ::openfl::_v2::display::LoaderInfo_obj::create(null());
				HX_STACK_LINE(65)
		...
		HX_STACK_LINE(36)
		::openfl::_v2::Lib_obj::create( Dynamic(new _Function_1_1()),(int)0,(int)0,(int)60,(int)14024694,(int((int((int((int((int((int((int((int((int((int(::openfl::_v2::Lib_obj::HARDWARE) | int(_g))) | int(_g1))) | int(_g2))) | int(_g3))) | int(_g4))) | int(_g5))) | int(_g6))) | int(_g7))) | int(_g8))) | int(_g9)),HX_CSTRING("snowflake-drift"),null(),null());
	}
return null();
}
