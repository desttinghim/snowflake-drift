...
Void ArgumentError_obj::__construct(::String __o_inMessage)
{
HX_STACK_FRAME("openfl.errors.ArgumentError","new",0x72c6c578,"openfl.errors.ArgumentError.new","openfl/errors/ArgumentError.hx",9,0xb16d4318)

HX_STACK_ARG(__o_inMessage,"inMessage")
::String inMessage = __o_inMessage.Default(HX_CSTRING(""));
{
	HX_STACK_LINE(9)
	super::__construct(inMessage,null());
}
;
	return null();
}
...
hx::ObjectPtr< ArgumentError_obj > ArgumentError_obj::__new(::String __o_inMessage)
