...
HX_STACK_ARG(soundTransform,"soundTransform")
{
	...
	if (((handle != null()))){
		HX_STACK_LINE(67)
		this->__handle = ::openfl::_v2::media::SoundChannel_obj::lime_sound_channel_create(handle,startTime,loops,this->__transform);
	}
	HX_STACK_LINE(71)
...
bool SoundChannel_obj::__checkComplete( ){
	...
	if (((this->__handle != null()))){
		...
		if (((  (((this->__dataProvider != null()))) ? bool(::openfl::_v2::media::SoundChannel_obj::lime_sound_channel_needs_data(this->__handle)) : bool(false) ))){
			...
			HX_STACK_LINE(122)
			request->position = ::openfl::_v2::media::SoundChannel_obj::lime_sound_channel_get_data_position(this->__handle);
			HX_STACK_LINE(123)
		...
		if (((bool(this->__addedToThread) || bool((bool((this->__soundInstance != null())) && bool((this->__soundInstance->__audioType == ::openfl::_v2::media::InternalAudioType_obj::MUSIC))))))){
			...
			if (((::openfl::_v2::media::SoundChannel_obj::__audioState == null()))){
				HX_STACK_LINE(139)
				::openfl::_v2::media::SoundChannel_obj::__audioState = ::openfl::_v2::media::AudioThreadState_obj::__new();
				HX_STACK_LINE(141)
				::openfl::_v2::media::SoundChannel_obj::__audioThreadRunning = true;
				HX_STACK_LINE(142)
				::openfl::_v2::media::SoundChannel_obj::__audioThreadIsIdle = false;
				HX_STACK_LINE(144)
				::openfl::_v2::media::SoundChannel_obj::__audioState->mainThread = ::cpp::vm::Thread_obj::current();
				HX_STACK_LINE(145)
				::openfl::_v2::media::SoundChannel_obj::__audioState->audioThread = ::cpp::vm::Thread_obj::create(::openfl::_v2::media::SoundChannel_obj::__checkCompleteBackgroundThread_dyn());
			}
			HX_STACK_LINE(149)
...
Float SoundChannel_obj::set_position( Float value){
	...
	HX_STACK_LINE(266)
	return ::openfl::_v2::media::SoundChannel_obj::lime_sound_channel_set_position(this->__handle,this->get_position());
}
...
::openfl::media::SoundTransform SoundChannel_obj::get_soundTransform( ){
	...
	if (((this->__transform == null()))){
		HX_STACK_LINE(273)
		this->__transform = ::openfl::media::SoundTransform_obj::__new(null(),null());
	}
	HX_STACK_LINE(277)
...
{
		HX_STACK_FRAME("openfl._v2.media.SoundChannel","__checkCompleteBackgroundThread",0x63d86fba,"openfl._v2.media.SoundChannel.__checkCompleteBackgroundThread","openfl/_v2/media/SoundChannel.hx",181,0xb300254c)
		HX_STACK_LINE(183)
		while((::openfl::_v2::media::SoundChannel_obj::__audioThreadRunning)){
			HX_STACK_LINE(185)
