	...
	HX_STACK_ARG(forcePlayAsMusic,"forcePlayAsMusic")
{
		...
		this->bytesTotal = (int)0;
		HX_STACK_LINE(95)
		this->__handle = ::openfl::_v2::media::Sound_obj::lime_sound_from_file(stream->url,forcePlayAsMusic);
		HX_STACK_LINE(97)
		if (((this->__handle == null()))){
			HX_STACK_LINE(99)
	...
	HX_STACK_ARG(forcePlayAsMusic,"forcePlayAsMusic")
{
		...
		HX_STACK_LINE(119)
		this->__handle = ::openfl::_v2::media::Sound_obj::lime_sound_from_data(bytes,length,forcePlayAsMusic);
		HX_STACK_LINE(121)
		if (((this->__handle == null()))){
			HX_STACK_LINE(123)
	...
	HX_STACK_ARG(soundTransform,"soundTransform")
{
		...
		if ((this->__dynamicSound)){
			...
			if (((request->data->length > (int)0))){
				HX_STACK_LINE(189)
				this->__handle = ::openfl::_v2::media::Sound_obj::lime_sound_channel_create_dynamic(request->data,soundTransform);
			}
			HX_STACK_LINE(193)
			if (((this->__handle == null()))){
				HX_STACK_LINE(195)
