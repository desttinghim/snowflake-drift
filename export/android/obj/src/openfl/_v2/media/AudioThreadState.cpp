...
{
HX_STACK_FRAME("openfl._v2.media.AudioThreadState","new",0x9b026c9e,"openfl._v2.media.AudioThreadState.new","openfl/_v2/media/SoundChannel.hx",326,0xb300254c)
{
	HX_STACK_LINE(328)
...
{
		HX_STACK_FRAME("openfl._v2.media.AudioThreadState","add",0x9af88e5f,"openfl._v2.media.AudioThreadState.add","openfl/_v2/media/SoundChannel.hx",336,0xb300254c)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl._v2.media.AudioThreadState","remove",0x10debac6,"openfl._v2.media.AudioThreadState.remove","openfl/_v2/media/SoundChannel.hx",346,0xb300254c)
		HX_STACK_THIS(this)
		HX_STACK_ARG(channel,"channel")
		HX_STACK_LINE(348)
		this->mutex->acquire();
...
{
		HX_STACK_FRAME("openfl._v2.media.AudioThreadState","updateComplete",0x702d6464,"openfl._v2.media.AudioThreadState.updateComplete","openfl/_v2/media/SoundChannel.hx",375,0xb300254c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(377)
		this->mutex->acquire();
		HX_STACK_LINE(379)
