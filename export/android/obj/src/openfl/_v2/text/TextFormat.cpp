...
{
HX_STACK_FRAME("openfl._v2.text.TextFormat","new",0xb3e0e3c6,"openfl._v2.text.TextFormat.new","openfl/_v2/text/TextFormat.hx",28,0x68e066cb)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.text.TextFormat"), hx::TCanCast< TextFormat_obj> ,sStaticFields,sMemberFields,
