...
{
	HX_STACK_LINE(50)
	super::__construct(::openfl::_v2::text::TextField_obj::lime_text_field_create(),HX_CSTRING("TextField"));
	HX_STACK_LINE(52)
...
{
		HX_STACK_FRAME("openfl._v2.text.TextField","appendText",0xb44866b8,"openfl._v2.text.TextField.appendText","openfl/_v2/text/TextField.hx",61,0xa8dfafe0)
		HX_STACK_THIS(this)
		HX_STACK_ARG(text,"text")
		HX_STACK_LINE(61)
		::openfl::_v2::text::TextField_obj::lime_text_field_set_text(this->__handle,(::openfl::_v2::text::TextField_obj::lime_text_field_get_text(this->__handle) + text));
	}
return null();
}
...
::openfl::text::TextFieldAutoSize TextField_obj::get_autoSize( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(151)
	return ::Type_obj::createEnumIndex(hx::ClassOf< ::openfl::text::TextFieldAutoSize >(),::openfl::_v2::text::TextField_obj::lime_text_field_get_auto_size(this->__handle),null());
}
...
::openfl::text::TextFieldAutoSize TextField_obj::set_autoSize( ::openfl::text::TextFieldAutoSize value){
	...
	HX_STACK_LINE(152)
	::openfl::_v2::text::TextField_obj::lime_text_field_set_auto_size(this->__handle,value->__Index());
	HX_STACK_LINE(152)
	return value;
}
...
::String TextField_obj::get_htmlText( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(210)
	return ::StringTools_obj::replace(::openfl::_v2::text::TextField_obj::lime_text_field_get_html_text(this->__handle),HX_CSTRING("\n"),HX_CSTRING("<br/>"));
}
