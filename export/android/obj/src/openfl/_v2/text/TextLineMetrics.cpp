...
{
HX_STACK_FRAME("openfl._v2.text.TextLineMetrics","new",0x709c27e4,"openfl._v2.text.TextLineMetrics.new","openfl/_v2/text/TextLineMetrics.hx",15,0x0b1f300b)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.text.TextLineMetrics"), hx::TCanCast< TextLineMetrics_obj> ,sStaticFields,sMemberFields,
