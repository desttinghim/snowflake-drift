...
::String filename = __o_filename.Default(HX_CSTRING(""));
{
	...
	if (((filename == HX_CSTRING("")))){
		...
		if ((::Reflect_obj::hasField(fontClass,HX_CSTRING("resourceName")))){
			HX_STACK_LINE(32)
			this->__fromBytes(::openfl::_v2::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::Reflect_obj::field(fontClass,HX_CSTRING("resourceName")))));
		}
		else{
		}
	}
...
::String Font_obj::toString( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(133)
	::String _g = ((((HX_CSTRING("{ name=") + this->fontName) + HX_CSTRING(", style=")) + ::Std_obj::string(this->fontStyle)) + HX_CSTRING(", type="));		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(133)
	return ((_g + ::Std_obj::string(this->fontType)) + HX_CSTRING(" }"));
}
	...
	HX_STACK_ARG(enumerateDeviceFonts,"enumerateDeviceFonts")
{
		...
		if ((enumerateDeviceFonts)){
			...
			if (((::openfl::_v2::text::Font_obj::__deviceFonts == null()))){
				HX_STACK_LINE(63)
				::openfl::_v2::text::Font_obj::__deviceFonts = Array_obj< ::Dynamic >::__new();
				HX_STACK_LINE(64)
			...
			HX_STACK_LINE(69)
			result = result->concat(::openfl::_v2::text::Font_obj::__deviceFonts);
		}
		HX_STACK_LINE(73)
		return result;
	}
...
Void Font_obj::registerFont( ::Class font){
{
		...
		if (((instance != null()))){
			...
			if ((::Reflect_obj::hasField(font,HX_CSTRING("resourceName")))){
				HX_STACK_LINE(120)
				::openfl::_v2::text::Font_obj::lime_font_register_font(instance->fontName,::openfl::_v2::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::Reflect_obj::field(font,HX_CSTRING("resourceName")))));
			}
			HX_STACK_LINE(124)
