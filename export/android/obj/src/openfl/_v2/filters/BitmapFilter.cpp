...
{
HX_STACK_FRAME("openfl._v2.filters.BitmapFilter","new",0x8aeb4cfd,"openfl._v2.filters.BitmapFilter.new","openfl/_v2/filters/BitmapFilter.hx",12,0xe57c05f0)
...
::openfl::_v2::filters::BitmapFilter BitmapFilter_obj::clone( ){
	HX_STACK_FRAME("openfl._v2.filters.BitmapFilter","clone",0x4548b13a,"openfl._v2.filters.BitmapFilter.clone","openfl/_v2/filters/BitmapFilter.hx",19,0xe57c05f0)
	HX_STACK_THIS(this)
	HX_STACK_LINE(19)
	return ::openfl::_v2::filters::BitmapFilter_obj::__new(this->type);
}
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.filters.BitmapFilter"), hx::TCanCast< BitmapFilter_obj> ,sStaticFields,sMemberFields,
