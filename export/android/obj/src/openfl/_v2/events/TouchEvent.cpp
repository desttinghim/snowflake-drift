...
{
HX_STACK_FRAME("openfl._v2.events.TouchEvent","new",0x13ae6031,"openfl._v2.events.TouchEvent.new","openfl/_v2/events/TouchEvent.hx",27,0xeb186540)
...
::openfl::_v2::events::MouseEvent TouchEvent_obj::__createSimilar( ::String type,::openfl::_v2::display::InteractiveObject related,::openfl::_v2::display::InteractiveObject target){
	HX_STACK_FRAME("openfl._v2.events.TouchEvent","__createSimilar",0x4c94bcc0,"openfl._v2.events.TouchEvent.__createSimilar","openfl/_v2/events/TouchEvent.hx",52,0xeb186540)
	HX_STACK_THIS(this)
	HX_STACK_ARG(type,"type")
	...
	HX_STACK_LINE(54)
	::openfl::_v2::events::TouchEvent touchEvent = ::openfl::_v2::events::TouchEvent_obj::__new(type,_g,_g1,this->localX,this->localY,this->sizeX,this->sizeY,(  (((related == null()))) ? ::openfl::_v2::display::InteractiveObject(this->relatedObject) : ::openfl::_v2::display::InteractiveObject(related) ),this->ctrlKey,this->altKey,this->shiftKey,this->buttonDown,this->delta,this->commandKey,this->clickCount);		HX_STACK_VAR(touchEvent,"touchEvent");
	HX_STACK_LINE(56)
...
::openfl::_v2::events::TouchEvent TouchEvent_obj::__create( ::String type,Dynamic event,::openfl::_v2::geom::Point local,::openfl::_v2::display::InteractiveObject target,Float sizeX,Float sizeY){
	HX_STACK_FRAME("openfl._v2.events.TouchEvent","__create",0x43d44cab,"openfl._v2.events.TouchEvent.__create","openfl/_v2/events/TouchEvent.hx",40,0xeb186540)
	HX_STACK_ARG(type,"type")
	...
	HX_STACK_LINE(43)
	::openfl::_v2::events::TouchEvent touchEvent = ::openfl::_v2::events::TouchEvent_obj::__new(type,true,false,local->x,local->y,sizeX,sizeY,null(),(((int(flags) & int(::openfl::_v2::events::MouseEvent_obj::efCtrlDown))) != (int)0),(((int(flags) & int(::openfl::_v2::events::MouseEvent_obj::efAltDown))) != (int)0),(((int(flags) & int(::openfl::_v2::events::MouseEvent_obj::efShiftDown))) != (int)0),(((int(flags) & int(::openfl::_v2::events::MouseEvent_obj::efLeftDown))) != (int)0),(int)0,null(),(int)0);		HX_STACK_VAR(touchEvent,"touchEvent");
	HX_STACK_LINE(44)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.events.TouchEvent"), hx::TCanCast< TouchEvent_obj> ,sStaticFields,sMemberFields,
