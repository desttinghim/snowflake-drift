...
HX_STACK_ARG(priority,"priority")
{
	...
	HX_STACK_LINE(263)
	this->id = (::openfl::_v2::events::Listener_obj::__id)++;
}
;
	return null();
}
...
bool Listener_obj::is( Dynamic listener,bool useCapture){
	HX_STACK_FRAME("openfl._v2.events.Listener","is",0x656e2340,"openfl._v2.events.Listener.is","openfl/_v2/events/EventDispatcher.hx",277,0x3e68c260)
	HX_STACK_THIS(this)
	HX_STACK_ARG(listener,"listener")
	HX_STACK_ARG(useCapture,"useCapture")
	HX_STACK_LINE(277)
	if ((::Reflect_obj::compareMethods(this->listener->get(),listener))){
		HX_STACK_LINE(277)
