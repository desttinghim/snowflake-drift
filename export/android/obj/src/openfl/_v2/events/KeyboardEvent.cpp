...
{
HX_STACK_FRAME("openfl._v2.events.KeyboardEvent","new",0x121b1101,"openfl._v2.events.KeyboardEvent.new","openfl/_v2/events/KeyboardEvent.hx",19,0x9d43574e)
...
::openfl::_v2::events::Event KeyboardEvent_obj::clone( ){
	HX_STACK_FRAME("openfl._v2.events.KeyboardEvent","clone",0xcaf47e3e,"openfl._v2.events.KeyboardEvent.clone","openfl/_v2/events/KeyboardEvent.hx",36,0x9d43574e)
	HX_STACK_THIS(this)
	HX_STACK_LINE(38)
	...
	HX_STACK_LINE(38)
	return ::openfl::_v2::events::KeyboardEvent_obj::__new(_g,_g1,this->get_cancelable(),this->charCode,this->keyCode,this->keyLocation,this->ctrlKey,this->altKey,this->shiftKey,this->controlKey,this->commandKey);
}


::String KeyboardEvent_obj::toString( ){
	HX_STACK_FRAME("openfl._v2.events.KeyboardEvent","toString",0x8bd4a86b,"openfl._v2.events.KeyboardEvent.toString","openfl/_v2/events/KeyboardEvent.hx",43,0x9d43574e)
	HX_STACK_THIS(this)
	HX_STACK_LINE(45)
	::String _g = ((HX_CSTRING("[KeyboardEvent type=") + this->get_type()) + HX_CSTRING(" bubbles="));		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(45)
	::String _g1 = ((_g + ::Std_obj::string(this->get_bubbles())) + HX_CSTRING(" cancelable="));		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(45)
	::String _g2 = ((((((((_g1 + ::Std_obj::string(this->get_cancelable())) + HX_CSTRING(" charCode=")) + this->charCode) + HX_CSTRING(" keyCode=")) + this->keyCode) + HX_CSTRING(" keyLocation=")) + this->keyLocation) + HX_CSTRING(" ctrlKey="));		HX_STACK_VAR(_g2,"_g2");
	HX_STACK_LINE(45)
	::String _g3 = ((_g2 + ::Std_obj::string(this->ctrlKey)) + HX_CSTRING(" altKey="));		HX_STACK_VAR(_g3,"_g3");
	HX_STACK_LINE(45)
	::String _g4 = ((_g3 + ::Std_obj::string(this->altKey)) + HX_CSTRING(" shiftKey="));		HX_STACK_VAR(_g4,"_g4");
	HX_STACK_LINE(45)
	return ((_g4 + ::Std_obj::string(this->shiftKey)) + HX_CSTRING("]"));
}
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.events.KeyboardEvent"), hx::TCanCast< KeyboardEvent_obj> ,sStaticFields,sMemberFields,
