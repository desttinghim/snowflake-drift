...
{
HX_STACK_FRAME("openfl._v2.events.SystemEvent","new",0x39710eb9,"openfl._v2.events.SystemEvent.new","openfl/_v2/events/SystemEvent.hx",15,0x71f73ad6)
...
::openfl::_v2::events::Event SystemEvent_obj::clone( ){
	HX_STACK_FRAME("openfl._v2.events.SystemEvent","clone",0xf20f59f6,"openfl._v2.events.SystemEvent.clone","openfl/_v2/events/SystemEvent.hx",23,0x71f73ad6)
	HX_STACK_THIS(this)
	HX_STACK_LINE(25)
	...
	HX_STACK_LINE(25)
	return ::openfl::_v2::events::SystemEvent_obj::__new(_g,_g1,this->get_cancelable(),this->data);
}


::String SystemEvent_obj::toString( ){
	HX_STACK_FRAME("openfl._v2.events.SystemEvent","toString",0x8c53efb3,"openfl._v2.events.SystemEvent.toString","openfl/_v2/events/SystemEvent.hx",30,0x71f73ad6)
	HX_STACK_THIS(this)
	HX_STACK_LINE(32)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.events.SystemEvent"), hx::TCanCast< SystemEvent_obj> ,sStaticFields,sMemberFields,
