...
::openfl::_v2::events::Event Event_obj::clone( ){
	...
	HX_STACK_LINE(70)
	return ::openfl::_v2::events::Event_obj::__new(_g,_g1,this->get_cancelable());
}
...
::String Event_obj::toString( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(107)
	::String _g = ((HX_CSTRING("[Event type=") + this->get_type()) + HX_CSTRING(" bubbles="));		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(107)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.events.Event"), hx::TCanCast< Event_obj> ,sStaticFields,sMemberFields,
