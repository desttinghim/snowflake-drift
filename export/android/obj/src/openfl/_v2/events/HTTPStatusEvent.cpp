...
{
HX_STACK_FRAME("openfl._v2.events.HTTPStatusEvent","new",0x5234818e,"openfl._v2.events.HTTPStatusEvent.new","openfl/_v2/events/HTTPStatusEvent.hx",14,0xf9442521)
...
::openfl::_v2::events::Event HTTPStatusEvent_obj::clone( ){
	HX_STACK_FRAME("openfl._v2.events.HTTPStatusEvent","clone",0x58b4ec0b,"openfl._v2.events.HTTPStatusEvent.clone","openfl/_v2/events/HTTPStatusEvent.hx",23,0xf9442521)
	HX_STACK_THIS(this)
	HX_STACK_LINE(25)
	...
	HX_STACK_LINE(25)
	return ::openfl::_v2::events::HTTPStatusEvent_obj::__new(_g,_g1,this->get_cancelable(),this->status);
}


::String HTTPStatusEvent_obj::toString( ){
	HX_STACK_FRAME("openfl._v2.events.HTTPStatusEvent","toString",0xa9d718be,"openfl._v2.events.HTTPStatusEvent.toString","openfl/_v2/events/HTTPStatusEvent.hx",30,0xf9442521)
	HX_STACK_THIS(this)
	HX_STACK_LINE(32)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.events.HTTPStatusEvent"), hx::TCanCast< HTTPStatusEvent_obj> ,sStaticFields,sMemberFields,
