	...
	HX_STACK_ARG(useWeakReference,"useWeakReference")
{
		...
		HX_STACK_LINE(50)
		list->push(::openfl::_v2::events::Listener_obj::__new(::openfl::_v2::utils::WeakRef_obj::__new(listener,useWeakReference),useCapture,priority));
		HX_STACK_LINE(51)
...
bool EventDispatcher_obj::dispatchEvent( ::openfl::_v2::events::Event event){
	...
	HX_STACK_LINE(77)
	bool capture = (event->get_eventPhase() == ::openfl::events::EventPhase_obj::CAPTURING_PHASE);		HX_STACK_VAR(capture,"capture");
	HX_STACK_LINE(79)
	if (((list != null()))){
		HX_STACK_LINE(81)
		...
		while(((index < length))){
			...
			HX_STACK_LINE(89)
			if (((  (((listItem != null()))) ? bool((listItem->listener->get() != null())) : bool(false) ))){
				HX_STACK_LINE(89)
				listener = listItem;
			}
			else{
...
::String EventDispatcher_obj::toString( ){
	HX_STACK_FRAME("openfl._v2.events.EventDispatcher","toString",0x4797af3d,"openfl._v2.events.EventDispatcher.toString","openfl/_v2/events/EventDispatcher.hx",182,0x3e68c260)
	HX_STACK_THIS(this)
	HX_STACK_LINE(182)
...
{
		HX_STACK_FRAME("openfl._v2.events.EventDispatcher","__dispatchCompleteEvent",0x9e9092f6,"openfl._v2.events.EventDispatcher.__dispatchCompleteEvent","openfl/_v2/events/EventDispatcher.hx",202,0x3e68c260)
		HX_STACK_THIS(this)
		HX_STACK_LINE(202)
		this->dispatchEvent(::openfl::_v2::events::Event_obj::__new(::openfl::_v2::events::Event_obj::COMPLETE,null(),null()));
	}
return null();
}
...
{
		HX_STACK_FRAME("openfl._v2.events.EventDispatcher","__dispatchIOErrorEvent",0x434e91e3,"openfl._v2.events.EventDispatcher.__dispatchIOErrorEvent","openfl/_v2/events/EventDispatcher.hx",209,0x3e68c260)
		HX_STACK_THIS(this)
		HX_STACK_LINE(209)
		this->dispatchEvent(::openfl::events::IOErrorEvent_obj::__new(::openfl::events::IOErrorEvent_obj::IO_ERROR,null(),null(),null(),null()));
	}
return null();
}
