	...
	HX_STACK_ARG(args,"args")
{
		...
		if (((::openfl::_v2::Lib_obj::__moduleNames == null()))){
			HX_STACK_LINE(187)
			::openfl::_v2::Lib_obj::__moduleNames = ::haxe::ds::StringMap_obj::__new();
		}
		HX_STACK_LINE(188)
		if ((::openfl::_v2::Lib_obj::__moduleNames->exists(library))){
			HX_STACK_LINE(191)
			return ::cpp::Lib_obj::load(::openfl::_v2::Lib_obj::__moduleNames->get(library),method,args);
		}
		HX_STACK_LINE(208)
		...
		if (((result == null()))){
			HX_STACK_LINE(214)
			result = ::openfl::_v2::Lib_obj::tryLoad((HX_CSTRING(".\\") + library),library,method,args);
		}
		HX_STACK_LINE(218)
		if (((result == null()))){
			HX_STACK_LINE(220)
			result = ::openfl::_v2::Lib_obj::tryLoad(library,library,method,args);
		}
		HX_STACK_LINE(224)
		if (((result == null()))){
			HX_STACK_LINE(226)
			...
			HX_STACK_LINE(226)
			if (((::openfl::_v2::Lib_obj::sysName().substr((int)7,null()).toLowerCase() == HX_CSTRING("windows")))){
				HX_STACK_LINE(226)
				slash = HX_CSTRING("\\");
			}
			else{
			...
			if (((haxelib != HX_CSTRING("")))){
				HX_STACK_LINE(231)
				result = ::openfl::_v2::Lib_obj::tryLoad(((((((haxelib + slash) + HX_CSTRING("ndll")) + slash) + ::openfl::_v2::Lib_obj::sysName()) + slash) + library),library,method,args);
				HX_STACK_LINE(233)
				if (((result == null()))){
					HX_STACK_LINE(235)
					result = ::openfl::_v2::Lib_obj::tryLoad((((((((haxelib + slash) + HX_CSTRING("ndll")) + slash) + ::openfl::_v2::Lib_obj::sysName()) + HX_CSTRING("64")) + slash) + library),library,method,args);
				}
			}
		}
		HX_STACK_LINE(243)
		::openfl::_v2::Lib_obj::loaderTrace((HX_CSTRING("Result : ") + ::Std_obj::string(result)));
		HX_STACK_LINE(253)
		return result;
	}
}
...
int Lib_obj::getTimer( ){
	HX_STACK_FRAME("openfl._v2.Lib","getTimer",0xd69c2b89,"openfl._v2.Lib.getTimer","openfl/_v2/Lib.hx",444,0x092451cc)
	HX_STACK_LINE(444)
...
{
		HX_STACK_FRAME("openfl._v2.Lib","postUICallback",0x0eb41453,"openfl._v2.Lib.postUICallback","openfl/_v2/Lib.hx",466,0x092451cc)
...
::openfl::_v2::display::MovieClip Lib_obj::get_current( ){
	...
	if (((::openfl::_v2::Lib_obj::__current == null()))){
		HX_STACK_LINE(526)
		::openfl::_v2::Lib_obj::__current = ::openfl::_v2::display::MovieClip_obj::__new();
		HX_STACK_LINE(528)
...
void Lib_obj::__boot()
{
	...
	lime_post_ui_callback= ::openfl::_v2::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_post_ui_callback"),(int)1);
