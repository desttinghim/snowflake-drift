...
{
HX_STACK_FRAME("openfl._v2.system.ScreenMode","new",0xeca4282f,"openfl._v2.system.ScreenMode.new","openfl/_v2/system/ScreenMode.hx",9,0x5b6c2702)
{
	HX_STACK_LINE(10)
	this->width = (int)-1;
	HX_STACK_LINE(11)
...
Dynamic ScreenMode_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 5:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"format") ) { format=inValue.Cast< ::openfl::_v2::system::PixelFormat >(); return inValue; }
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::_v2::system::PixelFormat*/ ,(int)offsetof(ScreenMode_obj,format),HX_CSTRING("format")},
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.system.ScreenMode"), hx::TCanCast< ScreenMode_obj> ,sStaticFields,sMemberFields,
