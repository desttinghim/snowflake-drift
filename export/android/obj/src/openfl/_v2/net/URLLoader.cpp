		...
		HX_STACK_LINE(69)
		{
			...
			while(((_g < headers->length))){
				...
				if (((index > (int)0))){
					...
					HX_STACK_LINE(74)
					event->responseHeaders->push(::openfl::net::URLRequestHeader_obj::__new(_g1,header.substr((index + (int)2),((header.length - index) - (int)4))));
				}
			}
		}
		HX_STACK_LINE(80)
...
Void URLLoader_obj::load( ::openfl::_v2::net::URLRequest request){
{
		...
		if (((bool((pref != HX_CSTRING("http://"))) && bool((pref != HX_CSTRING("https:/")))))){
			...
			HX_STACK_CATCHABLE(Dynamic, 0);
			{
				...
				HX_STACK_LINE(123)
				{
					...
					switch( (int)(_g->__Index())){
						...
						case (int)2: {
							HX_STACK_LINE(126)
							this->data = ::openfl::net::URLVariables_obj::__new(bytes->asString());
						}
						;break;
						default: {
							HX_STACK_LINE(127)
			...
			request->__prepare();
			HX_STACK_LINE(143)
			this->__handle = ::openfl::_v2::net::URLLoader_obj::lime_curl_create(request);
			HX_STACK_LINE(145)
...
Void URLLoader_obj::onError( ::String msg){
{
		...
		HX_STACK_LINE(163)
		this->dispatchEvent(::openfl::events::IOErrorEvent_obj::__new(::openfl::events::IOErrorEvent_obj::IO_ERROR,true,false,msg,null()));
	}
return null();
}
...
Void URLLoader_obj::update( ){
{
		...
		if (((this->__handle != null()))){
			...
			if (((bool((old_total < (int)0)) && bool((this->bytesTotal > (int)0))))){
				HX_STACK_LINE(178)
				this->dispatchEvent(::openfl::_v2::events::Event_obj::__new(::openfl::_v2::events::Event_obj::OPEN,null(),null()));
			}
			HX_STACK_LINE(182)
			if (((bool((this->bytesTotal > (int)0)) && bool((this->bytesLoaded != old_loaded))))){
				HX_STACK_LINE(184)
				this->dispatchEvent(::openfl::events::ProgressEvent_obj::__new(::openfl::events::ProgressEvent_obj::PROGRESS,false,false,this->bytesLoaded,this->bytesTotal));
			}
			HX_STACK_LINE(188)
			...
			if (((this->state == (int)3))){
				...
				if (((this->state == (int)4))){
					...
					this->dispatchHTTPStatus(code);
					HX_STACK_LINE(221)
					::openfl::events::IOErrorEvent event = ::openfl::events::IOErrorEvent_obj::__new(::openfl::events::IOErrorEvent_obj::IO_ERROR,true,false,::openfl::_v2::net::URLLoader_obj::lime_curl_get_error_message(this->__handle),code);		HX_STACK_VAR(event,"event");
					HX_STACK_LINE(222)
					this->__handle = null();
					HX_STACK_LINE(223)
					this->dispatchEvent(event);
...
Void URLLoader_obj::__pollData( ){
{
		...
		if ((!(::openfl::_v2::net::URLLoader_obj::activeLoaders->isEmpty()))){
			...
			HX_STACK_LINE(270)
			::openfl::_v2::net::URLLoader_obj::activeLoaders = ::List_obj::__new();
			HX_STACK_LINE(272)
