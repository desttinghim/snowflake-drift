...
::Class SharedObject_obj::resolveClass( ::String name){
	...
	if (((name != null()))){
		...
		if ((::StringTools_obj::startsWith(name,HX_CSTRING("neash.")))){
			HX_STACK_LINE(218)
			name = ::StringTools_obj::replace(name,HX_CSTRING("neash."),HX_CSTRING("openfl."));
		}
		HX_STACK_LINE(222)
		if ((::StringTools_obj::startsWith(name,HX_CSTRING("native.")))){
			HX_STACK_LINE(224)
			name = ::StringTools_obj::replace(name,HX_CSTRING("native."),HX_CSTRING("openfl."));
		}
		HX_STACK_LINE(228)
		if ((::StringTools_obj::startsWith(name,HX_CSTRING("flash.")))){
			HX_STACK_LINE(230)
			name = ::StringTools_obj::replace(name,HX_CSTRING("flash."),HX_CSTRING("openfl."));
		}
		HX_STACK_LINE(234)
