...
{
HX_STACK_FRAME("openfl._v2.net.URLRequest","new",0xf6b27234,"openfl._v2.net.URLRequest.new","openfl/_v2/net/URLRequest.hx",34,0xc5875c59)
...
{
		HX_STACK_FRAME("openfl._v2.net.URLRequest","basicAuth",0xc273de0a,"openfl._v2.net.URLRequest.basicAuth","openfl/_v2/net/URLRequest.hx",55,0xc5875c59)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl._v2.net.URLRequest","digestAuth",0xc7227e78,"openfl._v2.net.URLRequest.digestAuth","openfl/_v2/net/URLRequest.hx",63,0xc5875c59)
		HX_STACK_THIS(this)
		HX_STACK_ARG(user,"user")
		HX_STACK_ARG(password,"password")
		HX_STACK_LINE(65)
...
{
		HX_STACK_FRAME("openfl._v2.net.URLRequest","__prepare",0x397f9b3b,"openfl._v2.net.URLRequest.__prepare","openfl/_v2/net/URLRequest.hx",71,0xc5875c59)
		HX_STACK_THIS(this)
		HX_STACK_LINE(73)
		...
		if (((this->data == null()))){
			HX_STACK_LINE(81)
			this->__bytes = ::openfl::_v2::utils::ByteArray_obj::__new(null());
		}
		else{
			HX_STACK_LINE(83)
			if ((::Std_obj::is(this->data,hx::ClassOf< ::openfl::_v2::utils::ByteArray >()))){
				HX_STACK_LINE(85)
...
Dynamic URLRequest_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 7:
		...
		if (HX_FIELD_EQ(inName,"__bytes") ) { __bytes=inValue.Cast< ::openfl::_v2::utils::ByteArray >(); return inValue; }
		break;
	case 8:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::_v2::utils::ByteArray*/ ,(int)offsetof(URLRequest_obj,__bytes),HX_CSTRING("__bytes")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.net.URLRequest"), hx::TCanCast< URLRequest_obj> ,sStaticFields,sMemberFields,
