...
Void Assets_obj::initialize( ){
{
		...
		if ((!(::openfl::_v2::Assets_obj::initialized))){
			HX_STACK_LINE(580)
			::openfl::_v2::Assets_obj::registerLibrary(HX_CSTRING("default"),::DefaultAssetLibrary_obj::__new());
			HX_STACK_LINE(584)
	...
	HX_STACK_ARG(useCache,"useCache")
{
		...
		if (((  (((  ((useCache)) ? bool(::openfl::_v2::Assets_obj::cache->__Field(HX_CSTRING("get_enabled"),true)()) : bool(false) ))) ? bool(::openfl::_v2::Assets_obj::cache->hasFont(id1->__get((int)0))) : bool(false) ))){
			HX_STACK_LINE(812)
			handler1->__GetItem((int)0)(::openfl::_v2::Assets_obj::cache->getFont(id1->__get((int)0))).Cast< Void >();
			HX_STACK_LINE(813)
			return null();
		}
		HX_STACK_LINE(817)
...
Void Assets_obj::loadLibrary( ::String name,Dynamic handler){
{
		...
		if (((bool((data != null())) && bool((data != HX_CSTRING("")))))){
			...
			HX_STACK_LINE(872)
			::openfl::_v2::AssetLibrary library = ::Type_obj::createInstance(::Type_obj::resolveClass(info->__Field(HX_CSTRING("type"),true)),info->__Field(HX_CSTRING("args"),true));		HX_STACK_VAR(library,"library");
			HX_STACK_LINE(873)
...
Void Assets_obj::library_onEvent( ::openfl::_v2::AssetLibrary library,::String type){
{
		...
		if (((type == HX_CSTRING("change")))){
			...
			HX_STACK_LINE(1174)
			::openfl::_v2::Assets_obj::dispatchEvent(::openfl::_v2::events::Event_obj::__new(::openfl::_v2::events::Event_obj::CHANGE,null(),null()));
		}
	}
return null();
}
