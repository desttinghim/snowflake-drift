...
{
HX_STACK_FRAME("openfl._v2.display.Shape","new",0x13089bd6,"openfl._v2.display.Shape.new","openfl/_v2/display/Shape.hx",9,0x0df6d1dd)
{
	HX_STACK_LINE(9)
	super::__construct(::openfl::_v2::display::DisplayObject_obj::lime_create_display_object(),HX_CSTRING("Shape"));
}
;
	return null();
}
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.display.Shape"), hx::TCanCast< Shape_obj> ,sStaticFields,sMemberFields,
