...
HX_STACK_ARG(type,"type")
{
	...
	HX_STACK_LINE(64)
	this->__id = ::openfl::_v2::display::DisplayObject_obj::lime_display_object_get_id(this->__handle);
	HX_STACK_LINE(65)
...
bool DisplayObject_obj::hitTestObject( ::openfl::_v2::display::DisplayObject obj){
	...
	HX_STACK_LINE(117)
	if (((  (((  (((obj != null()))) ? bool((obj->get_parent() != null())) : bool(false) ))) ? bool((this->get_parent() != null())) : bool(false) ))){
		HX_STACK_LINE(119)
...
::openfl::_v2::display::DisplayObjectContainer DisplayObject_obj::__setParent( ::openfl::_v2::display::DisplayObjectContainer parent){
	...
	if (((this->__parent != null()))){
		...
		HX_STACK_LINE(417)
		this->__onRemoved(hx::ObjectPtr<OBJ_>(this),(this->get_stage() != null()));
	}
	HX_STACK_LINE(421)
...
::openfl::_v2::display::BlendMode DisplayObject_obj::set_blendMode( ::openfl::_v2::display::BlendMode value){
	...
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(492)
	::openfl::_v2::display::DisplayObject_obj::lime_display_object_set_blend_mode(this->__handle,value->__Index());
	HX_STACK_LINE(493)
	return value;
}
...
::openfl::display::PixelSnapping DisplayObject_obj::set_pixelSnapping( ::openfl::display::PixelSnapping value){
	...
	if (((value == null()))){
		...
		HX_STACK_LINE(532)
		::openfl::_v2::display::DisplayObject_obj::lime_display_object_set_pixel_snapping(this->__handle,value->__Index());
	}
	HX_STACK_LINE(536)
	return value;
}
...
::openfl::_v2::display::Graphics DisplayObject_obj::get_graphics( ){
	...
	if (((this->__graphicsCache == null()))){
		HX_STACK_LINE(589)
		this->__graphicsCache = ::openfl::_v2::display::Graphics_obj::__new(::openfl::_v2::display::DisplayObject_obj::lime_display_object_get_graphics(this->__handle));
	}
	HX_STACK_LINE(593)
