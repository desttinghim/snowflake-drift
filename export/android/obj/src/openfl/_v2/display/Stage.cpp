...
bool Stage_obj::__checkInOuts( ::openfl::_v2::events::MouseEvent event,Array< ::Dynamic > stack,::openfl::_v2::display::TouchInfo touchInfo){
	...
	if (((newObject != oldObject))){
		...
		HX_STACK_LINE(251)
		while(((bool((bool((common < newLength)) && bool((common < oldLength)))) && bool((stack->__get(common).StaticCast< ::openfl::_v2::display::InteractiveObject >() == prev->__get(common).StaticCast< ::openfl::_v2::display::InteractiveObject >()))))){
			HX_STACK_LINE(253)
			(common)++;
		}
		HX_STACK_LINE(257)
...
{
		HX_STACK_FRAME("openfl._v2.display.Stage","dummyTrace",0xf097e20a,"openfl._v2.display.Stage.dummyTrace","openfl/_v2/display/Stage.hx",338,0xd25d2a60)
		HX_STACK_THIS(this)
		HX_STACK_LINE(338)
		::haxe::Log_obj::trace(HX_CSTRING(""),hx::SourceInfo(HX_CSTRING("Stage.hx"),338,HX_CSTRING("openfl._v2.display.Stage"),HX_CSTRING("dummyTrace")));
	}
return null();
}
...
try {
{
		...
		HX_STACK_CATCHABLE(Dynamic, 0);
		{
			...
			switch( (int)(type)){
				...
				case (int)22: {
					HX_STACK_LINE(465)
					this->__dispatchEvent(::openfl::_v2::events::Event_obj::__new(::openfl::events::FocusEvent_obj::FOCUS_IN,null(),null()));
				}
				;break;
				case (int)23: {
					HX_STACK_LINE(469)
					this->__dispatchEvent(::openfl::_v2::events::Event_obj::__new(::openfl::events::FocusEvent_obj::FOCUS_OUT,null(),null()));
				}
				;break;
				case (int)24: {
					HX_STACK_LINE(473)
...
Float Stage_obj::__nextFrameDue( Float otherTimers){
	...
	if (((this->frameRate > (int)0))){
		HX_STACK_LINE(587)
		Float next = ((this->__nextRender - ::haxe::Timer_obj::stamp()) - ::openfl::_v2::display::Stage_obj::__earlyWakeup);		HX_STACK_VAR(next,"next");
		HX_STACK_LINE(588)
		if (((next < otherTimers))){
			HX_STACK_LINE(590)
			return next;
...
Void Stage_obj::__onChange( Dynamic event){
{
		...
		if (((object != null()))){
			HX_STACK_LINE(607)
			object->__fireEvent(::openfl::_v2::events::Event_obj::__new(::openfl::_v2::events::Event_obj::CHANGE,true,null()));
		}
	}
return null();
}
...
Void Stage_obj::__onFocus( Dynamic event){
{
		...
		if (((bool((stack->length > (int)0)) && bool(((bool((event->__Field(HX_CSTRING("value"),true) == (int)1)) || bool((event->__Field(HX_CSTRING("value"),true) == (int)2)))))))){
			...
			if (((event->__Field(HX_CSTRING("value"),true) == (int)1))){
				HX_STACK_LINE(628)
				_g = ::openfl::events::FocusEvent_obj::MOUSE_FOCUS_CHANGE;
			}
			else{
				HX_STACK_LINE(628)
				_g = ::openfl::events::FocusEvent_obj::KEY_FOCUS_CHANGE;
			}
			HX_STACK_LINE(628)
			::openfl::events::FocusEvent focusEvent = ::openfl::events::FocusEvent_obj::__new(_g,true,true,(  (((this->__focusOverObjects->length == (int)0))) ? ::openfl::_v2::display::InteractiveObject(null()) : ::openfl::_v2::display::InteractiveObject(this->__focusOverObjects->__get((int)0).StaticCast< ::openfl::_v2::display::InteractiveObject >()) ),(event->__Field(HX_CSTRING("flags"),true) > (int)0),event->__Field(HX_CSTRING("code"),true));		HX_STACK_VAR(focusEvent,"focusEvent");
			HX_STACK_LINE(629)
...
Void Stage_obj::__onJoystick( Dynamic event,::String type){
{
		...
		if (  ( _switch_1==HX_CSTRING("axisMove"))){
			...
			struct _Function_2_1{
				inline static bool Block( ::openfl::_v2::display::Stage_obj *__this,Dynamic &event){
			...
			if ((_Function_2_1::Block(this,event))){
				struct _Function_3_1{
					inline static Array< Float > Block( ::openfl::_v2::display::Stage_obj *__this,Dynamic &event){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/_v2/display/Stage.hx",671,0xd25d2a60)
						{
							HX_STACK_LINE(671)
							int key = event->__Field(HX_CSTRING("id"),true);		HX_STACK_VAR(key,"key");
				...
				HX_STACK_LINE(671)
				cachedAxisData = (_Function_3_1::Block(this,event))->toString();
			}
			HX_STACK_LINE(672)
			...
			if ((_Function_2_2::Block(this,event))){
				...
				HX_STACK_LINE(677)
				if ((((_Function_3_1::Block(this,event))->toString() == cachedAxisData))){
					HX_STACK_LINE(679)
					return null();
				}
				else{
...
Void Stage_obj::__onMouse( Dynamic event,::String type,bool fromMouse){
{
		...
		if (((this->__dragObject != null()))){
			HX_STACK_LINE(867)
			this->__drag(::openfl::_v2::geom::Point_obj::__new(event->__Field(HX_CSTRING("x"),true),event->__Field(HX_CSTRING("y"),true)));
		}
		HX_STACK_LINE(871)
		Array< ::Dynamic > stack = Array_obj< ::Dynamic >::__new();		HX_STACK_VAR(stack,"stack");
		HX_STACK_LINE(872)
		...
		if (((stack->length > (int)0))){
			...
			stack->reverse();
			HX_STACK_LINE(886)
			local = object1->globalToLocal(::openfl::_v2::geom::Point_obj::__new(event->__Field(HX_CSTRING("x"),true),event->__Field(HX_CSTRING("y"),true)));
			HX_STACK_LINE(887)
			...
			HX_STACK_LINE(900)
			local = ::openfl::_v2::geom::Point_obj::__new(event->__Field(HX_CSTRING("x"),true),event->__Field(HX_CSTRING("y"),true));
			HX_STACK_LINE(901)
...
Void Stage_obj::__onTouch( Dynamic event,::String type,::openfl::_v2::display::TouchInfo touchInfo){
{
		...
		if (((stack->length > (int)0))){
			...
			stack->reverse();
			HX_STACK_LINE(987)
			::openfl::_v2::geom::Point local = object1->globalToLocal(::openfl::_v2::geom::Point_obj::__new(event->__Field(HX_CSTRING("x"),true),event->__Field(HX_CSTRING("y"),true)));		HX_STACK_VAR(local,"local");
			HX_STACK_LINE(988)
			...
			HX_STACK_LINE(997)
			::openfl::_v2::events::TouchEvent touchEvent = ::openfl::_v2::events::TouchEvent_obj::__create(type,event,::openfl::_v2::geom::Point_obj::__new(event->__Field(HX_CSTRING("x"),true),event->__Field(HX_CSTRING("y"),true)),null(),event->__Field(HX_CSTRING("scaleX"),true),event->__Field(HX_CSTRING("scaleY"),true));		HX_STACK_VAR(touchEvent,"touchEvent");
			HX_STACK_LINE(998)
			touchEvent->touchPointID = event->__Field(HX_CSTRING("value"),true);
			HX_STACK_LINE(999)
			touchEvent->isPrimaryTouchPoint = (((int(event->__Field(HX_CSTRING("flags"),true)) & int((int)32768))) > (int)0);
...
Void Stage_obj::__render( bool sendEnterFrame){
{
		...
		if ((sendEnterFrame)){
			HX_STACK_LINE(1035)
			this->__broadcast(::openfl::_v2::events::Event_obj::__new(::openfl::_v2::events::Event_obj::ENTER_FRAME,null(),null()));
		}
		HX_STACK_LINE(1039)
		if ((this->__invalid)){
			HX_STACK_LINE(1041)
			this->__invalid = false;
			HX_STACK_LINE(1042)
			this->__broadcast(::openfl::_v2::events::Event_obj::__new(::openfl::_v2::events::Event_obj::RENDER,null(),null()));
		}
		HX_STACK_LINE(1046)
...
{
		HX_STACK_FRAME("openfl._v2.display.Stage","__setActive",0xb282307b,"openfl._v2.display.Stage.__setActive","openfl/_v2/display/Stage.hx",1051,0xd25d2a60)
		HX_STACK_THIS(this)
		...
		if (((this->active != value))){
			...
			if ((value)){
				...
				if (((  (((focus->__get((int)0).StaticCast< ::openfl::_v2::display::InteractiveObject >() != null()))) ? bool(focus->__get((int)0).StaticCast< ::openfl::_v2::display::InteractiveObject >()->get_needsSoftKeyboard()) : bool(false) ))){
					...
					Void run(){
						HX_STACK_FRAME("*","_Function_4_1",0x520333fa,"*._Function_4_1","openfl/_v2/display/Stage.hx",1077,0xd25d2a60)
						{
							HX_STACK_LINE(1077)
...
Void Stage_obj::__startDrag( ::openfl::_v2::display::Sprite sprite,bool lockCenter,::openfl::_v2::geom::Rectangle bounds){
{
		...
		if (((this->__dragObject != null()))){
			...
			if ((lockCenter)){
				...
				HX_STACK_LINE(1115)
				::openfl::_v2::geom::Point mouse = ::openfl::_v2::geom::Point_obj::__new(_g,this->get_mouseY());		HX_STACK_VAR(mouse,"mouse");
				HX_STACK_LINE(1116)
				::openfl::_v2::display::DisplayObjectContainer parent = this->__dragObject->get_parent();		HX_STACK_VAR(parent,"parent");
				HX_STACK_LINE(1118)
				if (((parent != null()))){
...
::openfl::display::StageAlign Stage_obj::set_align( ::openfl::display::StageAlign value){
	...
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(1186)
	::openfl::_v2::display::Stage_obj::lime_stage_set_align(this->__handle,value->__Index());
	HX_STACK_LINE(1187)
	return value;
}
...
::openfl::display::StageDisplayState Stage_obj::set_displayState( ::openfl::display::StageDisplayState value){
	...
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(1216)
	::openfl::_v2::display::Stage_obj::lime_stage_set_display_state(this->__handle,value->__Index());
	HX_STACK_LINE(1217)
	return value;
}
...
::openfl::_v2::display::StageQuality Stage_obj::set_quality( ::openfl::_v2::display::StageQuality value){
	...
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(1282)
	::openfl::_v2::display::Stage_obj::lime_stage_set_quality(this->__handle,value->__Index());
	HX_STACK_LINE(1283)
	return value;
}
...
::openfl::display::StageScaleMode Stage_obj::set_scaleMode( ::openfl::display::StageScaleMode value){
	...
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(1298)
	::openfl::_v2::display::Stage_obj::lime_stage_set_scale_mode(this->__handle,value->__Index());
	HX_STACK_LINE(1299)
	return value;
}
...
int Stage_obj::get_stageHeight( ){
	HX_STACK_FRAME("openfl._v2.display.Stage","get_stageHeight",0x984eb6ef,"openfl._v2.display.Stage.get_stageHeight","openfl/_v2/display/Stage.hx",1331,0xd25d2a60)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1331)
	return ::Std_obj::_int(hx::TCast< Float >::cast(::openfl::_v2::display::Stage_obj::lime_stage_get_stage_height(this->__handle)));
}
...
int Stage_obj::get_stageWidth( ){
	HX_STACK_FRAME("openfl._v2.display.Stage","get_stageWidth",0x91a8bffe,"openfl._v2.display.Stage.get_stageWidth","openfl/_v2/display/Stage.hx",1338,0xd25d2a60)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1338)
	return ::Std_obj::_int(hx::TCast< Float >::cast(::openfl::_v2::display::Stage_obj::lime_stage_get_stage_width(this->__handle)));
}
