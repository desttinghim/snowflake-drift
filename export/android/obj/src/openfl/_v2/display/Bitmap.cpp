...
{
HX_STACK_FRAME("openfl._v2.display.Bitmap","new",0xa13b3bbe,"openfl._v2.display.Bitmap.new","openfl/_v2/display/Bitmap.hx",15,0x220ab68f)
...
{
	HX_STACK_LINE(17)
	super::__construct(::openfl::_v2::display::DisplayObject_obj::lime_create_display_object(),HX_CSTRING("Bitmap"));
	HX_STACK_LINE(19)
...
{
		HX_STACK_FRAME("openfl._v2.display.Bitmap","__rebuild",0xa87ec559,"openfl._v2.display.Bitmap.__rebuild","openfl/_v2/display/Bitmap.hx",37,0x220ab68f)
		HX_STACK_THIS(this)
		HX_STACK_LINE(37)
		if (((this->__handle != null()))){
			...
			if (((this->bitmapData != null()))){
				...
				HX_STACK_LINE(45)
				gfx->drawRect((int)0,(int)0,_g,this->bitmapData->get_height());
				HX_STACK_LINE(46)
				gfx->endFill();
			}
		}
...
::openfl::_v2::display::BitmapData Bitmap_obj::set_bitmapData( ::openfl::_v2::display::BitmapData value){
	HX_STACK_FRAME("openfl._v2.display.Bitmap","set_bitmapData",0x3b6adbd8,"openfl._v2.display.Bitmap.set_bitmapData","openfl/_v2/display/Bitmap.hx",62,0x220ab68f)
	HX_STACK_THIS(this)
...
bool Bitmap_obj::set_smoothing( bool value){
	HX_STACK_FRAME("openfl._v2.display.Bitmap","set_smoothing",0x4c721835,"openfl._v2.display.Bitmap.set_smoothing","openfl/_v2/display/Bitmap.hx",72,0x220ab68f)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(74)
