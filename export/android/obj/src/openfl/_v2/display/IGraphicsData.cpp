...
{
HX_STACK_FRAME("openfl._v2.display.IGraphicsData","new",0x6e3538d3,"openfl._v2.display.IGraphicsData.new","openfl/_v2/display/IGraphicsData.hx",12,0x08d35e80)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.display.IGraphicsData"), hx::TCanCast< IGraphicsData_obj> ,sStaticFields,sMemberFields,
