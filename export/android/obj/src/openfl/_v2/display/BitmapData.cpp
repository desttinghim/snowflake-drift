...
int fillColor = __o_fillColor.Default(-1);
{
	...
	if (((bool((width < (int)1)) || bool((height < (int)1))))){
		...
		HX_STACK_LINE(62)
		this->__handle = ::openfl::_v2::display::BitmapData_obj::lime_bitmap_data_create(width,height,flags,(int(fillColor) & int((int)16777215)),alpha,gpuMode);
	}
}
;
	return null();
...
::openfl::_v2::display::BitmapData BitmapData_obj::clone( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(85)
	::openfl::_v2::display::BitmapData bitmapData = ::openfl::_v2::display::BitmapData_obj::__new((int)0,(int)0,this->get_transparent(),null(),null());		HX_STACK_VAR(bitmapData,"bitmapData");
	HX_STACK_LINE(86)
	bitmapData->__handle = ::openfl::_v2::display::BitmapData_obj::lime_bitmap_data_clone(this->__handle);
	HX_STACK_LINE(87)
	return bitmapData;
}
...
Void BitmapData_obj::paletteMap( ::openfl::_v2::display::BitmapData sourceBitmapData,::openfl::_v2::geom::Rectangle sourceRect,::openfl::_v2::geom::Point destPoint,Array< int > redArray,Array< int > greenArray,Array< int > blueArray,Array< int > alphaArray){
{
		...
		HX_STACK_LINE(350)
		{
			...
			while(((_g1 < _g))){
				...
				position = (i * (int)4);
				HX_STACK_LINE(352)
				pixelValue = ::openfl::_v2::Memory_obj::getI32(position);
				HX_STACK_LINE(354)
...
{
		HX_STACK_LINE(458)
		if (((  (((  (((  (((sourceBitmapData == hx::ObjectPtr<OBJ_>(this)))) ? bool(sourceRect->equals(this->get_rect())) : bool(false) ))) ? bool((destPoint->x == (int)0)) : bool(false) ))) ? bool((destPoint->y == (int)0)) : bool(false) ))){
			HX_STACK_LINE(460)
			...
			HX_STACK_LINE(466)
			memory->setLength(((_g * this->get_height()) * (int)4));
			HX_STACK_LINE(467)
				...
				while(((_g1 < _g2))){
					...
					HX_STACK_LINE(479)
					{
						...
						while(((_g3 < _g21))){
							...
							HX_STACK_LINE(485)
							i = ::openfl::_v2::display::BitmapData_obj::__ucompare(pixelMask,thresholdMask);
							HX_STACK_LINE(486)
							test = false;
							HX_STACK_LINE(488)
					...
					HX_STACK_LINE(565)
					{
						...
						while(((_g1 < dw))){
							...
							if ((test)){
								...
								if ((copySource)){
									HX_STACK_LINE(588)
									::openfl::_v2::Memory_obj::setI32(position,::openfl::_v2::Memory_obj::getI32((canvasMemory + position)));
								}
							}
						}
					}
...
{
		HX_STACK_FRAME("openfl._v2.display.BitmapData","__loadFromBytes",0x0e5a8923,"openfl._v2.display.BitmapData.__loadFromBytes","openfl/_v2/display/BitmapData.hx",637,0xebe9fb05)
		HX_STACK_THIS(this)
		HX_STACK_ARG(bytes,"bytes")
		HX_STACK_ARG(rawAlpha,"rawAlpha")
		HX_STACK_LINE(637)
		this->__handle = ::openfl::_v2::display::BitmapData_obj::lime_bitmap_data_from_bytes(bytes,rawAlpha);
	}
return null();
}
...
::openfl::_v2::geom::Rectangle BitmapData_obj::get_rect( ){
	...
	int _g = this->get_width();		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(705)
	return ::openfl::_v2::geom::Rectangle_obj::__new((int)0,(int)0,_g,this->get_height());
}
...
::openfl::_v2::utils::ByteArray BitmapData_obj::getRGBAPixels( ::openfl::_v2::display::BitmapData bitmapData){
	...
	HX_STACK_LINE(248)
	::openfl::_v2::utils::ByteArray data = bitmapData->getPixels(::openfl::_v2::geom::Rectangle_obj::__new((int)0,(int)0,_g,bitmapData->get_height()));		HX_STACK_VAR(data,"data");
	HX_STACK_LINE(249)
	int _g1 = bitmapData->get_width();		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(249)
	int size = (_g1 * bitmapData->get_height());		HX_STACK_VAR(size,"size");
	HX_STACK_LINE(251)
	...
	HX_STACK_ARG(format,"format")
{
		...
		HX_STACK_LINE(296)
		result->__handle = ::openfl::_v2::display::BitmapData_obj::lime_bitmap_data_load(filename,format);
		HX_STACK_LINE(297)
		return result;
	}
}
...
::openfl::_v2::display::BitmapData BitmapData_obj::loadFromBytes( ::openfl::_v2::utils::ByteArray bytes,::openfl::_v2::utils::ByteArray rawAlpha){
	...
	HX_STACK_LINE(305)
	result->__handle = ::openfl::_v2::display::BitmapData_obj::lime_bitmap_data_from_bytes(bytes,rawAlpha);
	HX_STACK_LINE(306)
	return result;
}
...
::openfl::_v2::display::BitmapData BitmapData_obj::loadFromHaxeBytes( ::haxe::io::Bytes bytes,::haxe::io::Bytes rawAlpha){
	...
	HX_STACK_LINE(313)
	return ::openfl::_v2::display::BitmapData_obj::loadFromBytes(_g,(  (((rawAlpha == null()))) ? ::openfl::_v2::utils::ByteArray(null()) : ::openfl::_v2::utils::ByteArray(::openfl::_v2::utils::ByteArray_obj::fromBytes(rawAlpha)) ));
}
