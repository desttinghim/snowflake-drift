...
{
HX_STACK_FRAME("openfl._v2.display.DisplayObjectContainer","new",0x989940af,"openfl._v2.display.DisplayObjectContainer.new","openfl/_v2/display/DisplayObjectContainer.hx",21,0x5bed24be)
...
::openfl::_v2::display::DisplayObject DisplayObjectContainer_obj::addChild( ::openfl::_v2::display::DisplayObject child){
	HX_STACK_FRAME("openfl._v2.display.DisplayObjectContainer","addChild",0x9b4ce10c,"openfl._v2.display.DisplayObjectContainer.addChild","openfl/_v2/display/DisplayObjectContainer.hx",29,0x5bed24be)
	HX_STACK_THIS(this)
	...
	HX_STACK_LINE(31)
	{
		...
		if (((child->__parent == hx::ObjectPtr<OBJ_>(this)))){
			...
			HX_STACK_LINE(31)
			::openfl::_v2::display::DisplayObjectContainer_obj::lime_doc_add_child(this->__handle,child->__handle);
		}
	}
	HX_STACK_LINE(32)
	return child;
...
::openfl::_v2::display::DisplayObject DisplayObjectContainer_obj::addChildAt( ::openfl::_v2::display::DisplayObject child,int index){
	HX_STACK_FRAME("openfl._v2.display.DisplayObjectContainer","addChildAt",0xb110751f,"openfl._v2.display.DisplayObjectContainer.addChildAt","openfl/_v2/display/DisplayObjectContainer.hx",37,0x5bed24be)
	HX_STACK_THIS(this)
	HX_STACK_ARG(child,"child")
	...
	HX_STACK_LINE(40)
	{
			...
			if (((child->__parent == hx::ObjectPtr<OBJ_>(this)))){
				...
				HX_STACK_LINE(40)
				{
					...
					while(((_g1 < _g))){
						...
						HX_STACK_LINE(40)
						if (((this->__children->__get(i).StaticCast< ::openfl::_v2::display::DisplayObject >() == child))){
							HX_STACK_LINE(40)
							actualIndex = i;
							HX_STACK_LINE(40)
							break;
		...
		HX_STACK_LINE(40)
		::openfl::_v2::display::DisplayObjectContainer_obj::lime_doc_set_child_index(this->__handle,child->__handle,index);
		HX_STACK_LINE(40)
		if (((index < firstIndex))){
			HX_STACK_LINE(40)
			...
			while(((i > index))){
				HX_STACK_LINE(40)
				this->__children[i] = this->__children->__get((i - (int)1)).StaticCast< ::openfl::_v2::display::DisplayObject >();
				HX_STACK_LINE(40)
				(i)--;
			}
			HX_STACK_LINE(40)
...
bool DisplayObjectContainer_obj::areInaccessibleObjectsUnderPoint( ::openfl::_v2::geom::Point point){
	HX_STACK_FRAME("openfl._v2.display.DisplayObjectContainer","areInaccessibleObjectsUnderPoint",0xc305de8e,"openfl._v2.display.DisplayObjectContainer.areInaccessibleObjectsUnderPoint","openfl/_v2/display/DisplayObjectContainer.hx",48,0x5bed24be)
	HX_STACK_THIS(this)
...
bool DisplayObjectContainer_obj::contains( ::openfl::_v2::display::DisplayObject child){
	HX_STACK_FRAME("openfl._v2.display.DisplayObjectContainer","contains",0x08b16b70,"openfl._v2.display.DisplayObjectContainer.contains","openfl/_v2/display/DisplayObjectContainer.hx",55,0x5bed24be)
	HX_STACK_THIS(this)
	HX_STACK_ARG(child,"child")
	HX_STACK_LINE(55)
...
::openfl::_v2::display::DisplayObject DisplayObjectContainer_obj::getChildAt( int index){
	HX_STACK_FRAME("openfl._v2.display.DisplayObjectContainer","getChildAt",0x98e7cf4a,"openfl._v2.display.DisplayObjectContainer.getChildAt","openfl/_v2/display/DisplayObjectContainer.hx",60,0x5bed24be)
	HX_STACK_THIS(this)
	HX_STACK_ARG(index,"index")
	HX_STACK_LINE(62)
	if (((bool((index >= (int)0)) && bool((index < this->__children->length))))){
		HX_STACK_LINE(64)
		return this->__children->__get(index).StaticCast< ::openfl::_v2::display::DisplayObject >();
	}
	HX_STACK_LINE(68)
...
::openfl::_v2::display::DisplayObject DisplayObjectContainer_obj::getChildByName( ::String name){
	HX_STACK_FRAME("openfl._v2.display.DisplayObjectContainer","getChildByName",0xa1571d99,"openfl._v2.display.DisplayObjectContainer.getChildByName","openfl/_v2/display/DisplayObjectContainer.hx",74,0x5bed24be)
	HX_STACK_THIS(this)
	...
	HX_STACK_LINE(76)
	{
		...
		while(((_g < _g1->length))){
			HX_STACK_LINE(76)
			::openfl::_v2::display::DisplayObject child = _g1->__get(_g).StaticCast< ::openfl::_v2::display::DisplayObject >();		HX_STACK_VAR(child,"child");
			HX_STACK_LINE(76)
			++(_g);
			HX_STACK_LINE(78)
...
int DisplayObjectContainer_obj::getChildIndex( ::openfl::_v2::display::DisplayObject child){
	HX_STACK_FRAME("openfl._v2.display.DisplayObjectContainer","getChildIndex",0x4d16f11b,"openfl._v2.display.DisplayObjectContainer.getChildIndex","openfl/_v2/display/DisplayObjectContainer.hx",93,0x5bed24be)
	HX_STACK_THIS(this)
	HX_STACK_ARG(child,"child")
	HX_STACK_LINE(93)
...
Array< ::Dynamic > DisplayObjectContainer_obj::getObjectsUnderPoint( ::openfl::_v2::geom::Point point){
	HX_STACK_FRAME("openfl._v2.display.DisplayObjectContainer","getObjectsUnderPoint",0xb0485767,"openfl._v2.display.DisplayObjectContainer.getObjectsUnderPoint","openfl/_v2/display/DisplayObjectContainer.hx",98,0x5bed24be)
	HX_STACK_THIS(this)
	HX_STACK_ARG(point,"point")
	HX_STACK_LINE(101)
	...
	if ((!(onStage))){
		...
		HX_STACK_LINE(107)
		::openfl::_v2::Lib_obj::get_stage()->addChild(hx::ObjectPtr<OBJ_>(this));
	}
	HX_STACK_LINE(111)
	...
	if ((!(onStage))){
		HX_STACK_LINE(116)
		::openfl::_v2::Lib_obj::get_stage()->removeChild(hx::ObjectPtr<OBJ_>(this));
		HX_STACK_LINE(117)
...
::openfl::_v2::display::DisplayObject DisplayObjectContainer_obj::removeChild( ::openfl::_v2::display::DisplayObject child){
	HX_STACK_FRAME("openfl._v2.display.DisplayObjectContainer","removeChild",0xdfa25e07,"openfl._v2.display.DisplayObjectContainer.removeChild","openfl/_v2/display/DisplayObjectContainer.hx",126,0x5bed24be)
	HX_STACK_THIS(this)
	HX_STACK_ARG(child,"child")
	HX_STACK_LINE(128)
...
::openfl::_v2::display::DisplayObject DisplayObjectContainer_obj::removeChildAt( int index){
	HX_STACK_FRAME("openfl._v2.display.DisplayObjectContainer","removeChildAt",0xd37b66da,"openfl._v2.display.DisplayObjectContainer.removeChildAt","openfl/_v2/display/DisplayObjectContainer.hx",142,0x5bed24be)
	HX_STACK_THIS(this)
	HX_STACK_ARG(index,"index")
	HX_STACK_LINE(144)
	if (((bool((index >= (int)0)) && bool((index < this->__children->length))))){
		HX_STACK_LINE(146)
		::openfl::_v2::display::DisplayObject result = this->__children->__get(index).StaticCast< ::openfl::_v2::display::DisplayObject >();		HX_STACK_VAR(result,"result");
		HX_STACK_LINE(147)
...
int endIndex = __o_endIndex.Default(2147483647);
	HX_STACK_FRAME("openfl._v2.display.DisplayObjectContainer","removeChildren",0x38a3b9b4,"openfl._v2.display.DisplayObjectContainer.removeChildren","openfl/_v2/display/DisplayObjectContainer.hx",157,0x5bed24be)
	HX_STACK_THIS(this)
...
Void DisplayObjectContainer_obj::setChildIndex( ::openfl::_v2::display::DisplayObject child,int index){
{
		HX_STACK_FRAME("openfl._v2.display.DisplayObjectContainer","setChildIndex",0x921cd327,"openfl._v2.display.DisplayObjectContainer.setChildIndex","openfl/_v2/display/DisplayObjectContainer.hx",194,0x5bed24be)
		HX_STACK_THIS(this)
		HX_STACK_ARG(child,"child")
		HX_STACK_ARG(index,"index")
		HX_STACK_LINE(194)
...
Void DisplayObjectContainer_obj::swapChildren( ::openfl::_v2::display::DisplayObject child1,::openfl::_v2::display::DisplayObject child2){
{
		HX_STACK_FRAME("openfl._v2.display.DisplayObjectContainer","swapChildren",0x82dad8c3,"openfl._v2.display.DisplayObjectContainer.swapChildren","openfl/_v2/display/DisplayObjectContainer.hx",199,0x5bed24be)
		HX_STACK_THIS(this)
		...
		HX_STACK_LINE(210)
		{
			...
			if (((index1 != index2))){
				HX_STACK_LINE(210)
				::openfl::_v2::display::DisplayObject temp = this->__children->__get(index1).StaticCast< ::openfl::_v2::display::DisplayObject >();		HX_STACK_VAR(temp,"temp");
				HX_STACK_LINE(210)
				this->__children[index1] = this->__children->__get(index2).StaticCast< ::openfl::_v2::display::DisplayObject >();
				HX_STACK_LINE(210)
				this->__children[index2] = temp;
				HX_STACK_LINE(210)
				::openfl::_v2::display::DisplayObjectContainer_obj::lime_doc_swap_children(this->__handle,index1,index2);
			}
		}
	}
return null();
...
{
		HX_STACK_FRAME("openfl._v2.display.DisplayObjectContainer","swapChildrenAt",0x11d50896,"openfl._v2.display.DisplayObjectContainer.swapChildrenAt","openfl/_v2/display/DisplayObjectContainer.hx",217,0x5bed24be)
		HX_STACK_THIS(this)
...
Void DisplayObjectContainer_obj::__addChild( ::openfl::_v2::display::DisplayObject child){
{
		HX_STACK_FRAME("openfl._v2.display.DisplayObjectContainer","__addChild",0x45290a6c,"openfl._v2.display.DisplayObjectContainer.__addChild","openfl/_v2/display/DisplayObjectContainer.hx",222,0x5bed24be)
		HX_STACK_THIS(this)
		HX_STACK_ARG(child,"child")
		HX_STACK_LINE(224)
		if (((child == hx::ObjectPtr<OBJ_>(this)))){
...
Void DisplayObjectContainer_obj::__broadcast( ::openfl::_v2::events::Event event){
{
		HX_STACK_FRAME("openfl._v2.display.DisplayObjectContainer","__broadcast",0xa8fac330,"openfl._v2.display.DisplayObjectContainer.__broadcast","openfl/_v2/display/DisplayObjectContainer.hx",245,0x5bed24be)
		HX_STACK_THIS(this)
		...
		if (((this->__children->length > (int)0))){
			HX_STACK_LINE(251)
			::openfl::_v2::display::DisplayObject child;		HX_STACK_VAR(child,"child");
			HX_STACK_LINE(253)
			while((true)){
				HX_STACK_LINE(255)
				child = this->__children->__get(i).StaticCast< ::openfl::_v2::display::DisplayObject >();
				HX_STACK_LINE(256)
...
bool DisplayObjectContainer_obj::__contains( ::openfl::_v2::display::DisplayObject child){
	HX_STACK_FRAME("openfl._v2.display.DisplayObjectContainer","__contains",0xb28d94d0,"openfl._v2.display.DisplayObjectContainer.__contains","openfl/_v2/display/DisplayObjectContainer.hx",285,0x5bed24be)
	HX_STACK_THIS(this)
	HX_STACK_ARG(child,"child")
	HX_STACK_LINE(287)
	if (((child == null()))){
	...
	HX_STACK_LINE(299)
	{
		...
		while(((_g < _g1->length))){
			HX_STACK_LINE(299)
			::openfl::_v2::display::DisplayObject c = _g1->__get(_g).StaticCast< ::openfl::_v2::display::DisplayObject >();		HX_STACK_VAR(c,"c");
			HX_STACK_LINE(299)
			++(_g);
			HX_STACK_LINE(301)
...
::openfl::_v2::display::DisplayObject DisplayObjectContainer_obj::__findByID( int id){
	HX_STACK_FRAME("openfl._v2.display.DisplayObjectContainer","__findByID",0x19c940fc,"openfl._v2.display.DisplayObjectContainer.__findByID","openfl/_v2/display/DisplayObjectContainer.hx",314,0x5bed24be)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(316)
	if (((this->__id == id))){
	...
	HX_STACK_LINE(322)
	::openfl::_v2::display::DisplayObject found;		HX_STACK_VAR(found,"found");
	HX_STACK_LINE(324)
	{
		HX_STACK_LINE(324)
		int _g = (int)0;		HX_STACK_VAR(_g,"_g");
...
int DisplayObjectContainer_obj::__getChildIndex( ::openfl::_v2::display::DisplayObject child){
	HX_STACK_FRAME("openfl._v2.display.DisplayObjectContainer","__getChildIndex",0x69c8cbbb,"openfl._v2.display.DisplayObjectContainer.__getChildIndex","openfl/_v2/display/DisplayObjectContainer.hx",341,0x5bed24be)
	HX_STACK_THIS(this)
	HX_STACK_ARG(child,"child")
	HX_STACK_LINE(343)
	{
...
Void DisplayObjectContainer_obj::__getObjectsUnderPoint( ::openfl::_v2::geom::Point point,Array< ::Dynamic > result){
{
		HX_STACK_FRAME("openfl._v2.display.DisplayObjectContainer","__getObjectsUnderPoint",0xb06d10c7,"openfl._v2.display.DisplayObjectContainer.__getObjectsUnderPoint","openfl/_v2/display/DisplayObjectContainer.hx",358,0x5bed24be)
		HX_STACK_THIS(this)
		HX_STACK_ARG(point,"point")
...
Void DisplayObjectContainer_obj::__onAdded( ::openfl::_v2::display::DisplayObject object,bool isOnStage){
{
		HX_STACK_FRAME("openfl._v2.display.DisplayObjectContainer","__onAdded",0x06e8d990,"openfl._v2.display.DisplayObjectContainer.__onAdded","openfl/_v2/display/DisplayObjectContainer.hx",371,0x5bed24be)
		HX_STACK_THIS(this)
...
Void DisplayObjectContainer_obj::__onRemoved( ::openfl::_v2::display::DisplayObject object,bool wasOnStage){
{
		HX_STACK_FRAME("openfl._v2.display.DisplayObjectContainer","__onRemoved",0x948bf870,"openfl._v2.display.DisplayObjectContainer.__onRemoved","openfl/_v2/display/DisplayObjectContainer.hx",384,0x5bed24be)
		HX_STACK_THIS(this)
		HX_STACK_ARG(object,"object")
...
Void DisplayObjectContainer_obj::__removeChildFromArray( ::openfl::_v2::display::DisplayObject child){
{
		HX_STACK_FRAME("openfl._v2.display.DisplayObjectContainer","__removeChildFromArray",0x323b1a28,"openfl._v2.display.DisplayObjectContainer.__removeChildFromArray","openfl/_v2/display/DisplayObjectContainer.hx",397,0x5bed24be)
		HX_STACK_THIS(this)
		HX_STACK_ARG(child,"child")
		HX_STACK_LINE(399)
		...
		if (((i >= (int)0))){
			HX_STACK_LINE(403)
			::openfl::_v2::display::DisplayObjectContainer_obj::lime_doc_remove_child(this->__handle,i);
			HX_STACK_LINE(404)
...
Void DisplayObjectContainer_obj::__setChildIndex( ::openfl::_v2::display::DisplayObject child,int index){
{
		HX_STACK_FRAME("openfl._v2.display.DisplayObjectContainer","__setChildIndex",0xaeceadc7,"openfl._v2.display.DisplayObjectContainer.__setChildIndex","openfl/_v2/display/DisplayObjectContainer.hx",411,0x5bed24be)
		HX_STACK_THIS(this)
		HX_STACK_ARG(child,"child")
		HX_STACK_ARG(index,"index")
		HX_STACK_LINE(413)
...
{
		HX_STACK_FRAME("openfl._v2.display.DisplayObjectContainer","__swapChildrenAt",0x10c279f6,"openfl._v2.display.DisplayObjectContainer.__swapChildrenAt","openfl/_v2/display/DisplayObjectContainer.hx",489,0x5bed24be)
		HX_STACK_THIS(this)
		HX_STACK_ARG(index1,"index1")
		HX_STACK_ARG(index2,"index2")
		HX_STACK_LINE(491)
...
bool DisplayObjectContainer_obj::get_mouseChildren( ){
	HX_STACK_FRAME("openfl._v2.display.DisplayObjectContainer","get_mouseChildren",0xbc6ae06a,"openfl._v2.display.DisplayObjectContainer.get_mouseChildren","openfl/_v2/display/DisplayObjectContainer.hx",516,0x5bed24be)
	HX_STACK_THIS(this)
	HX_STACK_LINE(516)
	return ::openfl::_v2::display::DisplayObjectContainer_obj::lime_doc_get_mouse_children(this->__handle);
}
...
bool DisplayObjectContainer_obj::set_mouseChildren( bool value){
	HX_STACK_FRAME("openfl._v2.display.DisplayObjectContainer","set_mouseChildren",0xdfd8b876,"openfl._v2.display.DisplayObjectContainer.set_mouseChildren","openfl/_v2/display/DisplayObjectContainer.hx",517,0x5bed24be)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(519)
	::openfl::_v2::display::DisplayObjectContainer_obj::lime_doc_set_mouse_children(this->__handle,value);
	HX_STACK_LINE(520)
	return value;
}
...
int DisplayObjectContainer_obj::get_numChildren( ){
	HX_STACK_FRAME("openfl._v2.display.DisplayObjectContainer","get_numChildren",0x46764c0b,"openfl._v2.display.DisplayObjectContainer.get_numChildren","openfl/_v2/display/DisplayObjectContainer.hx",525,0x5bed24be)
	HX_STACK_THIS(this)
	HX_STACK_LINE(525)
...
bool DisplayObjectContainer_obj::get_tabChildren( ){
	HX_STACK_FRAME("openfl._v2.display.DisplayObjectContainer","get_tabChildren",0x357bef1a,"openfl._v2.display.DisplayObjectContainer.get_tabChildren","openfl/_v2/display/DisplayObjectContainer.hx",526,0x5bed24be)
	HX_STACK_THIS(this)
	HX_STACK_LINE(526)
	return false;
}
...
bool DisplayObjectContainer_obj::set_tabChildren( bool value){
	HX_STACK_FRAME("openfl._v2.display.DisplayObjectContainer","set_tabChildren",0x31476c26,"openfl._v2.display.DisplayObjectContainer.set_tabChildren","openfl/_v2/display/DisplayObjectContainer.hx",527,0x5bed24be)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(527)
	return false;
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.display.DisplayObjectContainer"), hx::TCanCast< DisplayObjectContainer_obj> ,sStaticFields,sMemberFields,
...
{
	lime_create_display_object_container= ::openfl::_v2::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_create_display_object_container"),(int)0);
	lime_doc_add_child= ::openfl::_v2::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_doc_add_child"),(int)2);
	lime_doc_remove_child= ::openfl::_v2::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_doc_remove_child"),(int)2);
	lime_doc_set_child_index= ::openfl::_v2::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_doc_set_child_index"),(int)3);
	lime_doc_get_mouse_children= ::openfl::_v2::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_doc_get_mouse_children"),(int)1);
	lime_doc_set_mouse_children= ::openfl::_v2::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_doc_set_mouse_children"),(int)2);
	lime_doc_swap_children= ::openfl::_v2::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_doc_swap_children"),(int)3);
}
