...
HX_STACK_FRAME("openfl._v2.display.Loader","new",0x210755e2,"openfl._v2.display.Loader.new","openfl/_v2/display/Loader.hx",26,0x56462ceb)
{
	...
	super::__construct();
	HX_STACK_LINE(30)
	this->contentLoaderInfo = ::openfl::_v2::display::LoaderInfo_obj::create(hx::ObjectPtr<OBJ_>(this));
	HX_STACK_LINE(31)
...
{
		HX_STACK_FRAME("openfl._v2.display.Loader","unload",0xb607f8bd,"openfl._v2.display.Loader.unload","openfl/_v2/display/Loader.hx",62,0x56462ceb)
		HX_STACK_THIS(this)
		HX_STACK_LINE(62)
...
bool Loader_obj::__onComplete( ::openfl::_v2::utils::ByteArray bytes){
	...
	{
		HX_STACK_LINE(100)
		this->__image = ::openfl::_v2::display::BitmapData_obj::loadFromBytes(bytes,null());
		HX_STACK_LINE(101)
