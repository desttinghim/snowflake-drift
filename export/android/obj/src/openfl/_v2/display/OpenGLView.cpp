...
{
HX_STACK_FRAME("openfl._v2.display.OpenGLView","new",0xe3fdcf43,"openfl._v2.display.OpenGLView.new","openfl/_v2/display/OpenGLView.hx",19,0x89770d2a)
{
	HX_STACK_LINE(19)
...
bool OpenGLView_obj::get_isSupported( ){
	HX_STACK_FRAME("openfl._v2.display.OpenGLView","get_isSupported",0xc7ca7bde,"openfl._v2.display.OpenGLView.get_isSupported","openfl/_v2/display/OpenGLView.hx",33,0x89770d2a)
	HX_STACK_LINE(33)
	return true;
}
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.display.OpenGLView"), hx::TCanCast< OpenGLView_obj> ,sStaticFields,sMemberFields,
