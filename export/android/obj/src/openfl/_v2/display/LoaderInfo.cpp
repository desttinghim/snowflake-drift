...
Void LoaderInfo_obj::load( ::openfl::_v2::net::URLRequest request){
{
		...
		HX_STACK_LINE(74)
		if (((extension.indexOf(HX_CSTRING("?"),null()) != (int)-1))){
			HX_STACK_LINE(75)
			extension = extension.split(HX_CSTRING("?"))->__get((int)0);
		}
		HX_STACK_LINE(77)
...
::openfl::_v2::display::LoaderInfo LoaderInfo_obj::create( ::openfl::_v2::display::Loader loader){
	...
	HX_STACK_LINE(54)
	loaderInfo->uncaughtErrorEvents = ::openfl::events::UncaughtErrorEvents_obj::__new(null());
	HX_STACK_LINE(55)
