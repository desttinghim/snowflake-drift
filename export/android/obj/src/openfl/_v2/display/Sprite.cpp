...
HX_STACK_FRAME("openfl._v2.display.Sprite","new",0x556bcad4,"openfl._v2.display.Sprite.new","openfl/_v2/display/Sprite.hx",14,0xb1331c39)
{
	...
	HX_STACK_LINE(16)
	super::__construct(_g,this->__getType());
	HX_STACK_LINE(18)
...
bool lockCenter = __o_lockCenter.Default(false);
	HX_STACK_FRAME("openfl._v2.display.Sprite","startDrag",0x896ceeea,"openfl._v2.display.Sprite.startDrag","openfl/_v2/display/Sprite.hx",26,0xb1331c39)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl._v2.display.Sprite","stopDrag",0x064e1222,"openfl._v2.display.Sprite.stopDrag","openfl/_v2/display/Sprite.hx",37,0xb1331c39)
		HX_STACK_THIS(this)
		HX_STACK_LINE(37)
		if (((this->get_stage() != null()))){
			HX_STACK_LINE(39)
