...
HX_STACK_ARG(image,"image")
{
	...
	this->__bitmap = image;
	HX_STACK_LINE(41)
	this->__handle = ::openfl::_v2::display::Tilesheet_obj::lime_tilesheet_create(image->__handle);
	HX_STACK_LINE(43)
...
int Tilesheet_obj::addTileRect( ::openfl::_v2::geom::Rectangle rectangle,::openfl::_v2::geom::Point centerPoint){
	...
	if (((centerPoint == null()))){
		...
		HX_STACK_LINE(57)
		this->_tilePoints->push(::openfl::_v2::geom::Point_obj::__new((Float(centerPoint->x) / Float(rectangle->width)),(Float(centerPoint->y) / Float(rectangle->height))));
	}
	HX_STACK_LINE(58)
	Float _g = (Float(rectangle->get_left()) / Float(this->_bitmapWidth));		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(58)
	Float _g1 = (Float(rectangle->get_top()) / Float(this->_bitmapHeight));		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(58)
	Float _g2 = (Float(rectangle->get_right()) / Float(this->_bitmapWidth));		HX_STACK_VAR(_g2,"_g2");
	HX_STACK_LINE(58)
	this->_tileUVs->push(::openfl::_v2::geom::Rectangle_obj::__new(_g,_g1,_g2,(Float(rectangle->get_bottom()) / Float(this->_bitmapHeight))));
	HX_STACK_LINE(59)
