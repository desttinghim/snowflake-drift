					...
					while(((_g1 < width))){
						...
						HX_STACK_LINE(874)
						{
							...
							while(((_g2 < octaves))){
								...
								HX_STACK_LINE(911)
								g1 = (((  (((((int(hash) & int((int)1))) == (int)0))) ? Float(_Function_7_1::Block(hash,x1,y1)) : Float((  (((hash < (int)8))) ? Float(-(x1)) : Float(-(y1)) )) )) + _g3);
								HX_STACK_LINE(913)
								...
								HX_STACK_LINE(914)
								g2 = (((  (((((int(hash) & int((int)1))) == (int)0))) ? Float(_Function_7_2::Block(hash,x,y1)) : Float((  (((hash < (int)8))) ? Float(-(x)) : Float(-(y1)) )) )) + _g11);
								HX_STACK_LINE(916)
								...
								HX_STACK_LINE(917)
								g3 = (((  (((((int(hash) & int((int)1))) == (int)0))) ? Float(_Function_7_3::Block(hash,x1,y)) : Float((  (((hash < (int)8))) ? Float(-(x1)) : Float(-(y)) )) )) + _g21);
								HX_STACK_LINE(919)
								...
								HX_STACK_LINE(920)
								g4 = (((  (((((int(hash) & int((int)1))) == (int)0))) ? Float(_Function_7_4::Block(hash,x,y)) : Float((  (((hash < (int)8))) ? Float(-(x)) : Float(-(y)) )) )) + _g31);
								HX_STACK_LINE(922)
								...
								HX_STACK_LINE(923)
								g5 = (((  (((((int(hash) & int((int)1))) == (int)0))) ? Float(_Function_7_5::Block(hash,x1,y1)) : Float((  (((hash < (int)8))) ? Float(-(x1)) : Float(-(y1)) )) )) + _g4);
								HX_STACK_LINE(925)
								...
								HX_STACK_LINE(926)
								g6 = (((  (((((int(hash) & int((int)1))) == (int)0))) ? Float(_Function_7_6::Block(hash,x,y1)) : Float((  (((hash < (int)8))) ? Float(-(x)) : Float(-(y1)) )) )) + _g5);
								HX_STACK_LINE(928)
								...
								HX_STACK_LINE(929)
								g7 = (((  (((((int(hash) & int((int)1))) == (int)0))) ? Float(_Function_7_7::Block(hash,x1,y)) : Float((  (((hash < (int)8))) ? Float(-(x1)) : Float(-(y)) )) )) + _g6);
								HX_STACK_LINE(931)
								...
								HX_STACK_LINE(932)
								g8 = (((  (((((int(hash) & int((int)1))) == (int)0))) ? Float(_Function_7_8::Block(hash,x,y)) : Float((  (((hash < (int)8))) ? Float(-(x)) : Float(-(y)) )) )) + _g7);
								HX_STACK_LINE(934)
								hx::AddEq(g2,(u * ((g1 - g2))));
								HX_STACK_LINE(935)
								hx::AddEq(g4,(u * ((g3 - g4))));
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.display.OptimizedPerlin"), hx::TCanCast< OptimizedPerlin_obj> ,sStaticFields,sMemberFields,
