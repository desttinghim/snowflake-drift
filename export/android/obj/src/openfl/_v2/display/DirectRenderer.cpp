...
{
	HX_STACK_LINE(15)
	super::__construct(::openfl::_v2::display::DirectRenderer_obj::lime_direct_renderer_create(),type);
	HX_STACK_LINE(17)
...
Void DirectRenderer_obj::__onRender( Dynamic rect){
{
		...
		if (((this->render_dyn() != null()))){
			HX_STACK_LINE(40)
			this->render(::openfl::_v2::geom::Rectangle_obj::__new(rect->__Field(HX_CSTRING("x"),true),rect->__Field(HX_CSTRING("y"),true),rect->__Field(HX_CSTRING("width"),true),rect->__Field(HX_CSTRING("height"),true)));
		}
	}
return null();
}
