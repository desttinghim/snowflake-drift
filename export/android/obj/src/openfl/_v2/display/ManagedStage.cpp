...
{
HX_STACK_FRAME("openfl._v2.display.ManagedStage","new",0xae26976e,"openfl._v2.display.ManagedStage.new","openfl/_v2/display/ManagedStage.hx",44,0x9f9d949f)
...
{
	HX_STACK_LINE(44)
	super::__construct(::openfl::_v2::display::ManagedStage_obj::lime_managed_stage_create(width,height,flags),width,height);
}
;
	return null();
}
...
Void run(){
{
		HX_STACK_FRAME("openfl._v2.display.ManagedStage","beginRender",0xa0f4d36d,"openfl._v2.display.ManagedStage.beginRender","openfl/_v2/display/ManagedStage.hx",49,0x9f9d949f)
		HX_STACK_THIS(this)
	}
return null();
}
...
Void run(){
{
		HX_STACK_FRAME("openfl._v2.display.ManagedStage","endRender",0x91da3f1f,"openfl._v2.display.ManagedStage.endRender","openfl/_v2/display/ManagedStage.hx",56,0x9f9d949f)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("openfl._v2.display.ManagedStage","pumpEvent",0x4008cfe0,"openfl._v2.display.ManagedStage.pumpEvent","openfl/_v2/display/ManagedStage.hx",65,0x9f9d949f)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
		HX_STACK_LINE(65)
		::openfl::_v2::display::ManagedStage_obj::lime_managed_stage_pump_event(this->__handle,event);
	}
return null();
}
...
{
		HX_STACK_FRAME("openfl._v2.display.ManagedStage","resize",0xdc9fefa6,"openfl._v2.display.ManagedStage.resize","openfl/_v2/display/ManagedStage.hx",72,0x9f9d949f)
		HX_STACK_THIS(this)
		HX_STACK_ARG(width,"width")
		HX_STACK_ARG(height,"height")
		struct _Function_1_1{
			inline static Dynamic Block( int &width,int &height){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/_v2/display/ManagedStage.hx",72,0x9f9d949f)
				{
...
{
		HX_STACK_FRAME("openfl._v2.display.ManagedStage","sendQuit",0x75932369,"openfl._v2.display.ManagedStage.sendQuit","openfl/_v2/display/ManagedStage.hx",79,0x9f9d949f)
		HX_STACK_THIS(this)
		struct _Function_1_1{
			inline static Dynamic Block( ){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/_v2/display/ManagedStage.hx",79,0x9f9d949f)
				{
					hx::Anon __result = hx::Anon_obj::Create();
...
{
		HX_STACK_FRAME("openfl._v2.display.ManagedStage","setNextWake",0x2cc55187,"openfl._v2.display.ManagedStage.setNextWake","openfl/_v2/display/ManagedStage.hx",84,0x9f9d949f)
		HX_STACK_THIS(this)
...
Float ManagedStage_obj::__doProcessStageEvent( Dynamic event){
	HX_STACK_FRAME("openfl._v2.display.ManagedStage","__doProcessStageEvent",0x8f91c32e,"openfl._v2.display.ManagedStage.__doProcessStageEvent","openfl/_v2/display/ManagedStage.hx",91,0x9f9d949f)
	HX_STACK_THIS(this)
	HX_STACK_ARG(event,"event")
	HX_STACK_LINE(93)
	this->__pollTimers();
...
{
		HX_STACK_FRAME("openfl._v2.display.ManagedStage","__render",0x4413bca8,"openfl._v2.display.ManagedStage.__render","openfl/_v2/display/ManagedStage.hx",103,0x9f9d949f)
		HX_STACK_THIS(this)
...
void ManagedStage_obj::__Mark(HX_MARK_PARAMS)
{
	...
	::openfl::_v2::display::Stage_obj::__Mark(HX_MARK_ARG);
	HX_MARK_END_CLASS();
}
...
void ManagedStage_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	::openfl::_v2::display::Stage_obj::__Visit(HX_VISIT_ARG);
}
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.display.ManagedStage"), hx::TCanCast< ManagedStage_obj> ,sStaticFields,sMemberFields,
...
void ManagedStage_obj::__boot()
{
	...
	lime_managed_stage_create= ::openfl::_v2::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_managed_stage_create"),(int)3);
	lime_managed_stage_pump_event= ::openfl::_v2::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_managed_stage_pump_event"),(int)2);
}
