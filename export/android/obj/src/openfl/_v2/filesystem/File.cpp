...
::openfl::_v2::filesystem::File File_obj::get_applicationDirectory( ){
	...
	HX_STACK_LINE(45)
	return ::openfl::_v2::filesystem::File_obj::__new(::openfl::_v2::filesystem::File_obj::lime_filesystem_get_special_dir((int)0));
}
...
::openfl::_v2::filesystem::File File_obj::get_applicationStorageDirectory( ){
	...
	HX_STACK_LINE(46)
	return ::openfl::_v2::filesystem::File_obj::__new(::openfl::_v2::filesystem::File_obj::lime_filesystem_get_special_dir((int)1));
}
...
::openfl::_v2::filesystem::File File_obj::get_desktopDirectory( ){
	...
	HX_STACK_LINE(47)
	return ::openfl::_v2::filesystem::File_obj::__new(::openfl::_v2::filesystem::File_obj::lime_filesystem_get_special_dir((int)2));
}
...
::openfl::_v2::filesystem::File File_obj::get_documentsDirectory( ){
	...
	HX_STACK_LINE(48)
	return ::openfl::_v2::filesystem::File_obj::__new(::openfl::_v2::filesystem::File_obj::lime_filesystem_get_special_dir((int)3));
}
...
::openfl::_v2::filesystem::File File_obj::get_userDirectory( ){
	...
	HX_STACK_LINE(49)
	return ::openfl::_v2::filesystem::File_obj::__new(::openfl::_v2::filesystem::File_obj::lime_filesystem_get_special_dir((int)4));
}
...
::String File_obj::lime_filesystem_get_special_dir( int which){
	HX_STACK_FRAME("openfl._v2.filesystem.File","lime_filesystem_get_special_dir",0xea6da194,"openfl._v2.filesystem.File.lime_filesystem_get_special_dir","openfl/_v2/filesystem/File.hx",103,0xe040b451)
	HX_STACK_ARG(which,"which")
	HX_STACK_LINE(105)
	if (((::openfl::_v2::filesystem::File_obj::jni_filesystem_get_special_dir == null()))){
		HX_STACK_LINE(107)
		::openfl::_v2::filesystem::File_obj::jni_filesystem_get_special_dir = ::openfl::_v2::utils::JNI_obj::createStaticMethod(HX_CSTRING("org/haxe/lime/GameActivity"),HX_CSTRING("getSpecialDir"),HX_CSTRING("(I)Ljava/lang/String;"),null(),null());
	}
	HX_STACK_LINE(111)
	return ::openfl::_v2::filesystem::File_obj::jni_filesystem_get_special_dir(which);
}
