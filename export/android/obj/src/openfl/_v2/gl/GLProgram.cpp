...
{
HX_STACK_FRAME("openfl._v2.gl.GLProgram","new",0xb6572999,"openfl._v2.gl.GLProgram.new","openfl/_v2/gl/GLProgram.hx",10,0x0cd51736)
...
Void GLProgram_obj::attach( ::openfl::_v2::gl::GLShader shader){
{
		HX_STACK_FRAME("openfl._v2.gl.GLProgram","attach",0x87976c2c,"openfl._v2.gl.GLProgram.attach","openfl/_v2/gl/GLProgram.hx",20,0x0cd51736)
		HX_STACK_THIS(this)
...
Array< ::Dynamic > GLProgram_obj::getShaders( ){
	HX_STACK_FRAME("openfl._v2.gl.GLProgram","getShaders",0x552d379f,"openfl._v2.gl.GLProgram.getShaders","openfl/_v2/gl/GLProgram.hx",27,0x0cd51736)
	HX_STACK_THIS(this)
	HX_STACK_LINE(27)
...
::String GLProgram_obj::getType( ){
	HX_STACK_FRAME("openfl._v2.gl.GLProgram","getType",0x0e868c29,"openfl._v2.gl.GLProgram.getType","openfl/_v2/gl/GLProgram.hx",34,0x0cd51736)
	HX_STACK_THIS(this)
	HX_STACK_LINE(34)
...
void GLProgram_obj::__Mark(HX_MARK_PARAMS)
{
	...
	::openfl::_v2::gl::GLObject_obj::__Mark(HX_MARK_ARG);
	HX_MARK_END_CLASS();
}
...
void GLProgram_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	::openfl::_v2::gl::GLObject_obj::__Visit(HX_VISIT_ARG);
}
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.gl.GLProgram"), hx::TCanCast< GLProgram_obj> ,sStaticFields,sMemberFields,
