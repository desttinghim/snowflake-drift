...
{
HX_STACK_FRAME("openfl._v2.gl.GLObject","new",0x00c6546e,"openfl._v2.gl.GLObject.new","openfl/_v2/gl/GLObject.hx",14,0x19c6b463)
...
::String GLObject_obj::getType( ){
	HX_STACK_FRAME("openfl._v2.gl.GLObject","getType",0x352c457e,"openfl._v2.gl.GLObject.getType","openfl/_v2/gl/GLObject.hx",24,0x19c6b463)
	HX_STACK_THIS(this)
	HX_STACK_LINE(24)
...
{
		HX_STACK_FRAME("openfl._v2.gl.GLObject","invalidate",0x7c92532d,"openfl._v2.gl.GLObject.invalidate","openfl/_v2/gl/GLObject.hx",31,0x19c6b463)
		HX_STACK_THIS(this)
		HX_STACK_LINE(31)
		this->id = null();
	}
...
bool GLObject_obj::isValid( ){
	HX_STACK_FRAME("openfl._v2.gl.GLObject","isValid",0xe3debbc0,"openfl._v2.gl.GLObject.isValid","openfl/_v2/gl/GLObject.hx",38,0x19c6b463)
	HX_STACK_THIS(this)
	HX_STACK_LINE(38)
	if (((this->id != null()))){
		HX_STACK_LINE(38)
		return (this->version == ::openfl::_v2::gl::GL_obj::get_version());
	}
	else{
		HX_STACK_LINE(38)
		return false;
...
bool GLObject_obj::isInvalid( ){
	HX_STACK_FRAME("openfl._v2.gl.GLObject","isInvalid",0x78a05abb,"openfl._v2.gl.GLObject.isInvalid","openfl/_v2/gl/GLObject.hx",45,0x19c6b463)
	HX_STACK_THIS(this)
	HX_STACK_LINE(45)
	return !(this->isValid());
}
...
::String GLObject_obj::toString( ){
	HX_STACK_FRAME("openfl._v2.gl.GLObject","toString",0x0f5cd9de,"openfl._v2.gl.GLObject.toString","openfl/_v2/gl/GLObject.hx",50,0x19c6b463)
	HX_STACK_THIS(this)
	HX_STACK_LINE(52)
	::String _g = (this->getType() + HX_CSTRING("("));		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(52)
	return ((_g + ::Std_obj::string(this->id)) + HX_CSTRING(")"));
}
...
bool GLObject_obj::get_invalidated( ){
	HX_STACK_FRAME("openfl._v2.gl.GLObject","get_invalidated",0x733d4b2e,"openfl._v2.gl.GLObject.get_invalidated","openfl/_v2/gl/GLObject.hx",66,0x19c6b463)
	HX_STACK_THIS(this)
	HX_STACK_LINE(66)
...
bool GLObject_obj::get_valid( ){
	HX_STACK_FRAME("openfl._v2.gl.GLObject","get_valid",0xaebbd3e1,"openfl._v2.gl.GLObject.get_valid","openfl/_v2/gl/GLObject.hx",73,0x19c6b463)
	HX_STACK_THIS(this)
	HX_STACK_LINE(73)
	return this->isValid();
}
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.gl.GLObject"), hx::TCanCast< GLObject_obj> ,sStaticFields,sMemberFields,
