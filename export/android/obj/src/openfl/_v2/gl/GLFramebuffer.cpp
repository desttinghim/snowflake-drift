...
{
HX_STACK_FRAME("openfl._v2.gl.GLFramebuffer","new",0xdcb22a02,"openfl._v2.gl.GLFramebuffer.new","openfl/_v2/gl/GLFramebuffer.hx",9,0x3be1e26d)
...
::String GLFramebuffer_obj::getType( ){
	HX_STACK_FRAME("openfl._v2.gl.GLFramebuffer","getType",0x73747512,"openfl._v2.gl.GLFramebuffer.getType","openfl/_v2/gl/GLFramebuffer.hx",16,0x3be1e26d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(16)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.gl.GLFramebuffer"), hx::TCanCast< GLFramebuffer_obj> ,sStaticFields,sMemberFields,
