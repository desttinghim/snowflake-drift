...
Void ByteArray_obj::compress( ::openfl::_v2::utils::CompressionAlgorithm algorithm){
{
		...
		if (((algorithm == ::openfl::_v2::utils::CompressionAlgorithm_obj::LZMA))){
			HX_STACK_LINE(120)
			result = ::haxe::io::Bytes_obj::ofData(::openfl::_v2::utils::ByteArray_obj::lime_lzma_encode(src->b));
		}
		else{
			HX_STACK_LINE(124)
...
bool ByteArray_obj::readBoolean( ){
	...
	if (((this->position < this->length))){
		struct _Function_2_1{
			inline static int Block( ::openfl::_v2::utils::ByteArray_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/_v2/utils/ByteArray.hx",232,0x400ac17e)
				{
					HX_STACK_LINE(232)
...
Void ByteArray_obj::uncompress( ::openfl::_v2::utils::CompressionAlgorithm algorithm){
{
		...
		if (((algorithm == ::openfl::_v2::utils::CompressionAlgorithm_obj::LZMA))){
			HX_STACK_LINE(522)
			result = ::haxe::io::Bytes_obj::ofData(::openfl::_v2::utils::ByteArray_obj::lime_lzma_decode(src->b));
		}
		else{
			HX_STACK_LINE(526)
			int windowBits;		HX_STACK_VAR(windowBits,"windowBits");
...
{
		HX_STACK_FRAME("openfl._v2.utils.ByteArray","write_uncheck",0xed954324,"openfl._v2.utils.ByteArray.write_uncheck","openfl/_v2/utils/ByteArray.hx",555,0x400ac17e)
		HX_STACK_THIS(this)
...
Void ByteArray_obj::writeDouble( Float x){
{
		...
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(606)
		::haxe::io::Bytes bytes = ::haxe::io::Bytes_obj::ofData(::openfl::_v2::utils::ByteArray_obj::_double_bytes(x,this->bigEndian));		HX_STACK_VAR(bytes,"bytes");
		HX_STACK_LINE(609)
...
Void ByteArray_obj::writeFloat( Float x){
{
		...
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(628)
		::haxe::io::Bytes bytes = ::haxe::io::Bytes_obj::ofData(::openfl::_v2::utils::ByteArray_obj::_float_bytes(x,this->bigEndian));		HX_STACK_VAR(bytes,"bytes");
		HX_STACK_LINE(633)
		this->writeBytes(bytes,(int)0,(int)0);
	}
return null();
