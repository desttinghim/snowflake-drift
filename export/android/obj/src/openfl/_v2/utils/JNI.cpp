...
Dynamic JNI_obj::createInterface( Dynamic haxeClass,::String className,::String classDef){
	...
	if ((!(::openfl::_v2::utils::JNI_obj::alreadyCreated->get(className)))){
		HX_STACK_LINE(63)
		bytes = ::haxe::io::Bytes_obj::ofString(::haxe::crypto::BaseCode_obj::decode(classDef,::openfl::_v2::utils::JNI_obj::base64));
		HX_STACK_LINE(64)
		bytes = ::haxe::zip::Uncompress_obj::run(bytes,(int)9);
		HX_STACK_LINE(65)
...
::openfl::_v2::utils::JNIMemberField JNI_obj::createMemberField( ::String className,::String memberName,::String signature){
	...
	HX_STACK_LINE(79)
	return ::openfl::_v2::utils::JNIMemberField_obj::__new(::openfl::_v2::utils::JNI_obj::lime_jni_create_field(className,memberName,signature,false));
}
	...
	HX_STACK_ARG(quietFail,"quietFail")
{
		...
		::openfl::_v2::utils::JNI_obj::init();
		HX_STACK_LINE(88)
		className = className.split(HX_CSTRING("."))->join(HX_CSTRING("/"));
		HX_STACK_LINE(89)
...
::openfl::_v2::utils::JNIStaticField JNI_obj::createStaticField( ::String className,::String memberName,::String signature){
	...
	::openfl::_v2::utils::JNI_obj::init();
	HX_STACK_LINE(113)
	return ::openfl::_v2::utils::JNIStaticField_obj::__new(::openfl::_v2::utils::JNI_obj::lime_jni_create_field(className,memberName,signature,true));
}
...
Dynamic JNI_obj::onCallback( Dynamic object,Dynamic method,Dynamic args){
	...
	HX_STACK_LINE(175)
	::String _g = (HX_CSTRING("onCallback - unknown field ") + ::Std_obj::string(method));		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(175)
	::haxe::Log_obj::trace(_g,hx::SourceInfo(HX_CSTRING("JNI.hx"),175,HX_CSTRING("openfl._v2.utils.JNI"),HX_CSTRING("onCallback")));
	HX_STACK_LINE(176)
	return null();
}
