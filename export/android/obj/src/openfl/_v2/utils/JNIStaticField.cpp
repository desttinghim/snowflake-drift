...
{
HX_STACK_FRAME("openfl._v2.utils.JNIStaticField","new",0xc6a9a607,"openfl._v2.utils.JNIStaticField.new","openfl/_v2/utils/JNI.hx",248,0x9d23658a)
...
Dynamic JNIStaticField_obj::get( ){
	HX_STACK_FRAME("openfl._v2.utils.JNIStaticField","get",0xc6a4563d,"openfl._v2.utils.JNIStaticField.get","openfl/_v2/utils/JNI.hx",255,0x9d23658a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(255)
	return ::openfl::_v2::utils::JNIStaticField_obj::lime_jni_get_static(this->field);
}
...
Dynamic JNIStaticField_obj::set( Dynamic value){
	HX_STACK_FRAME("openfl._v2.utils.JNIStaticField","set",0xc6ad7149,"openfl._v2.utils.JNIStaticField.set","openfl/_v2/utils/JNI.hx",260,0x9d23658a)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(262)
	::openfl::_v2::utils::JNIStaticField_obj::lime_jni_set_static(this->field,value);
	HX_STACK_LINE(263)
	return value;
}
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.utils.JNIStaticField"), hx::TCanCast< JNIStaticField_obj> ,sStaticFields,sMemberFields,
...
{
	lime_jni_get_static= ::openfl::_v2::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_jni_get_static"),(int)1);
	lime_jni_set_static= ::openfl::_v2::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_jni_set_static"),(int)2);
}
