...
{
HX_STACK_FRAME("openfl._v2.utils.WeakRef","new",0x6bda9cdf,"openfl._v2.utils.WeakRef.new","openfl/_v2/utils/WeakRef.hx",16,0xdc6e8734)
...
bool makeWeak = __o_makeWeak.Default(true);
{
	...
	if ((makeWeak)){
		HX_STACK_LINE(18)
		this->weakRef = ::openfl::_v2::utils::WeakRef_obj::lime_weak_ref_create(hx::ObjectPtr<OBJ_>(this),object);
		HX_STACK_LINE(19)
		this->hardRef = null();
	}
	else{
...
Dynamic WeakRef_obj::get( ){
	HX_STACK_FRAME("openfl._v2.utils.WeakRef","get",0x6bd54d15,"openfl._v2.utils.WeakRef.get","openfl/_v2/utils/WeakRef.hx",31,0xdc6e8734)
	HX_STACK_THIS(this)
	HX_STACK_LINE(33)
	...
	HX_STACK_LINE(45)
	Dynamic result = ::openfl::_v2::utils::WeakRef_obj::lime_weak_ref_get(this->weakRef);		HX_STACK_VAR(result,"result");
	HX_STACK_LINE(46)
	if (((result == null()))){
		HX_STACK_LINE(48)
		this->weakRef = (int)-1;
...
::String WeakRef_obj::toString( ){
	HX_STACK_FRAME("openfl._v2.utils.WeakRef","toString",0xdc1757cd,"openfl._v2.utils.WeakRef.toString","openfl/_v2/utils/WeakRef.hx",57,0xdc6e8734)
	HX_STACK_THIS(this)
	HX_STACK_LINE(59)
	if (((this->hardRef == null()))){
		HX_STACK_LINE(61)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.utils.WeakRef"), hx::TCanCast< WeakRef_obj> ,sStaticFields,sMemberFields,
...
{
	lime_weak_ref_create= ::openfl::_v2::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_weak_ref_create"),(int)2);
	lime_weak_ref_get= ::openfl::_v2::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_weak_ref_get"),(int)1);
}
