...
{
HX_STACK_FRAME("openfl._v2.utils.JNIMemberField","new",0xc70f8adb,"openfl._v2.utils.JNIMemberField.new","openfl/_v2/utils/JNI.hx",206,0x9d23658a)
...
Dynamic JNIMemberField_obj::get( Dynamic jobject){
	HX_STACK_FRAME("openfl._v2.utils.JNIMemberField","get",0xc70a3b11,"openfl._v2.utils.JNIMemberField.get","openfl/_v2/utils/JNI.hx",213,0x9d23658a)
	HX_STACK_THIS(this)
	HX_STACK_ARG(jobject,"jobject")
	HX_STACK_LINE(213)
	return ::openfl::_v2::utils::JNIMemberField_obj::lime_jni_get_member(this->field,jobject);
}
...
Dynamic JNIMemberField_obj::set( Dynamic jobject,Dynamic value){
	HX_STACK_FRAME("openfl._v2.utils.JNIMemberField","set",0xc713561d,"openfl._v2.utils.JNIMemberField.set","openfl/_v2/utils/JNI.hx",218,0x9d23658a)
	HX_STACK_THIS(this)
	HX_STACK_ARG(jobject,"jobject")
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(220)
	::openfl::_v2::utils::JNIMemberField_obj::lime_jni_set_member(this->field,jobject,value);
	HX_STACK_LINE(221)
	return value;
}
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.utils.JNIMemberField"), hx::TCanCast< JNIMemberField_obj> ,sStaticFields,sMemberFields,
...
{
	lime_jni_get_member= ::openfl::_v2::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_jni_get_member"),(int)2);
	lime_jni_set_member= ::openfl::_v2::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_jni_set_member"),(int)3);
}
