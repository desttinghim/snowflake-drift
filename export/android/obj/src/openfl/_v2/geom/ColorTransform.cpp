...
{
HX_STACK_FRAME("openfl._v2.geom.ColorTransform","new",0xef23ed5c,"openfl._v2.geom.ColorTransform.new","openfl/_v2/geom/ColorTransform.hx",18,0x72776675)
...
Void ColorTransform_obj::concat( ::openfl::_v2::geom::ColorTransform second){
{
		HX_STACK_FRAME("openfl._v2.geom.ColorTransform","concat",0x238b3198,"openfl._v2.geom.ColorTransform.concat","openfl/_v2/geom/ColorTransform.hx",32,0x72776675)
		HX_STACK_THIS(this)
...
int ColorTransform_obj::get_color( ){
	HX_STACK_FRAME("openfl._v2.geom.ColorTransform","get_color",0xc0f3cfb6,"openfl._v2.geom.ColorTransform.get_color","openfl/_v2/geom/ColorTransform.hx",49,0x72776675)
	HX_STACK_THIS(this)
	HX_STACK_LINE(51)
	int _g = (int(::Std_obj::_int(this->redOffset)) << int((int)16));		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(51)
	int _g1 = (int(_g) | int((int(::Std_obj::_int(this->greenOffset)) << int((int)8))));		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(51)
	return (int(_g1) | int(::Std_obj::_int(this->blueOffset)));
}
...
int ColorTransform_obj::set_color( int value){
	HX_STACK_FRAME("openfl._v2.geom.ColorTransform","set_color",0xa444bbc2,"openfl._v2.geom.ColorTransform.set_color","openfl/_v2/geom/ColorTransform.hx",56,0x72776675)
	HX_STACK_THIS(this)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl._v2.geom.ColorTransform"), hx::TCanCast< ColorTransform_obj> ,sStaticFields,sMemberFields,
