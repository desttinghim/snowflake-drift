...
Dynamic Vector_Impl__obj::_new( Dynamic length,Dynamic fixed){
	...
	HX_STACK_LINE(782)
	this1 = Dynamic( Array_obj<Dynamic>::__new() )->__Field(HX_CSTRING("__SetSizeExact"),true)(length);
	HX_STACK_LINE(780)
	return this1;
}
	...
	struct _Function_1_1{
		inline static Dynamic Block( ){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/Vector.hx",916,0x4a01873c)
			{
				...
				HX_STACK_LINE(916)
				this2 = Dynamic( Array_obj<Dynamic>::__new() )->__Field(HX_CSTRING("__SetSizeExact"),true)(null());
				HX_STACK_LINE(916)
				return this2;
			}
			return null();
