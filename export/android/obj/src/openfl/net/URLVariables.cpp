...
Void URLVariables_obj::decode( ::String inVars){
{
		...
		HX_STACK_LINE(30)
		{
			...
			while(((_g < fields1->length))){
				...
				if (((eq > (int)0))){
					HX_STACK_LINE(36)
					::String field;		HX_STACK_VAR(field,"field");
					HX_STACK_LINE(36)
					{
						HX_STACK_LINE(36)
						::String s = f.substr((int)0,eq);		HX_STACK_VAR(s,"s");
						HX_STACK_LINE(36)
						field = s.__URLDecode();
					}
					HX_STACK_LINE(36)
					...
					{
						HX_STACK_LINE(36)
						::String s = f.substr((eq + (int)1),null());		HX_STACK_VAR(s,"s");
						HX_STACK_LINE(36)
						value = s.__URLDecode();
					}
					HX_STACK_LINE(36)
					...
					if (((eq != (int)0))){
						HX_STACK_LINE(40)
						::String field = f.__URLDecode();		HX_STACK_VAR(field,"field");
						HX_STACK_LINE(40)
...
::String URLVariables_obj::toString( ){
	...
	HX_STACK_LINE(54)
	{
		...
		while(((_g < fields->length))){
			...
			++(_g);
			HX_STACK_LINE(56)
			::String _g1 = (f.__URLEncode() + HX_CSTRING("="));		HX_STACK_VAR(_g1,"_g1");
			struct _Function_3_1{
				inline static ::String Block( ::openfl::net::URLVariables_obj *__this,::String &f){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/net/URLVariables.hx",56,0x10f26625)
					{
						HX_STACK_LINE(56)
						::String s = ::Reflect_obj::field(__this,f);		HX_STACK_VAR(s,"s");
						HX_STACK_LINE(56)
			...
			HX_STACK_LINE(56)
			result->push((_g1 + _Function_3_1::Block(this,f)));
		}
	}
	HX_STACK_LINE(60)
