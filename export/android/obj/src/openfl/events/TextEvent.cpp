...
::openfl::_v2::events::Event TextEvent_obj::clone( ){
	...
	HX_STACK_LINE(24)
	return ::openfl::events::TextEvent_obj::__new(_g,_g1,this->get_cancelable(),this->text);
}
...
::String TextEvent_obj::toString( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(31)
	::String _g = ((HX_CSTRING("[TextEvent type=") + this->get_type()) + HX_CSTRING(" bubbles="));		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(31)
	::String _g1 = ((_g + ::Std_obj::string(this->get_bubbles())) + HX_CSTRING(" cancelable="));		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(31)
	return ((((_g1 + ::Std_obj::string(this->get_cancelable())) + HX_CSTRING(" text=")) + this->text) + HX_CSTRING("]"));
}
