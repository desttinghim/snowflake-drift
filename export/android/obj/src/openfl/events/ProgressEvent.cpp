...
::openfl::_v2::events::Event ProgressEvent_obj::clone( ){
	...
	HX_STACK_LINE(26)
	return ::openfl::events::ProgressEvent_obj::__new(_g,_g1,this->get_cancelable(),this->bytesLoaded,this->bytesTotal);
}
...
::String ProgressEvent_obj::toString( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(33)
	::String _g = ((HX_CSTRING("[ProgressEvent type=") + this->get_type()) + HX_CSTRING(" bubbles="));		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(33)
	::String _g1 = ((_g + ::Std_obj::string(this->get_bubbles())) + HX_CSTRING(" cancelable="));		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(33)
	return ((((((_g1 + ::Std_obj::string(this->get_cancelable())) + HX_CSTRING(" bytesLoaded=")) + this->bytesLoaded) + HX_CSTRING(" bytesTotal=")) + this->bytesTotal) + HX_CSTRING("]"));
}
