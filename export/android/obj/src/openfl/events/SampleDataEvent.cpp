...
::openfl::_v2::events::Event SampleDataEvent_obj::clone( ){
	...
	HX_STACK_LINE(29)
	return ::openfl::events::SampleDataEvent_obj::__new(_g,_g1,this->get_cancelable());
}
...
::String SampleDataEvent_obj::toString( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(36)
	::String _g = ((HX_CSTRING("[SampleDataEvent type=") + this->get_type()) + HX_CSTRING(" bubbles="));		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(36)
...
Dynamic SampleDataEvent_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"data") ) { data=inValue.Cast< ::openfl::_v2::utils::ByteArray >(); return inValue; }
		break;
	case 8:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::_v2::utils::ByteArray*/ ,(int)offsetof(SampleDataEvent_obj,data),HX_CSTRING("data")},
