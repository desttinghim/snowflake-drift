...
Void UncaughtErrorEvents_obj::__construct(::openfl::_v2::events::IEventDispatcher target)
{
...
hx::ObjectPtr< UncaughtErrorEvents_obj > UncaughtErrorEvents_obj::__new(::openfl::_v2::events::IEventDispatcher target)
