...
::openfl::_v2::events::Event ErrorEvent_obj::clone( ){
	...
	HX_STACK_LINE(22)
	return ::openfl::events::ErrorEvent_obj::__new(_g,_g1,this->get_cancelable(),this->text,this->errorID);
}
...
::String ErrorEvent_obj::toString( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(29)
	::String _g = ((HX_CSTRING("[ErrorEvent type=") + this->get_type()) + HX_CSTRING(" bubbles="));		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(29)
