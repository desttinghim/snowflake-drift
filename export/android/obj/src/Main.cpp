...
Void Main_obj::setupGame( ){
{
		...
		HX_STACK_LINE(66)
		this->addChild(::flixel::FlxGame_obj::__new(this->gameWidth,this->gameHeight,this->initialState,this->zoom,this->framerate,this->framerate,this->skipSplash,this->startFullscreen));
	}
return null();
}
...
Void Main_obj::main( ){
{
		...
		HX_STACK_LINE(25)
		::openfl::_v2::Lib_obj::get_current()->addChild(::Main_obj::__new());
	}
return null();
}
