...
::EReg_obj::__register();
::__ASSET__assets_images_visitor1_ttf_obj::__register();
::__ASSET__assets_images_fipps_regular_otf_obj::__register();
...
::__ASSET__assets_images_fipps_regular_otf_obj::__boot();
::__ASSET__assets_images_visitor1_ttf_obj::__boot();
