...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		Font.registerFont (__ASSET__assets_images_fipps_regular_otf);
		...
		Font.registerFont (__ASSET__assets_images_visitor1_ttf);
...
@:keep #if display private #end class __ASSET__assets_images_fipps_regular_otf extends flash.text.Font { #if (!openfl_html5_dom) public function new () { super (); fontName = "assets/images/Fipps_Regular.otf"; } #end }
...
class __ASSET__assets_images_fipps_regular_otf extends openfl.text.Font { public function new () { super (); __fontPath = "assets/images/Fipps_Regular.otf"; fontName = "Fipps Regular"; }}
class __ASSET__assets_images_visitor1_ttf extends openfl.text.Font { public function new () { super (); __fontPath = "assets/images/visitor1.ttf"; fontName = "Visitor TT1 BRK"; }}
